...
Il presente verbale\G documenta la riunione esterna del 30 marzo 2026 con i referenti di Eggon, durante la quale il team ha illustrato lo stato di avanzamento dello sviluppo del progetto\G. 
L'azienda ha espresso parere positivo e ha formalmente approvato il prodotto\G realizzato. Sono stati mostrati il modulo\G di generazione post (AI Assistant) e
il modulo\G di estrazione e classificazione documenti (AI Copilot), con le relative funzionalità\G di interfaccia\G.
...
\begin{enumerate}
    \item \label{itm:gen} Dimostrazione del modulo\G di generazione post (AI\G Assistant).
    \item \label{itm:ext} Dimostrazione del modulo\G di estrazione e classificazione documenti (AI Copilot\G).
...
\subsection*{\ref{itm:gen}. Dimostrazione del modulo\G di generazione post (AI\G Assistant)}
...
\subsection*{\ref{itm:ext}. Dimostrazione del modulo\G di estrazione e classificazione documenti (AI Copilot\G)}

Il team ha illustrato il flusso di elaborazione dei documenti caricati nel sistema. Il
modulo\G è compatibile con PDF\G, CSV e file immagine (PNG, JPEG). Il processo si articola
nelle seguenti fasi:
...
\begin{itemize}
    ...
    azienda e categoria.
    \item \textbf{Confidenza\G e intervento umano:} Per ogni campo estratto viene calcolata
    una percentuale di confidenza\G. In assenza di un match nel database\G, il campo viene
    ...
    \item \textbf{Dashboard:} La dashboard\G riporta la percentuale di confidenza\G media dei
...
\begin{itemize}
    ...
    introduzione.
    \item \textbf{Generazione testo:} Dopo una fase di valutazione dei modelli AWS\G Nova (Lite
...
\DecisionRow{\href{https://github.com/BugBustersUnipd/DocumentazioneSWE/issues/226}{PB27}}{Portare a conclusione la documentazione propedeutica alla candidatura\G della Baseline PB\G}{Marco Favero, Linor Sadè, Leonardo Salviato}
\DecisionRow{\href{https://github.com/BugBustersUnipd/DocumentazioneSWE/issues/227}{PB28}}{Concludere la redazione del Piano di Qualifica\G e i test\G per la parte front-end\G dell'MVP\G}{Marco Piro}
\DecisionRow{\href{https://github.com/BugBustersUnipd/DocumentazioneSWE/issues/228}{PB29}}{Concludere la parte dei test\G per il back-end\G}{Luca Slongo}
\end{tabularx}
\fussy
...
Il gruppo BugBusters, preso atto dell'approvazione\G, procederà con la stesura della documentazione tecnica mancante e si candiderà ufficialmente per il raggiungimento della Product Baseline (PB)\G con i docenti.
