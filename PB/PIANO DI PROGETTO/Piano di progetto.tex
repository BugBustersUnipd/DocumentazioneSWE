...
\textit{Lungo termine:} la nuova data di consegna prevista è entro il 12/04/2026, aggiornata rispetto alla pianificazione iniziale del 21/03/2026.\\
...
\textit{Lungo termine:} la pianificazione al 12/04/2026 rimane percorribile nei tempi previsti. Le risorse rimanenti in termini di ore e budget sono sufficienti per completare le attività previste per la PB\pediceG.\\\
...
\centering
\begin{tikzpicture}[scale=1.3]
  % Calcolo delle percentuali (67 ore totali)
  % Responsabile: 5.97% (21.5°)
  \draw[fill=blue!60, draw=black, line width=1.5pt] 
    (0,0) -- (2,0) arc (0:21.5:2) -- cycle;
  \node at (10.75:1.2) {\small\bfseries 6.0\%};
  
  % Amministratore: 4.48% (16.1° cumulative: 21.5° -> 37.6°)
  \draw[fill=red!60, draw=black, line width=1.5pt] 
    (0,0) -- (21.5:2) arc (21.5:37.6:2) -- cycle;
  \node[rotate=29.55] at (29.55:1.5) {\small\bfseries 4.5\%};
  
  % Progettista: 29.85% (107.5° cumulative: 37.6° -> 145.1°)
  \draw[fill=purple!60, draw=black, line width=1.5pt] 
    (0,0) -- (37.6:2) arc (37.6:145.1:2) -- cycle;
  \node at (91.35:1.2) {\small\bfseries 29.9\%};
  
  % Programmatore: 40.30% (145.1° cumulative: 145.1° -> 290.2°)
  \draw[fill=yellow!60, draw=black, line width=1.5pt] 
    (0,0) -- (145.1:2) arc (145.1:290.2:2) -- cycle;
  \node at (217.65:1.2) {\small\bfseries 40.3\%};
  
  % Verificatore: 19.40% (69.8° cumulative to 360°)
  \draw[fill=green!60, draw=black, line width=1.5pt] 
    (0,0) -- (290.2:2) arc (290.2:360:2) -- cycle;
  \node at (325.1:1.2) {\small\bfseries 19.4\%};
