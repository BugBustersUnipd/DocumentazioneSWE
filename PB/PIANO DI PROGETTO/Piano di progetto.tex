...
\begin{longtblr}[
  ...
  % Specifica Tecnica (righe 2-5): hline interne su col 2-3
  hline{3,4,5} = {2-3}{primaryblue},
  hline{6} = {primaryblue},
  % Manuale Utente (righe 6-8)
  hline{7,8} = {2-3}{primaryblue},
  hline{9} = {primaryblue},
  % Correzione AdR (righe 9-15)
  hline{10,11,12,13,14,15} = {2-3}{primaryblue},
  hline{16} = {primaryblue},
  % Correzione NdP (righe 16-20)
  hline{17,18,19,20} = {2-3}{primaryblue},
  hline{21} = {primaryblue},
  % Piano di Qualifica (riga 21): singola, nessuna hline interna
  hline{22} = {primaryblue},
  % Glossario (righe 22-25)
  hline{23,24,25} = {2-3}{primaryblue},
  hline{26} = {primaryblue},
  % Piano di Progetto (righe 26-29)
  hline{27,28,29} = {2-3}{primaryblue},
  hline{30} = {primaryblue},
  % MVP (righe 30-33)
  hline{31,32,33} = {2-3}{primaryblue},
  hline{34} = {primaryblue},
}

Attività & Descrizione & Periodo di svolgimento & Stato \\

\SetCell[r=4]{c} \textbf{Redazione della Specifica Tecnica\pediceG}
...
\SetCell[r=5]{c} \textbf{Correzione e completamento Norme di Progetto\pediceG}
...
\SetCell[r=4]{c} \textbf{Ampliamento del Glossario\pediceG}
  & & & \SetCell[r=4]{c} {\small IN REDAZIONE} \\
  & & & \\
  & & & \\
  & & & \\

\SetCell[r=4]{c} \textbf{Ampliamento del Piano di Progetto\pediceG}
  & & & \SetCell[r=4]{c} {\small IN REDAZIONE} \\
  & & & \\
  & & & \\
  & & & \\
