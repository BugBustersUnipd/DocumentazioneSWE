...
\newcommand{\CurrentVersion}{1.1.1}
...
\rowcolor{secondaryblue!10}1.1.1 & 27/02/2026 & Redatta la pianificazione dello sprint\pediceG 7 e 8 & Alberto Autiero & - & - \\
\hline
...
\begin{itemize}
    \item RT1: Rischio Tecnologico\pediceG legato alla tecnologia utilizzata
    \item RT2: Rischio Tecnologico\pediceG legato a errori nel codice
\end{itemize}
...
\noindent\textbf{Misure correttive e aggiornamento dei rischi\pediceG}\\
Durante questo ottavo sprint\pediceG si sono concretizzati i rischi RT1 e RT2: Rischio Tecnologico\pediceG legato alla tecnologia utilizzata e Rischio Tecnologico\pediceG legato a errori nel codice, a causa dell'avvio delle attività di sviluppo del MVP\pediceG.

Le misure adottate sono state:
\begin{itemize}
    \item Per RT1: il gruppo ha approfondito le tecnologie utilizzate attraverso Video Tutorial e documentazione digitale. Inoltre sono state effettuate sessioni di confronto interno per allineare le conoscenze tra i membri.
    \item Per RT2: sono state adottate pratiche di revisione del codice tra pari (peer review\pediceG) prima di ogni merge\pediceG nel repository\pediceG, riducendo la propagazione di errori.
\end{itemize}

Le mitigazioni\pediceG applicata si sono rilevate efficaci.\\

\noindent\textbf{Pianificazione del prossimo sprint}\\\\
\textit{Breve termine (Sprint\pediceG 9 - PB\pediceG):} il gruppo proseguirà lo sviluppo del MVP\pediceG e l'avanzamento dei documenti Specifica Tecnica e Manuale Utente.\\\\
