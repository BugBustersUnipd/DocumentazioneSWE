...
Il ciclo di gestione adottato per ogni sprint\pediceG concluso segue il seguente ordine:
\begin{enumerate}
    \item \textbf{Consuntivo di periodo}: rendiconto delle ore effettivamente impiegate da ciascun membro per ciascun ruolo, con evidenza degli scostamenti rispetto al preventivo;
    \item \textbf{Retrospettiva\pediceG}: valutazione degli obiettivi raggiunti e di quelli mancati nel periodo considerato;
    \item \textbf{Misure correttive}: azioni intraprese in risposta agli scostamenti rilevati, incluso l'aggiornamento dell'analisi dei rischi\pediceG;
    \item \textbf{Miglioramento della pianificazione futura}: adattamenti apportati alla pianificazione di breve e lungo termine sulla base delle lezioni apprese;
...
\noindent\textbf{Miglioramento della pianificazione futura}\\
