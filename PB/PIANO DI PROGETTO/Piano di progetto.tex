...
\textit{Breve termine (Sprint\pediceG 10 - PB\pediceG):} il gruppo proseguirà lo sviluppo del MVP\pediceG, consolidando quanto definito in fase di progettazione. \\\\
 \textit{Nota organizzativa:}  a partire dal decimo sprint\pediceG la durata degli sprint\pediceG viene ridotta da due settimane a una, al fine di aumentare la frequenza delle revisioni interne e mantenere un controllo più granulare sull'avanzamento delle attività nelle fasi conclusive della PB\pediceG.\\\\
