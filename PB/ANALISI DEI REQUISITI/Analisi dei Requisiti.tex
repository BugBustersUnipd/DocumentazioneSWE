...
\usepackage{array}
\usepackage{ragged2e}
% Pacchetti necessari per il comando G
\usepackage{graphicx} % Serve per \scalebox
\usepackage{xspace}   % Serve per gestire lo spazio dopo la G

% Definizione del comando \G
...
% --- INIZIO DEFINIZIONI TEMPLATE\TEXTSUBSCRIPT{\SCALEBOX{0.6}{\TEXTBF{G}}} DINAMICO ---

\newcommand{\urlcap}{https://www.math.unipd.it/~tullio/IS-1/2025/Progetto/C5.pdf}

\newcounter{usecase}[subsection]
\renewcommand{\theusecase}{\AlphAlph{\value{usecase}}}
...
% --- FINE DEFINIZIONI TEMPLATE\TEXTSUBSCRIPT{\SCALEBOX{0.6}{\TEXTBF{G}}} DINAMICO ---
...
\begin{center}
 ...
 {\Huge\bfseries\color{primaryblue} Analisi dei Requisiti\G}\\[0.8cm]
...
\begin{center}
    ...
    \begin{tabularx}{\linewidth}{@{}>{\raggedright\arraybackslash}p{3.5cm}>{\raggedright\arraybackslash}X@{}}
        {Stato} & Approvato \\
        {Redattori\G} & Leonardo Salviato, Linor Sadè, Alberto Autiero, Alberto Pignat, Marco Favero, Marco Piro, Luca Slongo \\
        {Verificatori\G} &  Marco Piro, Luca Slongo \\
...
Questo documento contiene l'Analisi dei Requisiti\textsubscript{\scalebox{0.6}{\textbf{G}}} eseguita dal team \textbf{BugBusters} per il progetto\textsubscript{\scalebox{0.6}{\textbf{G}}} C5 proposto dall'azienda Eggon
\end{tcolorbox}
\end{center}
...
\hline
\endhead
\rowcolor{secondaryblue!10} 2.0.0 & 26/01/2025 & Approvazione documento & - & - &  Luca Slongo \\
\hline
\rowcolor{secondaryblue!10} 1.1.0 & 26/02/2025 & Correzioni errori annotati dal prof. Cardin & Leonardo Salviato & Linor Sadé &  - \\
\hline
\rowcolor{secondaryblue!10} 1.0.0 & 30/01/2025 & Approvazione documento & - & - &  Luca Slongo \\
\hline
\rowcolor{secondaryblue!10} 0.2.6 & 30/01/2025 & Verifica documento & - & Marco Piro & -\\
\hline
\rowcolor{secondaryblue!10} 0.2.5 & 29/01/2026 & Aggiunti ai termini presenti nel Glossario\textsubscript{\scalebox{0.6}{\textbf{G}}} la G & Alberto Autiero & - & - \\
\hline
\rowcolor{secondaryblue!10} 0.2.4 & 20/01/2026 & Correzione errori & Alberto Pignat & - & - \\
\hline
\rowcolor{secondaryblue!10} 0.2.3 & 14/01/2026 & Riscrittura tabella requisiti funzionali\textsubscript{\scalebox{0.6}{\textbf{G}}} & Leonardo Salviato & - & - \\
\hline
\rowcolor{secondaryblue!10} 0.2.2 & 12/01/2026 & Riscrittura a seguito del colloquio con il professor Cardin & Leonardo Salviato & - & - \\
\hline
\rowcolor{secondaryblue!10} 0.2.1 & 09/01/2026 & Correzioni errori riportati & Leonardo Salviato & - & - \\
\hline
...
\hline
\rowcolor{secondaryblue!10} 0.1.10 & 02/01/2026 & Inserimento Diagrammi casi d'uso sezioni 0 e 1 & Alberto Autiero & - & - \\
\hline
...
\hline
\rowcolor{secondaryblue!10} 0.1.5 & 19/12/2025 & Scritta sezione 3, rimozione trigger, finita tabella requisiti funzionali & Marco Piro & - & - \\
\hline
...
\begin{itemize}
    \item \textbf{Obbligatori\textsubscript{\scalebox{0.6}{\textbf{G}}}}: necessari e imprescindibili per garantire il corretto funzionamento dell'applicazione standalone;
    \item \textbf{Desiderabili\textsubscript{\scalebox{0.6}{\textbf{G}}}}: non strettamente necessari, ma capaci di migliorare l'esperienza utente o l'efficienza\textsubscript{\scalebox{0.6}{\textbf{G}}} del sistema;
    \item \textbf{Opzionali\textsubscript{\scalebox{0.6}{\textbf{G}}}}: funzionalità\textsubscript{\scalebox{0.6}{\textbf{G}}} aggiuntive utili per estensioni future, in particolare in vista della possibile integrazione con NEXUM.
\end{itemize}
...
\begin{itemize}
    ...
    \item Il \textbf{team di verifica\textsubscript{\scalebox{0.6}{\textbf{G}}}tori}, che impiegherà il presente documento per definire i casi di test\textsubscript{\scalebox{0.6}{\textbf{G}}} e validare il comportamento del prodotto\textsubscript{\scalebox{0.6}{\textbf{G}}}.
\end{itemize}

\newpage

\subsection{Prospettiva del prodotto\textsubscript{\scalebox{0.6}{\textbf{G}}}}

Il prodotto\textsubscript{\scalebox{0.6}{\textbf{G}}} che BugBusters intende sviluppare è una versione standalone dei moduli "AI Assistant\textsubscript{\scalebox{0.6}{\textbf{G}}} Generativo" e "AI Co-Pilot\textsubscript{\scalebox{0.6}{\textbf{G}}} per i CdL\textsubscript{\scalebox{0.6}{\textbf{G}}}", svincolata dalla piattaforma NEXUM. Tale applicazione costituirà un prototipo funzionale in grado di operare autonomamente e di implementare le principali funzionalità\textsubscript{\scalebox{0.6}{\textbf{G}}} richieste dal committente\textsubscript{\scalebox{0.6}{\textbf{G}}}, senza dipendere dalla piattaforma esistente.

Tale scelta deriva dalla necessità di rispettare le politiche di privacy e sicurezza\textsubscript{\scalebox{0.6}{\textbf{G}}} dei dati della proponente\textsubscript{\scalebox{0.6}{\textbf{G}}}, le quali risultano incompatibili con la richiesta del committente\textsubscript{\scalebox{0.6}{\textbf{G}}} di rendere il prodotto\textsubscript{\scalebox{0.6}{\textbf{G}}} accessibile al pubblico.
...
I moduli saranno quindi concepiti in modo modulare per permettere all'applicazione, in un'eventuale integrazione futura con NEXUM, di inserirsi nell'architettura esistente come componente riutilizzabile e scalabile. L'integrazione includerà l'adattamento delle API\textsubscript{\scalebox{0.6}{\textbf{G}}}, l'allineamento della gestione utenti e la centralizzazione dei dati all'interno dell'infrastruttura NEXUM.

\subsection{Funzioni del prodotto\textsubscript{\scalebox{0.6}{\textbf{G}}}}

Qui di seguito le funzionalità\textsubscript{\scalebox{0.6}{\textbf{G}}} del prodotto\textsubscript{\scalebox{0.6}{\textbf{G}}} descritte in breve e divise per i due moduli che andranno sviluppati:

\textbf{Modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} AI Assistant\textsubscript{\scalebox{0.6}{\textbf{G}}} Generativo}
\begin{itemize}
    \item \textbf{Generazione di contenuti tramite AI\textsubscript{\scalebox{0.6}{\textbf{G}}}}: 
    ...
    valutazione della qualità\textsubscript{\scalebox{0.6}{\textbf{G}}} dei contenuti generati dall'AI\textsubscript{\scalebox{0.6}{\textbf{G}}}, utile per analisi interne e miglioramento continuo.
    ...
    visualizzazione e gestione di storico, filtri, ricerca e analisi delle interazioni con l'AI\textsubscript{\scalebox{0.6}{\textbf{G}}} generativa.

    \item \textbf{Gestione delle immagini}: 
    possibilità di caricare immagini dall'utente o di generarle tramite AI\textsubscript{\scalebox{0.6}{\textbf{G}}}, con salvataggio locale.
...
\begin{itemize}
    ...
    sfruttando modelli OCR\textsubscript{\scalebox{0.6}{\textbf{G}}} e classificatori addestrati.
    ...
    interfaccia\textsubscript{\scalebox{0.6}{\textbf{G}}} dedicata per verifica\textsubscript{\scalebox{0.6}{\textbf{G}}}re, correggere o confermare i risultati ottenuti dall'AI\textsubscript{\scalebox{0.6}{\textbf{G}}} 
...
\begin{itemize}
    ...
    registrazione, autenticazione, gestione del profilo e configurazione dei parametri AI\textsubscript{\scalebox{0.6}{\textbf{G}}} 
    ...
    Dashboard\textsubscript{\scalebox{0.6}{\textbf{G}}} di monitoraggio delle performance dei moduli AI\textsubscript{\scalebox{0.6}{\textbf{G}}} per consentire valutazioni semplici su efficacia\textsubscript{\scalebox{0.6}{\textbf{G}}} ed efficienza\textsubscript{\scalebox{0.6}{\textbf{G}}} dei moduli. L'applicazione consentirà inoltre
    la possibilità di rilasciare miglioramenti in seguito ad un intervento umano. 
\end{itemize}
...
intelligente e semplice da utilizzare per generare contenuti tramite AI\textsubscript{\scalebox{0.6}{\textbf{G}}} e per gestire flussi documentali complessi con il supporto del Modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} Co-Pilot\textsubscript{\scalebox{0.6}{\textbf{G}}}.
...
In sintesi, il prodotto\textsubscript{\scalebox{0.6}{\textbf{G}}} è rivolto a organizzazioni di varie dimensioni — in particolare aziende medio-grandi e studi professionali — 
che necessitano di strumenti intelligenti per la creazione di contenuti, 
la gestione automatizzata dei documenti e la collaborazione con gli studi dei Consulenti del Lavoro\textsubscript{\scalebox{0.6}{\textbf{G}}}.
L'app standalone funge da primo passo verso una piattaforma HR completa, modulare e potenziata dall'AI\textsubscript{\scalebox{0.6}{\textbf{G}}}.
...
\item \textbf{Norme di Progetto\textsubscript{\scalebox{0.6}{\textbf{G}}} (versione 2.0.0)
:}\\
...
comprendere al meglio cosa il prodotto\textsubscript{\scalebox{0.6}{\textbf{G}}} deve fornire. La descrizione testuale, in particolar
...
\begin{itemize}
    ...
    principale\textsubscript{\scalebox{0.6}{\textbf{G}}} non vada a buon fine
    ...
    l'esecuzione delle operazioni del caso d'uso principale e rappresentano uno scenario\textsubscript{\scalebox{0.6}{\textbf{G}}} alternativo
...
Si fa presente che alcuni attori hanno senso nel contesto dell'applicazione che implementa l'autenticazione e la gestione dei ruoli. Tuttavia tale funzionalità\textsubscript{\scalebox{0.6}{\textbf{G}}}, come verrà descritto più avanti, è requisito\textsubscript{\scalebox{0.6}{\textbf{G}}} opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}}, pertanto gli attori devono essere considerati semplice utente se letti in un contesto in cui tale funzionalità\textsubscript{\scalebox{0.6}{\textbf{G}}} non è implementata. 
\begin{figure}[H]
    \centering
...
\begin{itemize}
    ...
    \item \textbf{Data Analyst\textsubscript{\scalebox{0.6}{\textbf{G}}}}: Figura incaricata di monitorare le prestazioni. Accede alle Dashboard\textsubscript{\scalebox{0.6}{\textbf{G}}} di analisi per consultare le statistiche di utilizzo, i rating di qualità\textsubscript{\scalebox{0.6}{\textbf{G}}} dei contenuti generati e i KPI\textsubscript{\scalebox{0.6}{\textbf{G}}} del riconoscimento documentale.
    \item \textbf{Amministratore\textsubscript{\scalebox{0.6}{\textbf{G}}}}: Gestisce la configurazione tecnica dell'applicazione standalone. Si occupa della creazione degli utenti, della gestione dei ruoli e della configurazione dei parametri globali dell'AI\textsubscript{\scalebox{0.6}{\textbf{G}}} (es. prompt\textsubscript{\scalebox{0.6}{\textbf{G}}} di sistema o soglie di confidenza\textsubscript{\scalebox{0.6}{\textbf{g}}}\textsubscript{\scalebox{0.6}{\textbf{G}}}).
    \item \textbf{Operatore Studio CdL\textsubscript{\scalebox{0.6}{\textbf{G}}}}: È l'utente principale del Modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} AI Co-Pilot\textsubscript{\scalebox{0.6}{\textbf{G}}}. Si occupa di caricare i flussi documentali (es. cedolini massivi\textsubscript{\scalebox{0.6}{\textbf{G}}}), supervisionare il riconoscimento automatico (validazione\textsubscript{\scalebox{0.6}{\textbf{G}}} Human-in-the-Loop) e gestire le liste di distribuzione.
    \item \textbf{AI Post Generator}: Modello AI\textsubscript{\scalebox{0.6}{\textbf{G}}} esterno utilizzato per la creazione di contenuti all'interno del Modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} AI\textsubscript{\scalebox{0.6}{\textbf{G}}}-assistant
    \item \textbf{AI Analyst}: Modello AI\textsubscript{\scalebox{0.6}{\textbf{G}}} esterno utilizzato per l'analisi dei documenti all'interno del Modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} AI-Copilot\textsubscript{\scalebox{0.6}{\textbf{G}}}
\end{itemize}
...
\begin{itemize}
    ...
    \item 3 - Casi d'uso\textsubscript{\scalebox{0.6}{\textbf{G}}} per il Modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} "Analytics e Monitoraggio Trasversale\textsubscript{\scalebox{0.6}{\textbf{G}}}"
\end{itemize}
...
\textbf{Pre-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Il sistema non conosce l'email inserita
\end{itemize}

\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Il sistema registra l'email inserita
\end{itemize}
...
\textbf{Pre-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Il sistema non ha una password inserita associata all'email inserita
\end{itemize}

\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Il sistema registra la password inserita associata all'email inserita
\end{itemize}
...
\textbf{Pre-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Il sistema non ha uno username inserito associato all'email o alla matricola
\end{itemize}

\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Il sistema registra lo username inserito associato all'email o alla matricola
\end{itemize}
...
\textbf{Pre-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Il sistema non ha un nome inserito associato all'email o alla matricola
\end{itemize}

\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Il sistema registra il nome inserito associato all'email o alla matricola
\end{itemize}
...
\textbf{Pre-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Il sistema non ha un cognome inserito associato all'email o alla matricola
\end{itemize}

\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Il sistema registra il cognome inserito associato all'email o alla matricola
\end{itemize}
...
\textbf{Pre-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Il sistema non ha una matricola inserita associata all'email
\end{itemize}

\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Il sistema registra la matricola inserita associata all'email
\end{itemize}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Viene visualizzato un messaggio di errore relativo ai Requisiti di sicurezza\textsubscript{\scalebox{0.6}{\textbf{G}}} della password
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente inserisce una password che non soddisfa i criteri minimi di sicurezza\textsubscript{\scalebox{0.6}{\textbf{G}}} (es. lunghezza minima, caratteri speciali)
...
\subUseCase{Errore autenticazione}
...
\textbf{Pre-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item L'email inserita nel Modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} di accesso non è presente nel database del sistema o la password assegnata alla mail non é corretta
\end{itemize}
...
\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente tenta di effettuare il login inserendo un indirizzo email non associato ad alcun account o inserendo una password non associata all'email inserita
    \item Il sistema verifica\textsubscript{\scalebox{0.6}{\textbf{G}}} l'esistenza dell'email e non trova corrispondenze o l'errore nella password
\end{enumerate}

\vspace{0.5cm}

\subUseCase{Inserimento email autenticazione}
...
\textbf{Pre-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item L'indirizzo email inserito è già associato ad un account esistente
\end{itemize}

\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item L'indirizzo email viene accettato come valido per il processo di autenticazione
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente inserisce un indirizzo email formalmente valido e presente nel sistema
\end{enumerate}
...
\subUseCase{Inserimento password autenticazione}
...
\textbf{Pre-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item La password inserita corrisponde a quella salvata nel sistema per l'email fornita
\end{itemize}

\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item La password inserita viene accettata come valida per il processo di autenticazione
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente inserisce una password corretta associata all'email fornita
\end{enumerate}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{Diagrammi casi d'uso/UC0D.jpg}
    \caption{Diagramma del caso d'uso UC-0D – Logout}
\end{figure}
...
\useCase{Modifica username}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Diagrammi casi d'uso/UC0G.jpg}
    \caption{Diagramma del caso d'uso UC-0G – Modifica username}
\end{figure}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item L'utente cambia username nel proprio profilo
...
\useCase{Modifica email}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Diagrammi casi d'uso/UC0H.jpg}
    \caption{Diagramma del caso d'uso UC-0H – Modifica email}
\end{figure}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item L'utente cambia email nel proprio profilo
    \item I dati vengono salvati nel sistema
\end{itemize}
...
\useCase{Modifica password}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Diagrammi casi d'uso/UC0I.jpg}
    \caption{Diagramma del caso d'uso UC-0I – Modifica password}
\end{figure}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item L'utente cambia password nel proprio profilo
    \item I dati vengono salvati nel sistema
\end{itemize}
...
\useCase{Annulla modifiche profilo utente}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Diagrammi casi d'uso/UC0J.jpg}
    \caption{Diagramma del caso d'uso UC-0J – Annulla modifiche profilo utente}
\end{figure}
...
\textbf{Pre-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Delle modifiche sono state apportate alle informazioni del profilo
\end{itemize}

\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Le modifiche precedenti vengono annullate e il profilo torna alla versione originale
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente decide di non applicare le modifiche correnti
    \item Il sistema ripristina lo stato del contenuto a quello precedente l'apertura della sezione dedicata alle modifiche del profilo
\end{enumerate}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Viene visualizzato il nome di un utente 
\end{itemize}
...
\useCase{Generazione contenuti AI\textsubscript{\scalebox{0.6}{\textbf{G}}}}


\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Diagrammi casi d'uso/UC1A.jpg}
    \caption{Diagramma del caso d'uso UC-1A – Generazione contenuti AI\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\end{figure}
...
\textbf{Pre-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item L'utente si trova nel modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} di generazione contenuti AI\textsubscript{\scalebox{0.6}{\textbf{G}}} (UC-1A)
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item UC-1K – Visualizzazione lista elementi storico filtrata
    \end{itemize}
\end{itemize}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Viene visualizzato il risultato della generazione prodotta dall'AI\textsubscript{\scalebox{0.6}{\textbf{G}}}
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item Il sistema mostra il risultato prodotto dall'AI\textsubscript{\scalebox{0.6}{\textbf{G}}} in risposta al prompt\textsubscript{\scalebox{0.6}{\textbf{G}}}, mantenendo la formattazione originale se presente
\end{enumerate}
...
\textbf{Pre-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Il sistema AI\textsubscript{\scalebox{0.6}{\textbf{G}}} ha completato l'elaborazione della richiesta
\end{itemize}
...
\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item Il sistema riceve l'output dall'AI\textsubscript{\scalebox{0.6}{\textbf{G}}} e lo renderizza nell'area di visualizzazione principale, permettendo all'utente di leggerlo
\end{enumerate}
...
\begin{enumerate}
    ...
    \item Il sistema sostituisce l'immagine generata dall'AI\textsubscript{\scalebox{0.6}{\textbf{G}}} con quella fornita dall'utente
\end{enumerate}
...
\textbf{Pre-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Delle modifiche sono state apportate al contenuto generato (titolo, testo o immagine)
\end{itemize}

\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Le modifiche precedenti vengono annullate e il contenuto torna alla versione originale generata dall'AI\textsubscript{\scalebox{0.6}{\textbf{G}}}
\end{itemize}
...
\begin{enumerate}
    ...
    \item Il sistema invia direttamente i dati al motore AI\textsubscript{\scalebox{0.6}{\textbf{G}}} per generare un nuovo output senza richiedere modifiche all'utente
\end{enumerate}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Diagrammi casi d'uso/UC1I.jpg}
...
\begin{enumerate}
    ...
    \item Il sistema reindirizza l'utente alla pagina di creazione, pre-popolando i campi con i valori recuperati dallo storico (prompt, tono, stile)
...
\begin{itemize}
    \item \textit{include}: 
    \begin{itemize}
        \item UC-1I.1 - Duplica prompt
        \item UC-1I.2 - Duplica tono
        \item UC-1I.3 - Duplica stile
    \end{itemize}
\end{itemize}
...
\textbf{Pre-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Un elemento é stato selezionato
\end{itemize}

\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Il campo viene compilato con il prompt dell'elemento
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente seleziona un elemento
    \item Il campo per la generazione viene riempito con il prompt dell'elemento selezionato
\end{enumerate}

\vspace{0.5cm}

\subUseCase{Duplica tono}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Il campo viene compilato con il tono dell'elemento
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente seleziona un elemento
    \item Il campo per la generazione viene riempito con il tono dell'elemento selezionato
\end{enumerate}

\vspace{0.5cm}

\subUseCase{Duplica stile}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Il campo viene compilato con il stile dell'elemento
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente seleziona un elemento
    \item Il campo per la generazione viene riempito con il stile dell'elemento selezionato
\end{enumerate}

\vspace{0.5cm}

\useCase{Filtraggio lista generazioni storico per stile}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Diagrammi casi d'uso/UC1J.jpg}
    \caption{Diagramma del caso d'uso UC-1J – Filtraggio lista generazioni storico per stile}
\end{figure}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Viene applicato un filtro tramite la categoria "stile" alla lista delle generazioni dello storico
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente inserisce un testo chiave (stile) alla barra di ricerca
...
\useCase{Visualizzazione lista elementi storico filtrata}
 ...
 \begin{figure}[H]
     \centering
     \includegraphics[width=0.7\textwidth]{Diagrammi casi d'uso/UC1K.jpg}
...
\useCase{Rigenera contenuto tramite AI\textsubscript{\scalebox{0.6}{\textbf{G}}}}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Diagrammi casi d'uso/UC1L.jpg}
    \caption{Diagramma del caso d'uso UC-1L – Rigenera contenuto tramite AI\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\end{figure}
...
\begin{enumerate}
    ...
    \item Il sistema invia una nuova richiesta all'AI\textsubscript{\scalebox{0.6}{\textbf{G}}}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Il feedback dell'utente (una valutazione da 1 a cinque) viene registrato e associato al contenuto nello storico
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente esprime un giudizio sulla qualità\textsubscript{\scalebox{0.6}{\textbf{G}}} del contenuto assegnando una valutazione da 1 a cinque
...
\begin{enumerate}
    ...
    \item Lo stile viene salvato all'interno del sistema ed è utilizzabile per generazioni future
\end{enumerate}
...
\useCase{Filtraggio lista generazioni storico per timestamp}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Diagrammi casi d'uso/UC1T.jpg}
    \caption{Diagramma del caso d'uso UC-1T – Filtraggio lista generazioni storico per timestamp}
\end{figure}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Viene applicato un filtro tramite la categoria "timestamp" alla lista delle generazioni dello storico
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente inserisce un testo chiave (timestamp) alla barra di ricerca
    \item Il sistema filtra gli elementi dello storico in tempo reale
\end{enumerate}
...
\useCase{Filtraggio lista generazioni storico per valutazione}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Diagrammi casi d'uso/UC1U.jpg}
    \caption{Diagramma del caso d'uso UC-1U – Filtraggio lista generazioni storico per valutazione}
\end{figure}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Viene applicato un filtro tramite la categoria "valutazione" alla lista delle generazioni dello storico
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente inserisce un testo chiave (valutazione) alla barra di ricerca
    \item Il sistema filtra gli elementi dello storico in tempo reale
\end{enumerate}
...
\useCase{Filtraggio lista generazioni storico per tono}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Diagrammi casi d'uso/UC1V.jpg}
    \caption{Diagramma del caso d'uso UC-1V – Filtraggio lista generazioni storico per tono}
\end{figure}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Viene applicato un filtro tramite la categoria "tono" alla lista delle generazioni dello storico
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente inserisce un testo chiave (tono) alla barra di ricerca
    \item Il sistema filtra gli elementi dello storico in tempo reale
\end{enumerate}
...
\useCase{Filtraggio lista generazioni storico per prompt}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Diagrammi casi d'uso/UC1W.jpg}
    \caption{Diagramma del caso d'uso UC-1W – Filtraggio lista generazioni storico per prompt}
\end{figure}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Viene applicato un filtro tramite la categoria "prompt" alla lista delle generazioni dello storico
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente inserisce un testo chiave (prompt) alla barra di ricerca
    \item Il sistema filtra gli elementi dello storico in tempo reale
\end{enumerate}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Il documento è stato analizzato tramite l'AI\textsubscript{\scalebox{0.6}{\textbf{G}}} e i dati sono stati inviati al sistema
\end{itemize}
...
\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente dalla Dashboard\textsubscript{\scalebox{0.6}{\textbf{G}}} principale accede al Modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} AI Co-Pilot\textsubscript{\scalebox{0.6}{\textbf{G}}} per i Consulenti del Lavoro\textsubscript{\scalebox{0.6}{\textbf{G}}}.
    \item L'utente procede a caricare il file che si desidera far analizzare
    \item L'utente inserisce i metadati al file caricato: categoria, mese/anno di competenza, azienda, reparto.
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Al file viene associato uno specifico reparto o dipartimento (opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}})
\end{itemize}
...
\textbf{Pre-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item La lista dei documenti contiene almeno un elemento
\end{itemize}
...
\begin{itemize}
    ...
    \item \textit{generalizzazione}: 
    \begin{itemize}
        \item UC-2Q – Visualizzazione lista documenti filtrata
    \end{itemize}
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Diagrammi casi d'uso/UC2D.jpg}
...
\begin{enumerate}
    ...
    \item L'utente ricerca e seleziona il destinatario corretto dall'anagrafica (identificato da email o matricola).
...
\begin{itemize}
    \item \textit{include}: 
    \begin{itemize}
        \item UC-2D.1 – Inserimento email destinatario documento
        \item UC-2D.2 – Inserimento matricola destinatario documento
    \end{itemize}
\end{itemize}
...
\subUseCase{Inserimento email destinatario documento}
...
\begin{itemize}
    ...
    \item Si ha a disposizione l'email del destinatario corretto
\end{itemize}

\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Il nuovo destinatario è identificato dall'email
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'operatore CdL inserisce l'email del destinatario corretto
    \item Il sistema assegna come nuovo destinatario il possessore dell'email inserita
\end{enumerate}

\vspace{0.5cm}

\subUseCase{Inserimento matricola destinatario documento}
...
\begin{itemize}
    \item La lista dei destinatari contiene almeno un elemento
    \item Si ha a disposizione la matricola del destinatario corretto
\end{itemize}

\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Il nuovo destinatario è identificato dalla matricola
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'operatore CdL inserisce la matricola del destinatario corretto
    \item Il sistema assegna come nuovo destinatario il possessore della matricola inserita
\end{enumerate}
...
\useCase{Rivaluta percentuale confidenza\textsubscript{\scalebox{0.6}{\textbf{g}}}}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Diagrammi casi d'uso/UC2F.jpg}
    \caption{Diagramma del caso d'uso UC-2F – Rivaluta percentuale confidenza\textsubscript{\scalebox{0.6}{\textbf{g}}}}
\end{figure}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item La percentuale di confidenza\textsubscript{\scalebox{0.6}{\textbf{g}}} viene ricalcolata (validazione\textsubscript{\scalebox{0.6}{\textbf{G}}} manuale).
\end{itemize}
...
\begin{enumerate}
    ...
    \item Il sistema aggiorna la percentuale di confidenza\textsubscript{\scalebox{0.6}{\textbf{g}}} per riflettere la nuova coerenza dei dati o la validazione\textsubscript{\scalebox{0.6}{\textbf{G}}} manuale dell'utente.
\end{enumerate}
...
\begin{itemize}
    ...
    \item \textit{generalizzazione}: 
    \begin{itemize}
        \item UC-2S – Visualizzazione lista destinatari filtrata
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \item \textit{generalizzazione}: 
    \begin{itemize}
        \item UC-2U – Visualizzazione lista storico documenti filtrata
    \end{itemize}
\end{itemize}
...
\begin{enumerate}
    ...
    \item Il sistema renderizza le colonne della tabella mostrando: Codice documento, Data caricamento, Stato elaborazione e Percentuale di confidenza\textsubscript{\scalebox{0.6}{\textbf{g}}}.
\end{enumerate}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item UC-2B.10 – Visualizzazione codice documento
        \item UC-2H.3 - Visualizzazione percentuale confidenza\textsubscript{\scalebox{0.6}{\textbf{g}}}
...
\subUseCase{Visualizzazione percentuale confidenza\textsubscript{\scalebox{0.6}{\textbf{g}}}}
...
\begin{itemize}
    \item La lista contiene almeno un elemento
    \item È stata calcolata la percentuale di confidenza\textsubscript{\scalebox{0.6}{\textbf{g}}} media del documento
\end{itemize}

\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Viene mostrato un indicatore numerico o visivo dell'affidabilità\textsubscript{\scalebox{0.6}{\textbf{G}}} dei dati estratti.
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item Il sistema recupera il punteggio di confidenza\textsubscript{\scalebox{0.6}{\textbf{g}}} calcolato durante l'importazione.
    \item Il sistema formatta il dato come percentuale.
    \item Il sistema visualizza il dato, evidenziandolo (es. in rosso) se la confidenza\textsubscript{\scalebox{0.6}{\textbf{g}}} è sotto una soglia di sicurezza\textsubscript{\scalebox{0.6}{\textbf{G}}}, suggerendo un controllo manuale.
\end{enumerate}
...
\useCase{Carica template\textsubscript{\scalebox{0.6}{\textbf{G}}} messaggio}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Diagrammi casi d'uso/UC2I.jpg}
    \caption{Diagramma del caso d'uso UC-2I – Carica template\textsubscript{\scalebox{0.6}{\textbf{G}}} messaggio}
\end{figure}
...
\textbf{Pre-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item L'utente ha selezionato un template\textsubscript{\scalebox{0.6}{\textbf{G}}} dalla lista dei template\textsubscript{\scalebox{0.6}{\textbf{G}}} disponibili
\end{itemize}

\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item I dati del template\textsubscript{\scalebox{0.6}{\textbf{G}}} (Oggetto e Corpo del messaggio) vengono trasferiti nei campi di input della pagina di gestione messaggio
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente clicca sul pulsante "Carica" o sulla riga del template\textsubscript{\scalebox{0.6}{\textbf{G}}} desiderato.
    \item Il sistema recupera il contenuto del template\textsubscript{\scalebox{0.6}{\textbf{G}}} (testo e oggetto).
...
\useCase{Salva nuovo template\textsubscript{\scalebox{0.6}{\textbf{G}}} messaggio}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Diagrammi casi d'uso/UC2L.jpg}
    \caption{Diagramma del caso d'uso UC-2L – Salva nuovo template\textsubscript{\scalebox{0.6}{\textbf{G}}} messaggio}
\end{figure}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Il contenuto del messaggio viene salvato nel database dei template\textsubscript{\scalebox{0.6}{\textbf{G}}} personali o globali.
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente, soddisfatto del messaggio attuale, clicca sul pulsante "Salva come template\textsubscript{\scalebox{0.6}{\textbf{G}}}".
    \item Il sistema richiede di assegnare un nome al nuovo template\textsubscript{\scalebox{0.6}{\textbf{G}}}.
    \item L'utente inserisce il nome e conferma.
    \item Il sistema salva il template\textsubscript{\scalebox{0.6}{\textbf{G}}} rendendolo disponibile per futuri utilizzi (vedi UC-2G).
\end{enumerate}

\vspace{0.5cm}


\useCase{Elimina template\textsubscript{\scalebox{0.6}{\textbf{G}}} messaggio}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Diagrammi casi d'uso/UC2M.jpg}
    \caption{Diagramma del caso d'uso UC-2M – Elimina template\textsubscript{\scalebox{0.6}{\textbf{G}}} messaggio}
\end{figure}
...
\textbf{Pre-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item L'utente visualizza la lista dei template\textsubscript{\scalebox{0.6}{\textbf{G}}} salvati (UC-2G).
    \item Il template\textsubscript{\scalebox{0.6}{\textbf{G}}} da eliminare è presente in lista.
\end{itemize}

\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Il template\textsubscript{\scalebox{0.6}{\textbf{G}}} viene rimosso definitivamente dal sistema.
    \item La lista viene aggiornata e non mostra più il template\textsubscript{\scalebox{0.6}{\textbf{G}}} eliminato.
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente identifica un template\textsubscript{\scalebox{0.6}{\textbf{G}}} obsoleto o errato nella tabella.
...
\useCase{Visualizzazione lista template\textsubscript{\scalebox{0.6}{\textbf{G}}}}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Diagrammi casi d'uso/UC2N.jpg}
    \caption{Diagramma del caso d'uso UC-2N – Visualizzazione lista template\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\end{figure}
...
\textbf{Pre-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item La lista contiene almeno un template\textsubscript{\scalebox{0.6}{\textbf{G}}} salvato
\end{itemize}

\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item L'utente visualizza la lista di template\textsubscript{\scalebox{0.6}{\textbf{G}}} salvati nel suo insieme
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente si trova nella sezione di gestione messaggi e vuole utilizzare un template\textsubscript{\scalebox{0.6}{\textbf{G}}} salvato
    \item L'utente vede l'elenco di tutti i template\textsubscript{\scalebox{0.6}{\textbf{G}}} relativi ai messaggi salvati
\end{enumerate}
...
\begin{itemize}
    \item \textit{include}: 
    \begin{itemize}
        \item UC-2N.1 – Visualizzazione elemento da lista template\textsubscript{\scalebox{0.6}{\textbf{G}}}
    \end{itemize}
\end{itemize}
...
\subUseCase{Visualizzazione elemento da lista template\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\textbf{Attori\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Operatore CdL\textsubscript{\scalebox{0.6}{\textbf{G}}}
\end{itemize}
...
\textbf{Pre-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item è stato salvato almeno un template\textsubscript{\scalebox{0.6}{\textbf{G}}} di messaggio.
\end{itemize}
...
\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente vuole visualizzare i dettagli di un template\textsubscript{\scalebox{0.6}{\textbf{G}}} salvato.
\end{enumerate}
...
\begin{itemize}
    \item \textit{include}: 
    \begin{itemize}
        \item UC-2N.2 – Visualizzazione oggetto template\textsubscript{\scalebox{0.6}{\textbf{G}}}
        \item UC-2N.3 – Visualizzazione testo template\textsubscript{\scalebox{0.6}{\textbf{G}}}
        \item UC-2N.4 – Visualizzazione codice template\textsubscript{\scalebox{0.6}{\textbf{G}}}
    \end{itemize}
    \item \textit{extend}: 
    \begin{itemize}
        \item Nessuno
...
\subUseCase{Visualizzazione oggetto template\textsubscript{\scalebox{0.6}{\textbf{G}}}}
...
\textbf{Pre-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Si sta visualizzando la tabella dei template\textsubscript{\scalebox{0.6}{\textbf{G}}} messaggio
\end{itemize}

\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Recupero dell'oggetto del messaggio nel template\textsubscript{\scalebox{0.6}{\textbf{G}}}
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item Il sistema recupera l'oggetto del template\textsubscript{\scalebox{0.6}{\textbf{G}}}.
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Recupero del testo del messaggio nel template\textsubscript{\scalebox{0.6}{\textbf{G}}}
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item Il sistema recupera il testo del template\textsubscript{\scalebox{0.6}{\textbf{G}}}.
    \item Il sistema mostra il contenuto nel campo dedicato.
\end{enumerate}

\vspace{0.5cm}

\subUseCase{Visualizzazione codice template\textsubscript{\scalebox{0.6}{\textbf{G}}}}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Recupero del codice del template\textsubscript{\scalebox{0.6}{\textbf{G}}}
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item Il sistema recupera il codice del template\textsubscript{\scalebox{0.6}{\textbf{G}}}.
    \item Il sistema mostra il contenuto nel campo dedicato.
\end{enumerate}
...
\useCase{Filtraggio lista documenti analisi per tipologia documento}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Diagrammi casi d'uso/UC2P.jpg}
    \caption{Diagramma del caso d'uso UC-2P – Filtraggio lista documenti analisi per tipologia documento}
\end{figure}
...
\textbf{Pre-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item L'utente visualizza la lista contenente i documenti analizzati
    \item Lo lista ha almeno un elemento
\end{itemize}

\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Viene applicato un filtro tramite la categoria "tipologia" alla lista dei documenti
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente inserisce un testo chiave (tipologia) alla barra di ricerca
    \item Il sistema filtra gli elementi della lista in tempo reale
\end{enumerate}
...
\useCase{Visualizzazione lista documenti filtrata}
 ...
 \begin{figure}[H]
     \centering
     \includegraphics[width=0.6\textwidth]{Diagrammi casi d'uso/UC2Q.jpg}
...
\useCase{Filtraggio lista destinatari analisi per matricola}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Diagrammi casi d'uso/UC2R.jpg}
    \caption{Diagramma del caso d'uso UC-2R – Filtraggio lista destinatari analisi per matricola}
\end{figure}
...
\textbf{Pre-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item L'utente visualizza la lista contenente i destinatari per i documenti analizzati
    \item Lo lista ha almeno un elemento
\end{itemize}

\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Viene applicato un filtro tramite la categoria "matricola" alla lista dei destinatari per i documenti analizzati
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente inserisce un testo chiave (matricola) alla barra di ricerca
    \item Il sistema filtra gli elementi della lista in tempo reale
\end{enumerate}
...
\useCase{Visualizzazione lista destinatari filtrata}
 ...
 \begin{figure}[H]
     \centering
     \includegraphics[width=0.6\textwidth]{Diagrammi casi d'uso/UC2S.jpg}
...
\useCase{Filtraggio lista documenti storico per lista distribuzione}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Diagrammi casi d'uso/UC2T.jpg}
    \caption{Diagramma del caso d'uso UC-2T – Filtraggio lista documenti analisi per lista distribuzione}
\end{figure}
...
\textbf{Pre-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item L'utente visualizza la lista contenente i documenti nello storico analizzati
    \item Lo lista ha almeno un elemento
\end{itemize}

\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Viene applicato un filtro tramite la categoria "lista distribuzione" alla lista dei documenti nello storico
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente inserisce un testo chiave (lista distribuzione) alla barra di ricerca
    \item Il sistema filtra gli elementi della lista in tempo reale
\end{enumerate}
...
\useCase{Visualizzazione audit documento}


\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Diagrammi casi d'uso/UC2V.jpg}
    \caption{Diagramma del caso d'uso UC-2V – Visualizzazione audit documento}
\end{figure}
...
\textbf{Pre-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Almeno un documento è presente nello storico.
    \item L'utente ha selezionato un documento specifico dallo storico.
\end{itemize}

\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item L'utente visualizza l'audit del documento selezionato nello storico.
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente si trova nel Modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} storico dell'AI Co-Pilot\textsubscript{\scalebox{0.6}{\textbf{G}}}
    \item L'utente vede visualizza i vari stati di un documento (es. creato, in attesa, inviato, consegnato) con relative date e orari.
\end{enumerate}

\vspace{0.5cm}

\useCase{Filtraggio lista documenti analisi per competenza}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Diagrammi casi d'uso/UC2W.jpg}
    \caption{Diagramma del caso d'uso UC-2W – Filtraggio lista documenti analisi per competenza documento}
\end{figure}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Viene applicato un filtro tramite la categoria "competenza" alla lista dei documenti
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente inserisce un testo chiave (competenza) alla barra di ricerca
    \item Il sistema filtra gli elementi della lista in tempo reale
\end{enumerate}
...
\useCase{Filtraggio lista documenti analisi per documento originale}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Diagrammi casi d'uso/UC2X.jpg}
    \caption{Diagramma del caso d'uso UC-2X – Filtraggio lista documenti analisi per documento originale}
\end{figure}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Viene applicato un filtro tramite la categoria "documento originale" alla lista dei documenti
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente inserisce un testo chiave (documento originale) alla barra di ricerca
    \item Il sistema filtra gli elementi della lista in tempo reale
\end{enumerate}
...
\useCase{Filtraggio lista destinatari analisi per reparto}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Diagrammi casi d'uso/UC2Y.jpg}
    \caption{Diagramma del caso d'uso UC-2Y – Filtraggio lista destinatari analisi per reparto}
\end{figure}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Viene applicato un filtro tramite la categoria "reparto" alla lista dei destinatari per i documenti analizzati
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente inserisce un testo chiave (reparto) alla barra di ricerca
    \item Il sistema filtra gli elementi della lista in tempo reale
\end{enumerate}
...
\useCase{Filtraggio lista destinatari analisi per codice documento}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Diagrammi casi d'uso/UC2Z.jpg}
    \caption{Diagramma del caso d'uso UC-2Z – Filtraggio lista destinatari analisi per codice documento}
\end{figure}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Viene applicato un filtro tramite la categoria "codice documento" alla lista dei destinatari per i documenti analizzati
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente inserisce un testo chiave (codice documento) alla barra di ricerca
    \item Il sistema filtra gli elementi della lista in tempo reale
\end{enumerate}
...
\useCase{Filtraggio lista documenti storico per confidenza\textsubscript{\scalebox{0.6}{\textbf{g}}}}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Diagrammi casi d'uso/UC2AA.jpg}
    \caption{Diagramma del caso d'uso UC-2AA – Filtraggio lista documenti analisi per confidenza\textsubscript{\scalebox{0.6}{\textbf{g}}}}
\end{figure}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Viene applicato un filtro tramite la categoria "confidenza\textsubscript{\scalebox{0.6}{\textbf{g}}}" alla lista dei documenti nello storico
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente inserisce un testo chiave (confidenza\textsubscript{\scalebox{0.6}{\textbf{g}}}) alla barra di ricerca
    \item Il sistema filtra gli elementi della lista in tempo reale
\end{enumerate}
...
\useCase{Filtraggio lista documenti storico per stato}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Diagrammi casi d'uso/UC2AB.jpg}
    \caption{Diagramma del caso d'uso UC-2AB – Filtraggio lista documenti analisi per stato}
\end{figure}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Viene applicato un filtro tramite la categoria "stato" alla lista dei documenti nello storico
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente inserisce un testo chiave (stato) alla barra di ricerca
    \item Il sistema filtra gli elementi della lista in tempo reale
\end{enumerate}
...
\begin{enumerate}
    ...
    \item Il sistema calcola e mostra una panoramica generale (\textsubscript{\scalebox{0.6}{\textbf{G}}}) applicando i filtri di data.
    \item Il sistema visualizza i grafici e le tabelle relative alle metriche (confidenza\textsubscript{\scalebox{0.6}{\textbf{g}}}, rating, volumi) per il contesto di default.
\end{enumerate}
...
\begin{itemize}
    \item \textit{include}: 
    \begin{itemize}
        \item UC-3A.1 - Visualizzazione numero prompt\textsubscript{\scalebox{0.6}{\textbf{G}}} generati
        \item UC-3A.2 - Visualizzazione rating medio prompt\textsubscript{\scalebox{0.6}{\textbf{G}}} generati
        \item UC-3A.3 - Visualizzazione numero rigenerazioni prompt\textsubscript{\scalebox{0.6}{\textbf{G}}}
        \item UC-3A.4 - Visualizzazione toni più usati
        \item UC-3A.5 - Visualizzazione stili più usati
    \end{itemize}
    \item \textit{extend}: 
    \begin{itemize}
        \item Nessuna
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item L'utente visualizza il volume totale di richieste (prompt\textsubscript{\scalebox{0.6}{\textbf{G}}}) inviate all'AI\textsubscript{\scalebox{0.6}{\textbf{G}}} nel periodo selezionato.
\end{itemize}
...
\begin{enumerate}
    ...
    \item Il sistema visualizza il dato numerico (KPI\textsubscript{\scalebox{0.6}{\textbf{G}}}) in un widget dedicato della Dashboard\textsubscript{\scalebox{0.6}{\textbf{G}}} (es. "Totale prompt\textsubscript{\scalebox{0.6}{\textbf{G}}}: 1.250").
\end{enumerate}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item L'utente visualizza un indicatore della qualità\textsubscript{\scalebox{0.6}{\textbf{G}}} percepita delle risposte dell'AI\textsubscript{\scalebox{0.6}{\textbf{G}}}.
\end{itemize}
...
\begin{enumerate}
    ...
    \item Il sistema visualizza il totale delle rigenerazioni, dato utile per capire se la prima risposta dell'AI\textsubscript{\scalebox{0.6}{\textbf{G}}} è spesso insoddisfacente.
\end{enumerate}
...
\begin{itemize}
    \item \textit{include}: 
    \begin{itemize}
        \item UC-3B.1 - Visualizzazione confidenza\textsubscript{\scalebox{0.6}{\textbf{g}}} media
...
\subUseCase{Visualizzazione confidenza\textsubscript{\scalebox{0.6}{\textbf{g}}} media}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item L'utente visualizza il punteggio medio di affidabilità\textsubscript{\scalebox{0.6}{\textbf{G}}} (confidence score) che l'AI\textsubscript{\scalebox{0.6}{\textbf{G}}} ha attribuito alle sue estrazioni nel periodo selezionato.
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item Il sistema aggrega i punteggi di confidenza\textsubscript{\scalebox{0.6}{\textbf{g}}} di tutti i documenti elaborati nell'intervallo temporale.
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item L'utente visualizza la frequenza con cui gli operatori umani devono correggere i dati estratti dall'AI\textsubscript{\scalebox{0.6}{\textbf{G}}}.
\end{itemize}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item L'utente visualizza un indicatore che rappresenta la precisione con cui l'AI\textsubscript{\scalebox{0.6}{\textbf{G}}} associa i dati trovati ai campi corretti del database.
\end{itemize}
...
\begin{enumerate}
    ...
    \item Il sistema visualizza il dato, permettendo di identificare se l'AI\textsubscript{\scalebox{0.6}{\textbf{G}}} sta fallendo nel riconoscere specifici layout o tipologie di documento.
\end{enumerate}
...
\hline
\rowcolor{primaryblue!40}
\textbf{Codice} & \textbf{Descrizione} & \textbf{Fonti} & \textbf{Priorità\textsubscript{\scalebox{0.6}{\textbf{G}}}} \\
\hline
\endfirsthead
...
\autoRF & Il sistema deve permettere all'utente non autenticato di effettuare la registrazione di un nuovo account. & \hyperref[UC-0A]{UC-0A} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere all'utente di inserire il proprio indirizzo email in fase di registrazione. & \hyperref[UC-0A.1]{UC-0A.1} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere all'utente di inserire una password in fase di registrazione. & \hyperref[UC-0A.2]{UC-0A.2} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere all'utente di inserire un username in fase di registrazione. & \hyperref[UC-0A.3]{UC-0A.3} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere all'utente di inserire il proprio nome in fase di registrazione. & \hyperref[UC-0A.4]{UC-0A.4} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere all'utente di inserire il proprio cognome in fase di registrazione. & \hyperref[UC-0A.5]{UC-0A.5} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere all'utente di inserire la propria matricola in fase di registrazione. & \hyperref[UC-0A.6]{UC-0A.6} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare un messaggio di errore se il formato dell'email inserita non è valido. & \hyperref[UC-0A.7]{UC-0A.7} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare un messaggio di errore se la password non rispetta i criteri di sicurezza\textsubscript{\scalebox{0.6}{\textbf{G}}}. & \hyperref[UC-0A.8]{UC-0A.8} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve impedire la registrazione se l'email inserita è già associata a un account esistente. & \hyperref[UC-0A.9]{UC-0A.9} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve impedire la registrazione se lo username inserito è già utilizzato. & \hyperref[UC-0A.10]{UC-0A.10} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve impedire la registrazione se la matricola inserita è già presente nel sistema. & \hyperref[UC-0A.11]{UC-0A.11} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare un messaggio di errore se il formato della matricola non è valido. & \hyperref[UC-0A.12]{UC-0A.12} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere all'utente registrato di effettuare il login (autenticazione). & \hyperref[UC-0B]{UC-0B} , \hyperref[UC-0B.3]{UC-0B.3} , \hyperref[UC-0B.4]{UC-0B.4} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve notificare l'errore in caso di tentativo di login con email non registrata o password associata all'email errata. & \hyperref[UC-0B.1]{UC-0B.1} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve consentire all'utente di poter inserire i dati necessari al login. & \hyperref[UC-0B.2]{UC-0B.2} , \hyperref[UC-0B.3]{UC-0B.3} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere all'utente di visualizzare i dati del proprio profilo. & \hyperref[UC-0C]{UC-0C} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve mostrare l'email associata al profilo utente. & \hyperref[UC-0C.1]{UC-0C.1} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve mostrare (o permettere la gestione del) la password del profilo utente. & \hyperref[UC-0C.2]{UC-0C.2} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve mostrare lo username associato al profilo utente. & \hyperref[UC-0C.3]{UC-0C.3} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve mostrare il nome associato al profilo utente. & \hyperref[UC-0C.4]{UC-0C.4} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve mostrare il cognome associato al profilo utente. & \hyperref[UC-0C.5]{UC-0C.5} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve mostrare la matricola associata al profilo utente. & \hyperref[UC-0C.6]{UC-0C.6} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere all'utente di effettuare il logout terminando la sessione. & \hyperref[UC-0D]{UC-0D} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve gestire l'uscita dalla modifica profilo senza salvare i cambiamenti. & \hyperref[UC-0D.1]{UC-0D.1} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere all'Amministratore\textsubscript{\scalebox{0.6}{\textbf{G}}} di visualizzare la lista degli utenti registrati. & \hyperref[UC-0E]{UC-0E} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere la visualizzazione del dettaglio di un singolo utente dalla lista. & \hyperref[UC-0E.1]{UC-0E.1} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve mostrare il ruolo associato a un utente registrato. & \hyperref[UC-0E.2]{UC-0E.2} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve mostrare il nome di un utente registrato. & \hyperref[UC-0E.3]{UC-0E.3} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve mostrare il cognome di un utente registrato. & \hyperref[UC-0E.4]{UC-0E.4} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere all'Amministratore\textsubscript{\scalebox{0.6}{\textbf{G}}} di modificare il ruolo di un utente registrato. & \hyperref[UC-0F]{UC-0F}, \hyperref[UC-0F.1]{UC-0F.1} , \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere all'utente di effettuare il logout (terminare la sessione). & \hyperref[UC-0G]{UC-0G} , \hyperref[UC-0H]{UC-0H} , \hyperref[UC-0I]{UC-0I} , \hyperref[UC-0J]{UC-0J} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve generare contenuti testuali tramite AI Assistant\textsubscript{\scalebox{0.6}{\textbf{G}}} in base a prompt\textsubscript{\scalebox{0.6}{\textbf{G}}} e parametri. & \hyperref[UC-1A]{UC-1A} , \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere l'inserimento di un prompt\textsubscript{\scalebox{0.6}{\textbf{G}}} testuale per la generazione. & \hyperref[UC-1A.1]{UC-1A.1} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere la selezione del tono per la generazione del contenuto. & \hyperref[UC-1A.2]{UC-1A.2} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere la selezione dello stile per la generazione del contenuto. & \hyperref[UC-1A.3]{UC-1A.3} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere la visualizzazione dello storico delle generazioni AI\textsubscript{\scalebox{0.6}{\textbf{G}}}. & \hyperref[UC-1B]{UC-1B} , \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve notificare l'assenza di elementi se lo storico delle generazioni è vuoto. & \hyperref[UC-1B.1]{UC-1B.1} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve mostrare i dettagli completi di un elemento selezionato dallo storico. & \hyperref[UC-1B.2]{UC-1B.2} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare lo stile utilizzato per un contenuto nello storico. & \hyperref[UC-1B.3]{UC-1B.3} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare il testo del risultato generato nello storico. & \hyperref[UC-1B.4]{UC-1B.4} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare il timestamp (data/ora) della generazione nello storico. & \hyperref[UC-1B.5]{UC-1B.5} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare la valutazione assegnata dall'utente al contenuto nello storico. & \hyperref[UC-1B.6]{UC-1B.6} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare il prompt\textsubscript{\scalebox{0.6}{\textbf{G}}} originale utilizzato per un contenuto nello storico. & \hyperref[UC-1B.7]{UC-1B.7} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare il tono utilizzato per un contenuto nello storico. & \hyperref[UC-1B.8]{UC-1B.8} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve mostrare un'anteprima del contenuto generato dall'AI\textsubscript{\scalebox{0.6}{\textbf{G}}}. & \hyperref[UC-1C]{UC-1C}, \hyperref[UC-1C.1]{UC-1C.1}, \hyperref[UC-1C.2]{UC-1C.2}, \hyperref[UC-1C.3]{UC-1C.3} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di modificare l'immagine associata al contenuto generato. & \hyperref[UC-1D]{UC-1D} , \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve notificare l'utente quando tenta di caricare un file immagine non valido. & \hyperref[UC-1D.1]{UC-1D.1} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di modificare il titolo del contenuto generato. & \hyperref[UC-1E]{UC-1E} , \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di modificare il testo del corpo del contenuto generato. & \hyperref[UC-1F]{UC-1F} , \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di annullare le modifiche apportate al contenuto generato. & \hyperref[UC-1G]{UC-1G} , \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di riutilizzare i parametri di un contenuto dello storico per una nuova generazione. & \hyperref[UC-1H]{UC-1H} , \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di duplicare un contenuto dallo storico per modificarne i parametri. & \hyperref[UC-1I]{UC-1I} , \hyperref[UC-1I.1]{UC-1I.1} , \hyperref[UC-1I.2]{UC-1I.2} , \hyperref[UC-1I.3]{UC-1I.3} , \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di filtrare la lista delle generazioni nello storico. & \hyperref[UC-1J]{UC-1J} , \hyperref[UC-1T]{UC-1T} , \hyperref[UC-1U]{UC-1U} ,\hyperref[UC-1V]{UC-1V} ,\hyperref[UC-1W]{UC-1W} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare la lista dello storico aggiornata in base ai filtri applicati. & \hyperref[UC-1K]{UC-1K} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di rigenerare un contenuto tramite AI\textsubscript{\scalebox{0.6}{\textbf{G}}} mantenendo i parametri. & \hyperref[UC-1L]{UC-1L} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere all'utente di valutare (rating) il contenuto generato. & \hyperref[UC-1M]{UC-1M} , \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di scartare il contenuto generato e pulire l'interfaccia\textsubscript{\scalebox{0.6}{\textbf{G}}}. & \hyperref[UC-1N]{UC-1N} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di salvare il contenuto generato nel database. & \hyperref[UC-1O]{UC-1O} , \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere all'utente l'inserimento di un nuovo tono per la generazione di contenuti & \hyperref[UC-1P]{UC-1P} , \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere all'utente l'eliminazione di un tono per la generazione di contenuti & \hyperref[UC-1Q]{UC-1Q} , \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere all'utente l'inserimento di un nuovo stile per la generazione di contenuti & \hyperref[UC-1R]{UC-1R} , \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere all'utente l'eliminazione di uno stile per la generazione di contenuti & \hyperref[UC-1S]{UC-1S} , \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere l'analisi di documenti tramite il modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} AI Co-Pilot\textsubscript{\scalebox{0.6}{\textbf{G}}}. & \hyperref[UC-2A]{UC-2A} , \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere l'inserimento/selezione della categoria del documento. & \hyperref[UC-2A.1]{UC-2A.1} , \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere l'inserimento del mese/anno di competenza del documento. & \hyperref[UC-2A.2]{UC-2A.2} , \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere l'inserimento dell'azienda associata al documento. & \hyperref[UC-2A.3]{UC-2A.3} , \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere l'inserimento del reparto associato al documento. & \hyperref[UC-2A.4]{UC-2A.4} , \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere controllare la correttezza del formato del file inserito. & \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere controllare che lo stesso file non sia già stato analizzato. & \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere lo split di documenti diversi all'interno dello stesso file. & \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare la lista dei documenti analizzati. & \hyperref[UC-2B]{UC-2B}, \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve notificare l'utente se nessun documento è stato riconosciuto dall'analisi. & \hyperref[UC-2B.1]{UC-2B.1} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare i dettagli di un singolo documento dalla lista. & \hyperref[UC-2B.2]{UC-2B.2} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare la competenza (periodo) del documento analizzato. & \hyperref[UC-2B.3]{UC-2B.3} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare l'azienda associata al documento analizzato. & \hyperref[UC-2B.4]{UC-2B.4} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare la causale del documento analizzato. & \hyperref[UC-2B.5]{UC-2B.5} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare la lingua rilevata nel documento. & \hyperref[UC-2B.6]{UC-2B.6} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare il numero di pagine del documento. & \hyperref[UC-2B.7]{UC-2B.7} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare il nome originale del file del documento. & \hyperref[UC-2B.8]{UC-2B.8} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare la data di redazione/caricamento del documento. & \hyperref[UC-2B.9]{UC-2B.9} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare il codice identificativo del documento. & \hyperref[UC-2B.10]{UC-2B.10} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare la tipologia del documento. & \hyperref[UC-2B.11]{UC-2B.11} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve mostrare l'anteprima visiva del documento analizzato. & \hyperref[UC-2C]{UC-2C} , \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di modificare il destinatario associato al documento. & \hyperref[UC-2D]{UC-2D}, \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}}  & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di modificare la tipologia del documento. & \hyperref[UC-2E]{UC-2E} , \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve ricalcolare la percentuale di confidenza\textsubscript{\scalebox{0.6}{\textbf{g}}} dopo modifiche manuali. & \hyperref[UC-2F]{UC-2F} , \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare la lista delle informazioni sui destinatari estratti. & \hyperref[UC-2G]{UC-2G} , \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare i dettagli di un singolo destinatario in lista. & \hyperref[UC-2G.1]{UC-2G.1} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare il codice fiscale del destinatario. & \hyperref[UC-2G.2]{UC-2G.2} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare la matricola del destinatario. & \hyperref[UC-2G.3]{UC-2G.3} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare il reparto del destinatario. & \hyperref[UC-2G.4]{UC-2G.4} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare il nome/cognome del destinatario. & \hyperref[UC-2G.5]{UC-2G.5} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve notificare se nessun destinatario è stato riconosciuto. & \hyperref[UC-2G.6]{UC-2G.6} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare lo storico completo dei documenti processati. & \hyperref[UC-2H]{UC-2H} , \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve notificare l'assenza di documenti nello storico. & \hyperref[UC-2H.1]{UC-2H.1} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare i dettagli di un elemento nello storico documenti. & \hyperref[UC-2H.2]{UC-2H.2} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare la percentuale di confidenza\textsubscript{\scalebox{0.6}{\textbf{g}}} dell'analisi nello storico. & \hyperref[UC-2H.3]{UC-2H.3} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare l'appartenenza alle liste di distribuzione. & \hyperref[UC-2H.4]{UC-2H.4} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare lo stato di elaborazione del documento. & \hyperref[UC-2H.5]{UC-2H.5} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di caricare un template\textsubscript{\scalebox{0.6}{\textbf{G}}} di messaggio esistente. & \hyperref[UC-2I]{UC-2I} , \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di modificare l'oggetto del messaggio. & \hyperref[UC-2J]{UC-2J} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di modificare il testo del corpo del messaggio. & \hyperref[UC-2K]{UC-2K} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di salvare il messaggio corrente come nuovo template\textsubscript{\scalebox{0.6}{\textbf{G}}}. & \hyperref[UC-2L]{UC-2L} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di eliminare un template\textsubscript{\scalebox{0.6}{\textbf{G}}} di messaggio. & \hyperref[UC-2M]{UC-2M} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare la lista dei template\textsubscript{\scalebox{0.6}{\textbf{G}}} di messaggio disponibili. & \hyperref[UC-2N]{UC-2N} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare un elemento della lista dei template\textsubscript{\scalebox{0.6}{\textbf{G}}} di messaggio disponibili. & \hyperref[UC-2N.1]{UC-2N.1} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare l'oggetto del template\textsubscript{\scalebox{0.6}{\textbf{G}}}. & \hyperref[UC-2N.2]{UC-2N.2} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare il testo del template\textsubscript{\scalebox{0.6}{\textbf{G}}}. & \hyperref[UC-2N.3]{UC-2N.3} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare il codice del template\textsubscript{\scalebox{0.6}{\textbf{G}}}. & \hyperref[UC-2N.4]{UC-2N.4} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere l'invio del documento e del messaggio associato. & \hyperref[UC-2O]{UC-2O} , \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF &  Il sistema deve permettere di allegare ulteriore contenuto al messaggio. & \hyperref[UC-2O.1]{UC-2O.1} , \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di pianificare l'invio del documento e del messaggio associato. & \hyperref[UC-2O.2]{UC-2O.2} , \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere il filtraggio della lista dei documenti analizzati. & \hyperref[UC-2P]{UC-2P} , \hyperref[UC-2W]{UC-2W}, \hyperref[UC-2X]{UC-2X} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve mostrare la lista dei documenti aggiornata in base ai filtri. & \hyperref[UC-2Q]{UC-2Q} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere il filtraggio della lista dei destinatari. & \hyperref[UC-2R]{UC-2R} , \hyperref[UC-2Y]{UC-2Y} , \hyperref[UC-2Z]{UC-2Z} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve mostrare la lista dei destinatari aggiornata in base ai filtri. & \hyperref[UC-2S]{UC-2S} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere il filtraggio della lista dello storico documenti. & \hyperref[UC-2T]{UC-2T} , \hyperref[UC-2AA]{UC-2AA} , \hyperref[UC-2AB]{UC-2AB} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve mostrare la lista dello storico documenti aggiornata in base ai filtri. & \hyperref[UC-2U]{UC-2U} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di mostrare l'audit di un documento nello storico. & \hyperref[UC-2V]{UC-2V} , \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}}  & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare la dashboard\textsubscript{\scalebox{0.6}{\textbf{G}}} con i dati di analytics per l'AI Assistant\textsubscript{\scalebox{0.6}{\textbf{G}}}. & \hyperref[UC-3A]{UC-3A} , \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare il numero totale di prompt\textsubscript{\scalebox{0.6}{\textbf{G}}} generati. & \hyperref[UC-3A.1]{UC-3A.1} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare il rating medio dei prompt\textsubscript{\scalebox{0.6}{\textbf{G}}} generati. & \hyperref[UC-3A.2]{UC-3A.2} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare il numero di rigenerazioni effettuate. & \hyperref[UC-3A.3]{UC-3A.3} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare le statistiche sui toni più utilizzati. & \hyperref[UC-3A.4]{UC-3A.4} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare le statistiche sugli stili più utilizzati. & \hyperref[UC-3A.5]{UC-3A.5} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare la dashboard\textsubscript{\scalebox{0.6}{\textbf{G}}} con i dati di analytics per l'AI Co-Pilot\textsubscript{\scalebox{0.6}{\textbf{G}}}. & \hyperref[UC-3B]{UC-3B} , \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare la confidenza\textsubscript{\scalebox{0.6}{\textbf{g}}} media delle analisi documenti. & \hyperref[UC-3B.1]{UC-3B.1} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare la percentuale di interventi manuali necessari. & \hyperref[UC-3B.2]{UC-3B.2} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare l'accuratezza del mapping dei dati. & \hyperref[UC-3B.3]{UC-3B.3} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di visualizzare i tempi medi di analisi dei documenti. & \hyperref[UC-3B.4]{UC-3B.4} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
\autoRF & Il sistema deve permettere di filtrare i dati di analytics per periodo temporale. & \hyperref[UC-3C]{UC-3C} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
...
Definiscono gli attributi qualitativi del software che influenzano l'esperienza d'uso e la manutenibilità\textsubscript{\scalebox{0.6}{\textbf{G}}} del progetto\textsubscript{\scalebox{0.6}{\textbf{G}}}. Spesso indicati come "attributi di qualità\textsubscript{\scalebox{0.6}{\textbf{G}}}" (es. usabilità, affidabilità\textsubscript{\scalebox{0.6}{\textbf{G}}}, manutenibilità\textsubscript{\scalebox{0.6}{\textbf{G}}}).
\vspace{0.5cm}
...
\vspace{0.5cm}
\begin{longtable}{|L{\wCod}|L{\wDesc}|L{\wFonti}|L{\wPrio}|}
\caption{Tabella dei requisiti di qualità\textsubscript{\scalebox{0.6}{\textbf{G}}}}\label{tab:reqqualita}\\
\hline
\rowcolor{primaryblue!40}
\textbf{Codice} & \textbf{Descrizione} & \textbf{Fonti} & \textbf{Priorità\textsubscript{\scalebox{0.6}{\textbf{G}}}} \\
\hline
...
\endlastfoot
    ...
    RQ-01 & Presentare documento analisi dei Requisiti\textsubscript{\scalebox{0.6}{\textbf{G}}} contenente diagrammi e descrizioni Use Case & \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
    \hline
    RQ-02 & Il way of working\textsubscript{\scalebox{0.6}{\textbf{G}}} descritto in Norme di Progetto\textsubscript{\scalebox{0.6}{\textbf{G}}} deve essere rispettato & Interna & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
    \hline
    RQ-03 & Il Prodotto\textsubscript{\scalebox{0.6}{\textbf{G}}} deve passare tutti i test\textsubscript{\scalebox{0.6}{\textbf{G}}} con la copertura concordata con la proponente\textsubscript{\scalebox{0.6}{\textbf{G}}}, equivalente all'80\% & \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}}, Piano di Qualifica\textsubscript{\scalebox{0.6}{\textbf{G}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
    \hline
    RQ-04 & Il codice deve essere documentato secondo le linee guida descritte in Norme di Progetto\textsubscript{\scalebox{0.6}{\textbf{G}}} & \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}}, Interna & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
    \hline
    RQ-05 & È necessario versionare il codice tramite un sistema di controllo versione (Git) & \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
    \hline
    RQ-06 & Manuale utente per il prodotto sviluppato & \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
    \hline
...
\textbf{Caratteristiche}
\begin{enumerate}
    \item Possono essere di natura tecnologica (hardware, linguaggio), normativa (GDPR\textsubscript{\scalebox{0.6}{\textbf{G}}}) o di business (budget).
...
\endlastfoot
    ...
    RV-01 & Git come sistema di controllo versione & \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
    \hline
    RV-02 & API\textsubscript{\scalebox{0.6}{\textbf{G}}} \& Backend devono essere sviluppati in Ruby on Rails\textsubscript{\scalebox{0.6}{\textbf{G}}} & \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
    \hline
    RV-03 & Il database deve essere PostgreSQL\textsubscript{\scalebox{0.6}{\textbf{G}}} & \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
    \hline
    RV-04 & Il frontend deve essere sviluppato in Angular\textsubscript{\scalebox{0.6}{\textbf{G}}} (v21) & \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
    \hline
    RV-05 & La gestione dei modelli AI\textsubscript{\scalebox{0.6}{\textbf{G}}} deve essere implementata utilizzando AWS Bedrock\textsubscript{\scalebox{0.6}{\textbf{G}}} & \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
    \hline
    RV-06 & Eventuali background jobs gestiti con Sidekiq e PWA\textsubscript{\scalebox{0.6}{\textbf{G}}} con Next.js & \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}}, trattativa con la proponente\textsubscript{\scalebox{0.6}{\textbf{G}}} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
    \hline
    RV-07 & Requisiti minimi di sistema: RAM 2GB, Spazio 20 GB SSD, CPU 1-2 vCPU  & trattativa con la proponente\textsubscript{\scalebox{0.6}{\textbf{G}}} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
    \hline
    RV-08 & Requisiti minimi utente: Desktop 4GB, Mobile 2GB, Rete 3G stabile  & trattativa con la proponente\textsubscript{\scalebox{0.6}{\textbf{G}}} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
    \hline
    RV-09 & I browser supportati devono essere Chrome, Safari, Edge e Firefox & trattativa con la proponente\textsubscript{\scalebox{0.6}{\textbf{G}}} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
    \hline

\end{longtable}

\subsection{Tabella tracciamento}
Descrivono i servizi specifici e le funzioni che il sistema deve fornire. Rappresentano il "cosa" il sistema deve fare in risposta a determinati input o situazioni.
\vspace{0.5cm}
...
\newcounter{rfaCounter}

\newcommand{\autoRFa}{%
  \stepcounter{rfaCounter}% Incrementa il contatore
  RF-%
  \ifnum\value{rfaCounter}<100 0\fi % Aggiunge uno 0 se < 100
  \ifnum\value{rfaCounter}<10 0\fi  % Aggiunge un altro 0 se < 10
  \arabic{rfaCounter}% Stampa il numero
}

\setcounter{rfaCounter}{0}

\begin{longtable}{|L{\wCod}|L{\wDesc}|L{\wFonti}|L{\wPrio}|}
\caption{Tabella di tracciamento dei Requisiti funzionali\textsubscript{\scalebox{0.6}{\textbf{G}}}}\label{tab:reqfunzionali}\\
\hline
\rowcolor{primaryblue!40}
\textbf{Codice} & \textbf{Casi d'uso associati} \\
\hline
\endfirsthead
\multicolumn{4}{c}{{\bfseries \tablename\ \thetable{} -- continua dalla pagina precedente}}\\
\hline
...
\autoRFa & \hyperref[UC-0A]{UC-0A} \\
\hline
\autoRFa & \hyperref[UC-0A.1]{UC-0A.1} \\
\hline
\autoRFa & \hyperref[UC-0A.2]{UC-0A.2} \\
\hline
\autoRFa & \hyperref[UC-0A.3]{UC-0A.3} \\
\hline
\autoRFa & \hyperref[UC-0A.4]{UC-0A.4} \\
\hline
\autoRFa & \hyperref[UC-0A.5]{UC-0A.5} \\
\hline
\autoRFa & \hyperref[UC-0A.6]{UC-0A.6} \\
\hline
\autoRFa & \hyperref[UC-0A.7]{UC-0A.7} \\
\hline
\autoRFa & \hyperref[UC-0A.8]{UC-0A.8} \\
\hline
\autoRFa & \hyperref[UC-0A.9]{UC-0A.9} \\
\hline
\autoRFa & \hyperref[UC-0A.10]{UC-0A.10} \\
\hline
\autoRFa & \hyperref[UC-0A.11]{UC-0A.11} \\
\hline
\autoRFa & \hyperref[UC-0A.12]{UC-0A.12} \\
\hline
\autoRFa & \hyperref[UC-0B]{UC-0B} , \hyperref[UC-0B.3]{UC-0B.3} , \hyperref[UC-0B.4]{UC-0B.4} \\
\hline
\autoRFa & \hyperref[UC-0B.1]{UC-0B.1} \\
\hline
\autoRFa & \hyperref[UC-0B.2]{UC-0B.2} , \hyperref[UC-0B.3]{UC-0B.3} \\
\hline
\autoRFa & \hyperref[UC-0C]{UC-0C} \\
\hline
\autoRFa & \hyperref[UC-0C.1]{UC-0C.1} \\
\hline
\autoRFa & \hyperref[UC-0C.2]{UC-0C.2} \\
\hline
\autoRFa & \hyperref[UC-0C.3]{UC-0C.3} \\
\hline
\autoRFa & \hyperref[UC-0C.4]{UC-0C.4} \\
\hline
\autoRFa & \hyperref[UC-0C.5]{UC-0C.5} \\
\hline
\autoRFa & \hyperref[UC-0C.6]{UC-0C.6} \\
\hline
\autoRFa & \hyperref[UC-0D]{UC-0D} \\
\hline
\autoRFa & \hyperref[UC-0D.1]{UC-0D.1} \\
\hline
\autoRFa & \hyperref[UC-0E]{UC-0E} \\
\hline
\autoRFa & \hyperref[UC-0E.1]{UC-0E.1} \\
\hline
\autoRFa & \hyperref[UC-0E.2]{UC-0E.2} \\
\hline
\autoRFa & \hyperref[UC-0E.3]{UC-0E.3} \\
\hline
\autoRFa & \hyperref[UC-0E.4]{UC-0E.4} \\
\hline
\autoRFa & \hyperref[UC-0F]{UC-0F}, \hyperref[UC-0F.1]{UC-0F.1} \\
\hline
\autoRFa & \hyperref[UC-0G]{UC-0G} , \hyperref[UC-0H]{UC-0H} , \hyperref[UC-0I]{UC-0I} , \hyperref[UC-0J]{UC-0J} \\
\hline
\autoRFa & \hyperref[UC-1A]{UC-1A} \\
\hline
\autoRFa & \hyperref[UC-1A.1]{UC-1A.1} \\
\hline
\autoRFa & \hyperref[UC-1A.2]{UC-1A.2} \\
\hline
\autoRFa & \hyperref[UC-1A.3]{UC-1A.3} \\
\hline
\autoRFa & \hyperref[UC-1B]{UC-1B} \\
\hline
\autoRFa & \hyperref[UC-1B.1]{UC-1B.1} \\
\hline
\autoRFa & \hyperref[UC-1B.2]{UC-1B.2} \\
\hline
\autoRFa & \hyperref[UC-1B.3]{UC-1B.3} \\
\hline
\autoRFa & \hyperref[UC-1B.4]{UC-1B.4} \\
\hline
\autoRFa & \hyperref[UC-1B.5]{UC-1B.5} \\
\hline
\autoRFa & \hyperref[UC-1B.6]{UC-1B.6} \\
\hline
\autoRFa & \hyperref[UC-1B.7]{UC-1B.7} \\
\hline
\autoRFa & \hyperref[UC-1B.8]{UC-1B.8} \\
\hline
\autoRFa & \hyperref[UC-1C]{UC-1C}, \hyperref[UC-1C.1]{UC-1C.1}, \hyperref[UC-1C.2]{UC-1C.2}, \hyperref[UC-1C.3]{UC-1C.3} \\
\hline
\autoRFa & \hyperref[UC-1D]{UC-1D} \\
\hline
\autoRFa & \hyperref[UC-1D.1]{UC-1D.1} \\
\hline
\autoRFa & \hyperref[UC-1E]{UC-1E} \\
\hline
\autoRFa & \hyperref[UC-1F]{UC-1F} \\
\hline
\autoRFa & \hyperref[UC-1G]{UC-1G} \\
\hline
\autoRFa & \hyperref[UC-1H]{UC-1H} \\
\hline
\autoRFa & \hyperref[UC-1I]{UC-1I} , \hyperref[UC-1I.1]{UC-1I.1} , \hyperref[UC-1I.2]{UC-1I.2} , \hyperref[UC-1I.3]{UC-1I.3} \\
\hline
\autoRFa & \hyperref[UC-1J]{UC-1J} , \hyperref[UC-1T]{UC-1T} , \hyperref[UC-1U]{UC-1U} ,\hyperref[UC-1V]{UC-1V} ,\hyperref[UC-1W]{UC-1W} \\
\hline
\autoRFa & \hyperref[UC-1K]{UC-1K} \\
\hline
\autoRFa & \hyperref[UC-1L]{UC-1L} \\
\hline
\autoRFa & \hyperref[UC-1M]{UC-1M} \\
\hline
\autoRFa & \hyperref[UC-1N]{UC-1N} \\
\hline
\autoRFa & \hyperref[UC-1O]{UC-1O} \\
\hline
\autoRFa & \hyperref[UC-1P]{UC-1P} \\
\hline
\autoRFa & \hyperref[UC-1Q]{UC-1Q} \\
\hline
\autoRFa & \hyperref[UC-1R]{UC-1R} \\
\hline
\autoRFa & \hyperref[UC-1S]{UC-1S} \\
\hline
\autoRFa & \hyperref[UC-2A]{UC-2A} \\
\hline
\autoRFa & \hyperref[UC-2A.1]{UC-2A.1} \\
\hline
\autoRFa & \hyperref[UC-2A.2]{UC-2A.2} \\
\hline
\autoRFa & \hyperref[UC-2A.3]{UC-2A.3} \\
\hline
\autoRFa & \hyperref[UC-2A.4]{UC-2A.4} \\
\hline
\autoRFa & \hyperref[UC-2A]{UC-2A} \\
\hline
\autoRFa & \hyperref[UC-2A]{UC-2A} \\
...
\autoRFa & \hyperref[UC-2A]{UC-2A} \\
\hline
\autoRFa & \hyperref[UC-2B]{UC-2B} \\
\hline
\autoRFa & \hyperref[UC-2B.1]{UC-2B.1} \\
\hline
\autoRFa & \hyperref[UC-2B.2]{UC-2B.2} \\
\hline
\autoRFa & \hyperref[UC-2B.3]{UC-2B.3} \\
\hline
\autoRFa & \hyperref[UC-2B.4]{UC-2B.4} \\
\hline
\autoRFa & \hyperref[UC-2B.5]{UC-2B.5} \\
\hline
\autoRFa & \hyperref[UC-2B.6]{UC-2B.6} \\
\hline
\autoRFa & \hyperref[UC-2B.7]{UC-2B.7} \\
\hline
\autoRFa & \hyperref[UC-2B.8]{UC-2B.8} \\
\hline
\autoRFa & \hyperref[UC-2B.9]{UC-2B.9} \\
\hline
\autoRFa & \hyperref[UC-2B.10]{UC-2B.10} \\
\hline
\autoRFa & \hyperref[UC-2B.11]{UC-2B.11} \\
\hline
\autoRFa & \hyperref[UC-2C]{UC-2C} \\
\hline
\autoRFa & \hyperref[UC-2D]{UC-2D} \\
\hline
\autoRFa & \hyperref[UC-2E]{UC-2E} \\
\hline
\autoRFa & \hyperref[UC-2F]{UC-2F} \\
\hline
\autoRFa & \hyperref[UC-2G]{UC-2G} \\
\hline
\autoRFa & \hyperref[UC-2G.1]{UC-2G.1} \\
\hline
\autoRFa & \hyperref[UC-2G.2]{UC-2G.2} \\
\hline
\autoRFa & \hyperref[UC-2G.3]{UC-2G.3} \\
\hline
\autoRFa & \hyperref[UC-2G.4]{UC-2G.4} \\
\hline
\autoRFa & \hyperref[UC-2G.5]{UC-2G.5} \\
\hline
\autoRFa & \hyperref[UC-2G.6]{UC-2G.6} \\
\hline
\autoRFa & \hyperref[UC-2H]{UC-2H} \\
\hline
\autoRFa & \hyperref[UC-2H.1]{UC-2H.1} \\
\hline
\autoRFa & \hyperref[UC-2H.2]{UC-2H.2} \\
\hline
\autoRFa & \hyperref[UC-2H.3]{UC-2H.3} \\
\hline
\autoRFa & \hyperref[UC-2H.4]{UC-2H.4} \\
\hline
\autoRFa & \hyperref[UC-2H.5]{UC-2H.5} \\
\hline
\autoRFa & \hyperref[UC-2I]{UC-2I} \\
\hline
\autoRFa & \hyperref[UC-2J]{UC-2J} \\
\hline
\autoRFa & \hyperref[UC-2K]{UC-2K} \\
\hline
\autoRFa & \hyperref[UC-2L]{UC-2L} \\
\hline
\autoRFa & \hyperref[UC-2M]{UC-2M} \\
\hline
\autoRFa & \hyperref[UC-2N]{UC-2N} \\
\hline
\autoRFa & \hyperref[UC-2N.1]{UC-2N.1} \\
\hline
\autoRFa & \hyperref[UC-2N.2]{UC-2N.2} \\
\hline
\autoRFa & \hyperref[UC-2N.3]{UC-2N.3} \\
\hline
\autoRFa & \hyperref[UC-2N.4]{UC-2N.4} \\
\hline
\autoRFa & \hyperref[UC-2O]{UC-2O} \\
\hline
\autoRFa & \hyperref[UC-2O.1]{UC-2O.1} \\
\hline
\autoRFa & \hyperref[UC-2O.2]{UC-2O.2} \\
\hline
\autoRFa & \hyperref[UC-2P]{UC-2P} , \hyperref[UC-2W]{UC-2W}, \hyperref[UC-2X]{UC-2X} \\
\hline
\autoRFa & \hyperref[UC-2Q]{UC-2Q} \\
\hline
\autoRFa & \hyperref[UC-2R]{UC-2R} , \hyperref[UC-2Y]{UC-2Y} , \hyperref[UC-2Z]{UC-2Z} \\
\hline
\autoRFa & \hyperref[UC-2S]{UC-2S} \\
\hline
\autoRFa & \hyperref[UC-2T]{UC-2T} , \hyperref[UC-2AA]{UC-2AA} , \hyperref[UC-2AB]{UC-2AB} \\
\hline
\autoRFa & \hyperref[UC-2U]{UC-2U} \\
\hline
\autoRFa & \hyperref[UC-2V]{UC-2V}  \\
\hline
\autoRFa & \hyperref[UC-3A]{UC-3A} \\
\hline
\autoRFa & \hyperref[UC-3A.1]{UC-3A.1} \\
\hline
\autoRFa & \hyperref[UC-3A.2]{UC-3A.2} \\
\hline
\autoRFa & \hyperref[UC-3A.3]{UC-3A.3} \\
\hline
\autoRFa & \hyperref[UC-3A.4]{UC-3A.4} \\
\hline
\autoRFa & \hyperref[UC-3A.5]{UC-3A.5} \\
\hline
\autoRFa & \hyperref[UC-3B]{UC-3B} \\
\hline
\autoRFa & \hyperref[UC-3B.1]{UC-3B.1} \\
\hline
\autoRFa & \hyperref[UC-3B.2]{UC-3B.2} \\
\hline
\autoRFa & \hyperref[UC-3B.3]{UC-3B.3} \\
\hline
\autoRFa & \hyperref[UC-3B.4]{UC-3B.4} \\
\hline
\autoRFa & \hyperref[UC-3C]{UC-3C} \\
\hline
