...
\begin{enumerate}
    ...
    \item Il sistema visualizza il dato, evidenziandolo (es. in rosso) se la confidenza è sotto una soglia di sicurezza\textsubscript{\scalebox{0.6}{\textbf{G}}}, suggerendo un controllo manuale.
\end{enumerate}
...
\useCase{Filtraggio lista documenti storico per confidenza}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Diagrammi casi d'uso/UC2AA.jpg}
    \caption{Diagramma del caso d'uso UC-2AA – Filtraggio lista documenti analisi per confidenza}
\end{figure}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Viene applicato un filtro tramite la categoria "confidenza" alla lista dei documenti nello storico
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente inserisce un testo chiave (confidenza) alla barra di ricerca
    \item Il sistema filtra gli elementi della lista in tempo reale
\end{enumerate}
...
\hline
\autoRF & Il sistema deve ricalcolare la percentuale di confidenza dopo modifiche manuali. & \hyperref[UC-2F]{UC-2F} , \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
...
\hline
\autoRF & Il sistema deve permettere di visualizzare la percentuale di confidenza dell'analisi nello storico. & \hyperref[UC-2H.3]{UC-2H.3} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
...
\hline
\autoRF & Il sistema deve permettere di visualizzare la confidenza media delle analisi documenti. & \hyperref[UC-3B.1]{UC-3B.1} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
...
\endlastfoot
    ...
    \hline
    RQ-03 & Il Prodotto\textsubscript{\scalebox{0.6}{\textbf{G}}} deve passare tutti i test\textsubscript{\scalebox{0.6}{\textbf{G}}} con la copertura concordata con la proponente\textsubscript{\scalebox{0.6}{\textbf{G}}} & \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}}, Piano di Qualifica\textsubscript{\scalebox{0.6}{\textbf{G}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
    \hline
    ...
    \hline
    RQ-05 & È necessario versionare il codice con appositi strumenti di controllo versione, compreso di istruzioni di setup & \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
    \hline
    RQ-06 & Report finale di integrazione e suggerimenti di evoluzione & \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
    \hline
...
\endlastfoot
    ...
    \hline
    RV-04 & Il frontend deve essere sviluppato in Angular\textsubscript{\scalebox{0.6}{\textbf{G}}} & \href{\urlcap}{capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
    \hline
...
\endlastfoot
    ...
    RP-01 & Il sistema deve generare contenuti testuali tramite AI\textsubscript{\scalebox{0.6}{\textbf{G}}} (Modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} Assistant) entro 5 secondi per testi fino a 500 parole & Interna & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
    \hline
    RP-02 & Il sistema deve classificare e partizionare documenti PDF (Modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} Co-Pilot\textsubscript{\scalebox{0.6}{\textbf{G}}}) entro 3 secondi per pagina & Interna & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
    \hline
    RP-03 & Il tempo di risposta dell'interfaccia\textsubscript{\scalebox{0.6}{\textbf{G}}} utente per operazioni standard deve essere inferiore a 2 secondi & Interna & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
    \hline
    RP-04 & Il sistema deve supportare l'upload di file PDF fino a 20 MB & Interna & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
    \hline
    RP-05 & La Dashboard\textsubscript{\scalebox{0.6}{\textbf{G}}} di Analytics deve caricare le statistiche entro 3 secondi per dataset fino a 1000 documenti & Interna & Desiderabile\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
    \hline
    RP-06 & Il sistema deve garantire una disponibilità del 99\% durante l'orario lavorativo (8:00-18:00) & Interna & Desiderabile\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
    \hline
    RP-07 & Il sistema deve essere in grado di processare almeno 50 documenti in parallelo senza degrado delle performance & Interna & Desiderabile\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
    \hline
    RP-08 & Il tempo di estrazione OCR\textsubscript{\scalebox{0.6}{\textbf{G}}} per documenti scansionati deve essere inferiore a 5 secondi per pagina & Interna & Obbligatorio\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
    \hline
