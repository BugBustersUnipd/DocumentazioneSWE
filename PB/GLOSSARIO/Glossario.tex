...
\begin{center}
  ...
  \begin{tcolorbox}[colback=lightgray,colframe=primaryblue,width=0.85\textwidth,arc=3mm,boxrule=0.5pt]
    \begin{tabular}{@{}lp{0.7\textwidth}@{}}
      ...
      \textbf{Redattori}     & Alberto Autiero, Marco Favero, Alberto Pignat, Marco Piro, Linor Sadé, Leonardo Salviato, Luca Slongo \\
      \textbf{Verificatori}  & Marco Favero, Alberto Pignat\\
...
{\footnotesize
\begin{xltabular}{\textwidth}{|>{\raggedright\arraybackslash}p{1.5cm}|>{\raggedright\arraybackslash}p{2cm}|X|>{\raggedright\arraybackslash}p{1.8cm}|>{\raggedright\arraybackslash}p{2cm}|>{\raggedright\arraybackslash}p{2cm}|}
\hline
...
\hline
\endfirsthead % Fine intestazione prima pagina

\hline
\rowcolor{primaryblue!40}
\textbf{\color{white} Versione} & \textbf{\color{white} Data} & \textbf{\color{white} Descrizione} & \textbf{\color{white} Redatto} & \textbf{\color{white} Verificato} & \textbf{\color{white} Approvato} \\
\hline
\endhead % Fine intestazione per le pagine successive

\rowcolor{secondaryblue!10} 2.0.0 & 27/03/2026 & Approvazione del documento & - &  - & Linor Sadé\\
\hline
\rowcolor{secondaryblue!10} 1.4.0 & 30/03/2026 & Verifica del documento & - &  Alberto Autiero & -\\
\hline
\rowcolor{secondaryblue!10} 1.3.1 & 30/03/2026 & Sono stati aggiunti nuovi termini & Luca Slongo &  & -\\
\hline
\rowcolor{secondaryblue!10} 1.3.0 & 27/03/2026 & Verifica del documento & - &  Marco Favero & -\\
\hline
\rowcolor{secondaryblue!10} 1.2.1 & 19/03/2026 & Sono stati aggiunti nuovi termini & Luca Slongo &  & -\\
\hline
\rowcolor{secondaryblue!10} 1.2.0 & 10/03/2026 & Verifica & - & Marco Favero & -\\
\hline
\rowcolor{secondaryblue!10} 1.1.1 & 10/03/2026 & Sono stati aggiunti nuovi termini & Alberto Autiero &  & -\\
\hline
\rowcolor{secondaryblue!10} 1.1.0 & 27/02/2026 & Verifica & - & Alberto Pignat & -\\
\hline
\rowcolor{secondaryblue!10} 1.0.1 & 27/02/2026 & Sono stati aggiunti nuovi termini & Leonardo Salviato &  & -\\
\hline
\rowcolor{secondaryblue!10} 1.0.0 & 30/01/2026 & Approvazione del documento & - &  & Luca Slongo\\
\hline
\rowcolor{secondaryblue!10} 0.1.0 & 30/01/2026 & Verifica del documento & - & Alberto Pignat & - \\
\hline
\rowcolor{secondaryblue!10} 0.0.11 & 29/01/2026 & Sono stati aggiunti nuovi termini & Luca Slongo & - & - \\
\hline
\rowcolor{secondaryblue!10} 0.0.10 & 06/01/2026 & Sono stati aggiunti nuovi termini & Leonardo Salviato & - & - \\
\hline
\rowcolor{secondaryblue!10} 0.0.9 & 23/12/2025 & Sono stati aggiunti nuovi termini & Linor Sadé & - & - \\
\hline
\rowcolor{secondaryblue!10} 0.0.8 & 14/12/2025 & Sono stati aggiunti nuovi termini & Marco Piro & - & - \\
\hline
\rowcolor{secondaryblue!10} 0.0.7 & 14/12/2025 & Riorganizzazione documento & Marco Piro & - & - \\
\hline
\rowcolor{secondaryblue!10} 0.0.6 & 12/12/2025 & Sono stati aggiunti nuovi termini & Marco Piro & - & - \\
\hline
\rowcolor{secondaryblue!10} 0.0.5 & 06/12/2025 & Sono stati aggiunti nuovi termini & Alberto Pignat & - & - \\
\hline
\rowcolor{secondaryblue!10} 0.0.4 & 30/11/2025 & Sono stati aggiunti nuovi termini & Alberto Pignat & - & - \\
\hline
\rowcolor{secondaryblue!10} 0.0.3 & 23/11/2025 & Sono stati aggiunti nuovi termini & Marco Favero & - & - \\
\hline
\rowcolor{secondaryblue!10} 0.0.2 & 17/11/2025 & Sono stati aggiunti nuovi termini & Marco Favero & - & - \\
\hline
\rowcolor{secondaryblue!10} 0.0.1 & 10/11/2025 & Prima stesura del documento con i termini del capitolato aggiudicato (5) e dalle diapositive dei docenti& Marco Favero & - & - \\
\hline
\end{xltabular}
}
...
Metrica di testing che misura la percentuale di rami decisionali (branch) del codice eseguiti durante i test. Ogni struttura condizionale (if-else, switch-case) crea branch multipli e questa metrica verifica che entrambi i percorsi (vero/falso) di ogni condizione siano stati testati almeno una volta. Un valore elevato di branch coverage indica una migliore copertura dei possibili flussi di esecuzione del programma, riducendo il rischio di bug nascosti in percorsi non testati.
...
Metrica che misura la percentuale di codice sorgente effettivamente eseguito durante l'esecuzione dei test automatizzati. Rappresenta il rapporto tra le linee di codice testate e il totale delle linee di codice del programma, espresso in percentuale. Un elevato code coverage indica che la maggior parte del codice è stata verificata attraverso i test, riducendo la probabilità di bug non rilevati. Tuttavia, un'alta percentuale non garantisce automaticamente la qualità dei test, che devono anche verificare correttamente il comportamento atteso del software.
...
\subsection{Complessità Ciclomatica (Cyclomatic Complexity)}
Metrica software che misura la complessità strutturale di un programma o di un singolo metodo calcolando il numero di percorsi linearmente indipendenti attraverso il codice sorgente. Viene calcolata contando il numero di punti decisionali (if, while, for, case) più uno. Un valore elevato indica codice complesso, difficile da testare, mantenere e comprendere. Valori tipici: 1-10 (semplice), 11-20 (moderatamente complesso), 21-50 (complesso), oltre 50 (non testabile). Viene utilizzata per identificare metodi che necessitano di refactoring per migliorare la manutenibilità.
...
\subsection{Confidence score (Percentuale di confidenza)}
Valore percentuale prodotto dal modulo AI Co-Pilot che indica il grado di affidabilità con cui il sistema ha classificato un documento e identificato i relativi destinatari. Un valore elevato indica che l'estrazione automatica è considerata corretta e non richiede intervento umano; un valore al di sotto della soglia prestabilita segnala invece la necessità di una revisione manuale da parte dell'operatore. 
...
\subsection{Docker}
Piattaforma open-source che consente di creare, distribuire ed eseguire applicazioni all'interno di container, ovvero ambienti isolati e leggeri che includono tutto il necessario per l'esecuzione del software (codice, dipendenze, configurazioni). Garantisce che l'applicazione si comporti in modo identico indipendentemente dall'ambiente sottostante, eliminando il problema del "funziona solo sulla mia macchina". Nel progetto è utilizzato per containerizzare i tre componenti principali del sistema (frontend, backend e database), orchestrandoli tramite Docker Compose, che permette di avviarli tutti con un unico comando e di gestirne la comunicazione tramite una rete virtuale privata.
...
Piattaforma di videoconferenza sviluppata da Google che consente riunioni virtuali, condivisione dello schermo e chat. Utilizzata dal gruppo per le riunioni di coordinamento e le presentazioni.
...
Documento tecnico che descrive le funzionalità del prodotto software dal punto di vista dell'utente finale, fornendo istruzioni dettagliate sull'installazione, la configurazione e l'utilizzo del sistema. Ha lo scopo di guidare l'utente nell'uso corretto del prodotto, illustrando le operazioni disponibili, i flussi di lavoro e le soluzioni ai problemi più comuni.
...
Versione minimale ma funzionante di un prodotto software che include solo le funzionalità essenziali necessarie per soddisfare i requisiti fondamentali e consentire una prima valutazione da parte del committente o degli utenti. L'MVP permette di verificare le ipotesi di base del progetto, raccogliere feedback reali e ridurre il rischio di sviluppare funzionalità non necessarie, seguendo un approccio iterativo e incrementale.
...
Tecnologia che converte immagini di testo scritto o stampato in testo digitale leggibile automaticamente.
...
\subsection{Progetto}
Insieme di attività che mirano a raggiungere obiettivi specifici entro date definite, con un inizio e una fine fissati in calendario, disponendo di risorse limitate (persone, tempo, denaro, strumenti) e consumando risorse durante il loro svolgimento.
...
\subsection{Qualità}
Insieme delle caratteristiche di un prodotto software che gli conferiscono la capacità di soddisfare le esigenze espresse e implicite degli stakeholder. La qualità del software si misura in base ad attributi interni (visibili agli sviluppatori) ed esterni (visibili agli utenti).
...
\subsection{Scope}
Ambito di un progetto che definisce i confini, i deliverable, gli obiettivi e i compiti inclusi nel progetto.
...
Documento che descrive l'architettura del sistema software e le scelte progettuali adottate per soddisfare i requisiti definiti nell'Analisi dei Requisiti. Definisce la struttura dei componenti, le loro interazioni, i pattern architetturali utilizzati, le tecnologie impiegate e i criteri di qualità perseguiti. Costituisce il riferimento tecnico per le attività di codifica e verifica, e rappresenta il principale deliverable della fase di progettazione (Product Baseline) nel ciclo di vita del progetto.
...
Processo di suddivisione. Nel nostro progetto si fa riferimento a una suddivisione automatica di un file contenente più documenti aggregati (es. cedolini massivi, buste paga multiple, fatture raggruppate) in singoli documenti distinti, ciascuno associato al proprio destinatario. Viene realizzato tramite tecniche di intelligenza artificiale, riconoscimento di marcatori o analisi del layout. In questo progetto, la suddivisione (splitting) fa parte del modulo AI Co-Pilot per l'automazione della gestione documentale dei Consulenti del Lavoro.
...
Linguaggio di programmazione open-source sviluppato da Microsoft, basato su JavaScript e progettato per aggiungere la tipizzazione statica opzionale al codice. Grazie al controllo dei tipi in fase di compilazione, consente di individuare molti errori prima dell’esecuzione, migliorando la manutenibilità, la robustezza e la scalabilità delle applicazioni, soprattutto in progetti di grandi dimensioni.
...
\subsection{Verifica}
Processo sistematico che determina se i prodotti di lavoro (documenti, codice, componenti) soddisfino i requisiti e le specifiche definite per loro. Risponde alla domanda "Stiamo costruendo il prodotto nel modo giusto?" e include attività come revisioni, ispezioni e test.
...
Sistema per gestire le diverse versioni di file, codice sorgente o documenti, permettendo di tracciare le modifiche, collaborare in team e ripristinare versioni precedenti.
...
\subsection{Workflow}
Sequenza di attività che definiscono un processo di business, in cui compiti, informazioni o documenti passano da un partecipante all'altro secondo regole prestabilite.
