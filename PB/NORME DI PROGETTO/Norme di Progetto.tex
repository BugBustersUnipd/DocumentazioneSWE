...
\begin{itemize}
    ...
    \item \href{http:\\localhost}{Verbali}
    \item \href{http:\\localhost}{Lettera di candidatura}
    \item \href{http:\\localhost}{Lettera di presentazione}
    \item \href{http:\\localhost}{Specifica tecnica}
    \item \href{http:\\localhost}{Manuale utente}
    \item \href{http:\\localhost}{Valutazione dei capitolati}
