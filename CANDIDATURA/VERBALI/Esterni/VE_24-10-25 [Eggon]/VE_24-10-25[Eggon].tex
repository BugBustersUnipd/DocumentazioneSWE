...
Verbale\textsubscript{\scalebox{0.6}{\textbf{G}}} della prima riunione avvenuta con l'azienda Eggon in via telematica per chiedere delucidazioni riguardanti il progetto\textsubscript{\scalebox{0.6}{\textbf{G}}}
...
, con particolare attenzione ad AWS\textsubscript{\scalebox{0.6}{\textbf{G}}}
 (Bedrock\textsubscript{\scalebox{0.6}{\textbf{G}}}) e al suo ruolo per lo sviluppo delle AI\textsubscript{\scalebox{0.6}{\textbf{G}}}
...
.
 ...
 per fare in modo che il team acquisisca dimestichezza con le tecnologie proposte (Ruby on rails\textsubscript{\scalebox{0.6}{\textbf{G}}}, AWS\textsubscript{\scalebox{0.6}{\textbf{G}}}
