...
\textbf{Redattori\textsubscript{\scalebox{0.6}{\textbf{G}}}}   & Leonardo Salviato\\
...
Verbale\textsubscript{\scalebox{0.6}{\textbf{G}}} della prima riunione avvenuta con l'azienda Miriade in via telematica per chiedere delucidazioni riguardanti il progetto\textsubscript{\scalebox{0.6}{\textbf{G}}}
 "L'app che Protegge e Trasforma" e sui sistemi di collaborazione tra il gruppo e l'azienda.
\end{tcolorbox}
\end{center}
...
\section{Svolgimento}
    La riunione è iniziata come previsto alle ore 16:00. I componenti del gruppo hanno espresso le loro perplessitá riguardanti il progetto\textsubscript{\scalebox{0.6}{\textbf{G}}}
. I punti trattati sono i seguenti
 ...
 minimi per una soddisfacente realizzazione del progetto\textsubscript{\scalebox{0.6}{\textbf{G}}}
    ...
    \noindent
    Essendo un progetto\textsubscript{\scalebox{0.6}{\textbf{G}}}
 alquanto completo quello presentato nel capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}
 il team voleva sapere se era stata fatta una stima delle tempistiche per l'implementazione\textsubscript{\scalebox{0.6}{\textbf{G}}} delle varie funzionalitá e se erano stati predisposti dei requisiti\textsubscript{\scalebox{0.6}{\textbf{G}}}
 minimi ottenibili nel tempo che ci è stato assegnato.\\ \\
    \textit{Risposta:} 
    
    I requisiti\textsubscript{\scalebox{0.6}{\textbf{G}}}
 minimi non sono stati ancora determinati, verranno indicati all'inizio del progetto\textsubscript{\scalebox{0.6}{\textbf{G}}}
 in caso di conferma dell'assegnazione. Ci è stato detto comunque che l'attenzione sará rivolta alle funzionalitá principali per poi eventualmente allargarsi verso quelle secondarie. Data la mancanza di requisiti\textsubscript{\scalebox{0.6}{\textbf{G}}}
 minimi non possono ancora essere determinate le tempistiche per il nostro team.
    \vspace{1em}

    \item \textbf{Domande tecniche sulle tecnologie che sarà necessario utilizzare}\\
    \noindent
    Approfondimento delle tecnologie sulla qual è importante specializzarsi per la riuscita del progetto\textsubscript{\scalebox{0.6}{\textbf{G}}}
.\\ \\
    \textit{Risposta:} 
    Le tecnologie necessarie sono molteplici, in particolare l'attenzione è stata rivolta a Flatter e ad AWS\textsubscript{\scalebox{0.6}{\textbf{G}}}
.
    \vspace{1em}
    ...
    \textit{Risposta:} 
    La formazione a livello tecnico verrá svolta tramite corsi da loro indicati e durante il progetto\textsubscript{\scalebox{0.6}{\textbf{G}}}
 avremo il loro supporto tecnico in caso di problemi che non superabili autonomamente.
    \vspace{1em}
...
\section{Esito riunione}
    L'esito della riunione è stato complessivamente positivo, le domande riguardanti il capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}} sono state risposte in maniera esaustiva. Si ringraziano l'azienda Miriade e i rappresentanti Emanuele Righetto e Arianna Bellino per la disponibilitá dimostrata.
