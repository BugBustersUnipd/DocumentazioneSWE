...
\section{Svolgimento}
    ...
    \noindent
    Il team\textsubscript{\textbf{G}} domanda se verrà fornito un supporto o qualche forma di affiancamento nell'utilizzare le tecnologie proposte.\\ \\
    \textit{Risposta:} 
    ...
    \textit{Risposta:} 
    L'analisi\textsubscript{\textbf{G}} dei rischi\textsubscript{\textbf{G}} verrà svolta dal team\textsubscript{\textbf{G}} durante il progetto\textsubscript{\textbf{G}}, riguardo alle tempistiche l'azienda è pienamente consapevole delle possibili difficoltà tecniche a cui il team\textsubscript{\textbf{G}} può andare incontro ed è disposta a discutere con el team\textsubscript{\textbf{G}} per contrattare i requisiti\textsubscript{\textbf{G}}.
    \vspace{1cm}
