...
Verbale della riunione interna del gruppo BugBusters tenutasi il 29 ottobre 2025 tramite Discord\textsubscript{\scalebox{0.6}{\textbf{G}}}. È stata terminata la stesura del documento di candidatura al capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}} C5 (Nexum).
\end{tcolorbox}
\end{center}
...
\begin{enumerate}
    ...
    \item Stesura del documento di candidatura al capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}
...
\begin{itemize}
    ...
    \item Discussione sull'accessibilità del sito.
    \item Terminata la stesura del documento di candidatura al capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}
.
