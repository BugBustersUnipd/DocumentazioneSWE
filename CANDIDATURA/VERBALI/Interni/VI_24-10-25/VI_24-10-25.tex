...
Verbale interno\textsubscript{\scalebox{0.6}{\textbf{G}}} della riunione del gruppo BugBusters tenutasi il 24 ottobre 2025 tramite Discord\textsubscript{\scalebox{0.6}{\textbf{G}}}. Durante la riunione c'è stata la scelta definitiva del capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}
 alla quale abbiamo scelto di candidarsi.
\end{tcolorbox}
\end{center}
...
\begin{enumerate}
    \item Scelta definitiva capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}
...
\begin{itemize}
    ...
    \item Ognuno ha esposto la propria idea riguardante i vari capitolati\textsubscript{\scalebox{0.6}{\textbf{G}}}
 presi in considerazione.
    \item Dato l'incontro molto produttivo e la disponibilità dei rappresentanti di Eggon il gruppo ha deciso Nexum come capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}
.
...
:} Il capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}
 scelto è quello proposto dall'azienda Eggon, che consiste nell'implementazione\textsubscript{\scalebox{0.6}{\textbf{G}}} di supporto AI\textsubscript{\scalebox{0.6}{\textbf{G}}}
 all'interno della piattaforma Nexum.
\end{itemize}
...
\begin{itemize}[topsep=5pt]
    \item Uniformare e finire la compilazione dei documenti in base alla scelta del capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}
