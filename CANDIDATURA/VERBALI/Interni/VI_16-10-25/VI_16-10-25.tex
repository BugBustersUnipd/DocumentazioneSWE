...
Verbale della prima riunione avvenuta in via telematica per concordare sulle tecnologie che verranno utilizzate, il nome del gruppo\textsubscript{\textbf{G}}, il logo e l'email ufficiale. Inoltre sono stati discussi i vari capitolati\textsubscript{\textbf{G}} e le modalità di scelta.
\end{tcolorbox}
\end{center}
...
\begin{enumerate}
    ...
    \item Creazione della mail del progetto\textsubscript{\textbf{G}}
    \item Scelta del capitolato\textsubscript{\textbf{G}} principale e capitolati\textsubscript{\textbf{G}} di riserva
...
\begin{itemize}
    ...
    \item Il team\textsubscript{\textbf{G}} ha deciso le tecnologie per le comunicazioni e l'organizzazione.
    ...
    \item È stata creata l'email ufficiale del progetto\textsubscript{\textbf{G}}.
    \item È stato scelto il capitolato\textsubscript{\textbf{G}} principale e individuati i due di riserva.
...
\begin{itemize}
    \item Discord\textsubscript{\textbf{G}} e WhatsApp (comunicazione)
    \item Google Calendar (gestione attività)
    \item GitHub\textsubscript{\textbf{G}} (versionamento\textsubscript{\textbf{G}})
    \item LaTeX\textsubscript{\textbf{G}} (documentazione)
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Email di progetto\textsubscript{\textbf{G}}:} {\small\textsf{bugbusters.unipd@gmail.com}}
    \item \textbf{Preferenza espressa per il capitolato\textsubscript{\textbf{G}} View4Life}
    \item \textbf{Capitolati\textsubscript{\textbf{G}} di riserva:} SecondBrain e Nexum
...
\begin{itemize}[topsep=5pt]
    \item Studiare i capitolati\textsubscript{\textbf{G}} scelti e preparare ulteriori domande da rivolgere alle aziende
