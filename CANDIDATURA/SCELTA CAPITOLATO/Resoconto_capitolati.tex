...
\subsubsection{Chiarimenti e colloqui con l'azienda}
Le domande al team Vimar sono state inoltrate via email, tramite un altro gruppo di progetto, su richiesta esplicita dell'azienda, che ha preferito ricevere tutte le domande raggruppate per comodità.
