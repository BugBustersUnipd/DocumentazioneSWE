...
\textbf{Verificatori\textsubscript{\scalebox{0.6}{\textbf{G}}}} & Alberto Pignat, Alberto Autiero \\
...
\hline
\rowcolor{secondaryblue!10} \CurrentVersion & 30/01/2026 & Approvazione\textsubscript{\scalebox{0.6}{\textbf{G}}} del documento & - & - & Luca Slongo \\
\hline
\rowcolor{secondaryblue!10} 1.1.0 & 30/01/2026 & Verifica\textsubscript{\scalebox{0.6}{\textbf{G}}} del documento & - & Alberto Pignat & - \\
\hline
\rowcolor{secondaryblue!10} 1.0.1 & 29/01/2026 & Aggiunti ai termini presenti nel Glossario\textsubscript{\scalebox{0.6}{\textbf{G}}} la G & Luca Slongo & - & - \\
\hline
\rowcolor{secondaryblue!10} 1.0.0 & 30/10/2025 & Approvazione\textsubscript{\scalebox{0.6}{\textbf{G}}} del documento. & - & - & Alberto Autiero \\
\hline
...
Il progetto\textsubscript{\scalebox{0.6}{\textbf{G}}}
 mira ad automatizzare la verifica\textsubscript{\scalebox{0.6}{\textbf{G}}} di conformità alla norma EN 18031, legata ai dispositivi radio (Wi-Fi, Bluetooth, IoT, ecc.). L'obiettivo è quello di garantire che le apparecchiature radio non danneggino o abusino delle risorse, che salvaguardino la privacy e siano in grado di garantire sicurezza\textsubscript{\scalebox{0.6}{\textbf{G}}} nelle transazioni.
...
:} React.js
  \item \textbf{Database:} MongoDB o PostgreSQL\textsubscript{\scalebox{0.6}{\textbf{G}}}
...
\begin{itemize}[leftmargin=*]
 ...
 opzionali avanzate quali ricerca semantica e verifica\textsubscript{\scalebox{0.6}{\textbf{G}}} delle firme digitali;
...
: React.js o equivalente per interfaccia\textsubscript{\scalebox{0.6}{\textbf{G}}} utente;
  \item Database: MongoDB o PostgreSQL\textsubscript{\scalebox{0.6}{\textbf{G}}} per memorizzazione metadati;
  \item Gestione dei pacchetti DIP e formati standard (es. XML, PDF/A);
  \item Strumenti per verifica\textsubscript{\scalebox{0.6}{\textbf{G}}} firme digitali.
\end{itemize}
...
\begin{itemize}
  \item riconoscere segnali di pericolo e situazioni di rischio\textsubscript{\scalebox{0.6}{\textbf{G}}} tramite analisi del linguaggio e dei comportamenti;
...
\end{itemize}
L'obiettivo finale è creare un prodotto\textsubscript{\scalebox{0.6}{\textbf{G}}} tecnologicamente avanzato ma anche eticamente responsabile, in grado di avere un impatto sociale positivo e concreto.
...
\begin{itemize}
 ...
 Lambda} per la logica applicativa, \textit{Amazon API\textsubscript{\scalebox{0.6}{\textbf{G}}} Gateway} per la gestione delle richieste e \textit{AWS\textsubscript{\scalebox{0.6}{\textbf{G}}}
 Step Functions} per i flussi complessi.
  \item \textbf{Database}: \textit{Amazon DynamoDB} (NoSQL) per i dati ad alta scalabilità\textsubscript{\scalebox{0.6}{\textbf{G}}} e \textit{Amazon RDS} (PostgreSQL\textsubscript{\scalebox{0.6}{\textbf{G}}}/MySQL) per dati strutturati.
 ...
 e Machine Learning}: utilizzo di \textit{Amazon SageMaker} e \textit{Amazon Bedrock\textsubscript{\scalebox{0.6}{\textbf{G}}}} per le funzionalità\textsubscript{\scalebox{0.6}{\textbf{G}}}
...
Per ulteriori dettagli è possibile consultare il verbale esterno\textsubscript{\scalebox{0.6}{\textbf{G}}} dell'incontro disponibile al seguente link: \href{https://bugbustersunipd.github.io/DocumentazioneSWE/CANDIDATURA/VERBALI/Esterni/VE_2025-10-22%20%5BMiriade%5D/VE_2025-10-22%5BMiriade%5D.pdf}{Verbale Esterno\textsubscript{\scalebox{0.6}{\textbf{G}}} - Miriade (22/10/2025)}.
...
, allarmi silenziosi, diario criptato, moduli\textsubscript{\scalebox{0.6}{\textbf{G}}} educativi, community). Il rischio\textsubscript{\scalebox{0.6}{\textbf{G}}} di sovra-estendere il progetto\textsubscript{\scalebox{0.6}{\textbf{G}}}
 è alto.
\end{enumerate} \\
\hline
\end{tabularx}
...
\vspace{0.5em}\\
\parbox[t]{\linewidth}{%
Nexum nasce come piattaforma HR evoluta, in grado di connettere aziende, collaboratori e gli studi dei CdL\textsubscript{\scalebox{0.6}{\textbf{G}}}. Il progetto\textsubscript{\scalebox{0.6}{\textbf{G}}}
...
\item \textbf{AI\textsubscript{\scalebox{0.6}{\textbf{G}}}
 Co-Pilot\textsubscript{\scalebox{0.6}{\textbf{G}}} per i CdL\textsubscript{\scalebox{0.6}{\textbf{G}}}:} \\
\begin{minipage}[t]{\dimexpr\linewidth-2em}
...
\begin{itemize}[noitemsep, topsep=0pt]
 \item \textbf{front-end\textsubscript{\scalebox{0.6}{\textbf{G}}}
:} Angular\textsubscript{\scalebox{0.6}{\textbf{G}}} (dashboard\textsubscript{\scalebox{0.6}{\textbf{G}}}
...
:} Ruby on Rails\textsubscript{\scalebox{0.6}{\textbf{G}}} (stateless su ECS Fargate dietro ALB);
 \item \textbf{Background Jobs:} Sidekiq (su Fargate + SQS);
 \item \textbf{Database e cache:} PostgreSQL\textsubscript{\scalebox{0.6}{\textbf{G}}} (RDS Multi-AZ con snapshot automatici), ElastiCache for Redis (cache e gestione sessioni);
...
Per ulteriori dettagli è possibile consultare il verbale esterno\textsubscript{\scalebox{0.6}{\textbf{G}}} dell'incontro disponibile al seguente link: \href{https://bugbustersunipd.github.io/DocumentazioneSWE/CANDIDATURA/VERBALI/Esterni/VE_2025-10-24%20%5BEggon%5D/VE_2025-10-24%5BEggon%5D.pdf}{Verbale Esterno\textsubscript{\scalebox{0.6}{\textbf{G}}} - Eggon (24/10/2025)}.
...
Nella vostra esperienza avete già avuto modo di affidare una certa responsabilità operativa o decisionale a team che non avevano ancora esperienza nel mondo del lavoro? Se sì, quali risultati o insegnamenti ne avete tratto in termini di autonomia, qualità\textsubscript{\scalebox{0.6}{\textbf{G}}} del lavoro e collaborazione con il vostro team interno?
&
\begin{itemize}
 \item Ci lavoriamo spesso: funziona quando suddividiamo il lavoro in milestone\textsubscript{\scalebox{0.6}{\textbf{G}}} piccole con demo frequenti, manteniamo standard chiari (lint/test\textsubscript{\scalebox{0.6}{\textbf{G}}}
...
:}
 ...
 \begin{itemize}
  ...
  \item Una volta concordate milestone\textsubscript{\scalebox{0.6}{\textbf{G}}} e scadenze, ci si impegna a rispettarle: fa parte del patto professionale azienda-fornitore e ci permette di coordinare bene tutto il team.
 \end{itemize}
\end{itemize} \\
\hline
\parbox[t]{\linewidth}{%
...
\begin{itemize}
 ...
 Bedrock\textsubscript{\scalebox{0.6}{\textbf{G}}} (integrazione e governance). Tramite Bedrock\textsubscript{\scalebox{0.6}{\textbf{G}}} possiamo usare più modelli (Claude, Llama, Mistral).
 \item \textbf{Apertura ad alternative:} via libera a provider/idee creative, purché valutate su qualità\textsubscript{\scalebox{0.6}{\textbf{G}}} output, aderenza al prompt\textsubscript{\scalebox{0.6}{\textbf{G}}}
...
\parbox[t]{\linewidth}{
\begin{itemize}[leftmargin=*]
 \item Il dominio HR e CdL\textsubscript{\scalebox{0.6}{\textbf{G}}} potrà essere appreso tramite interazioni con Eggon, in quanto conosce nel dettaglio come intende supportare i manager HR e i CdL\textsubscript{\scalebox{0.6}{\textbf{G}}} nel loro lavoro.
...
\parbox[t]{\linewidth}{
Si utilizzano modelli pre-addestrati come base, che vengono successivamente adattati al dominio specifico tramite gli strumenti messi a disposizione da alcune piattaforme, come ad esempio Amazon Bedrock\textsubscript{\scalebox{0.6}{\textbf{G}}}, attraverso funzionalità\textsubscript{\scalebox{0.6}{\textbf{G}}}
...
La documentazione di AWS\textsubscript{\scalebox{0.6}{\textbf{G}}}
 ...
 sviluppato alcuni anni fa e successivamente aggiornato alle versioni più recenti di Ruby on Rails\textsubscript{\scalebox{0.6}{\textbf{G}}}. Tale codice presenta alcune parti ridondanti o non più necessarie, che potrebbero generare confusione durante lo sviluppo.
È prevedibile che l'integrazione con AWS\textsubscript{\scalebox{0.6}{\textbf{G}}}
 rappresenti una delle principali difficoltà; si consiglia pertanto di esaminare le diverse librerie e SDK disponibili per Bedrock\textsubscript{\scalebox{0.6}{\textbf{G}}}, preferibilmente in linguaggi già noti al team, per comprendere il funzionamento del servizio. Una volta acquisite le necessarie competenze, sarà possibile effettuare una migrazione del codice in Ruby on Rails\textsubscript{\scalebox{0.6}{\textbf{G}}}.
} \\
\hline
\end{tabularx}
}
...
\hline
\begin{enumerate}
\item Prodotto\textsubscript{\scalebox{0.6}{\textbf{G}}} reale e integrazione con piattaforma esistente: Nexum è una piattaforma HR già operativa. Sviluppare moduli\textsubscript{\scalebox{0.6}{\textbf{G}}} che si integreranno in un prodotto\textsubscript{\scalebox{0.6}{\textbf{G}}} commerciale fornisce un'esperienza di lavoro su codice legacy e integrazione con sistemi esistenti.
...
\item L'azienda ha fornito un documento per il capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}
 ...
 e obiettivi misurabili in milestone\textsubscript{\scalebox{0.6}{\textbf{G}}}, rendendo la pianificazione .
\item Integrazione di AI\textsubscript{\scalebox{0.6}{\textbf{G}}}
. Lavorare su queste tecnologie fornisce un'esperienza preziosa vista la loro crescente importanza nel settore.
...
\begin{enumerate}
 \item Integrazione con una piattaforma esistente: Nexum è già una piattaforma operativa; sviluppare nuovi moduli\textsubscript{\scalebox{0.6}{\textbf{G}}} comporta difficoltà legate alla comprensione e modifica di codice preesistente, con rischi di incompatibilità e maggiore complessità tecnica.
  \item Vincoli progettuali e tecnologici: L'integrazione in un prodotto\textsubscript{\scalebox{0.6}{\textbf{G}}} reale impone vincoli rigidi, definiti dagli standard e dalle esigenze aziendali, che limitano la flessibilità\textsubscript{\scalebox{0.6}{\textbf{G}}} del team e aumentano la complessità dello sviluppo.
...
&
\begin{itemize}
 \item \textbf{Database consigliato:} PostgreSQL\textsubscript{\scalebox{0.6}{\textbf{G}}}.
...
\end{enumerate}
 & \begin{enumerate}
\item Le tecnologie non risultano chiaramente definite e i requisiti\textsubscript{\scalebox{0.6}{\textbf{G}}} di progetto\textsubscript{\scalebox{0.6}{\textbf{G}}}
 sono ampi. Inoltre, l'assenza di specifiche vincolanti e di requisiti\textsubscript{\scalebox{0.6}{\textbf{G}}}
 opzionali\textsubscript{\scalebox{0.6}{\textbf{G}}}
 chiaramente delineati comporta un'eccessiva libertà decisionale, che può generare incertezza nella pianificazione e aumentare il rischio\textsubscript{\scalebox{0.6}{\textbf{G}}} di deviazioni dagli obiettivi progettuali.
...
, è interessato anche all'utilizzo di nuove tecnologie più moderne e avanzate per lo sviluppo web, come i framework \textit{React} e \textit{Angular\textsubscript{\scalebox{0.6}{\textbf{G}}}}. 
\end{enumerate} \\
\hline
\end{tabularx}
}
...
un numero crescente di sensori, gateway e tenant senza degrado delle prestazioni;
 ...
 automatizzati} e \textbf{code coverage\textsubscript{\scalebox{0.6}{\textbf{G}}}:}lo sviluppo deve includere test\textsubscript{\scalebox{0.6}{\textbf{G}}}
...
\begin{itemize}[noitemsep, topsep=0pt]
 \item \textbf{Sviluppo:} 
 interfaccia\textsubscript{\scalebox{0.6}{\textbf{G}}} utente in \textbf{Angular\textsubscript{\scalebox{0.6}{\textbf{G}}}} per la creazione di una \textbf{SPA} (Single Page Application); 
...
.
 ...
 \textit{PostgreSQL\textsubscript{\scalebox{0.6}{\textbf{G}}}} per la persistenza dei dati strutturati (quelli raccolti e manipolati per renderli \textit{valuable}).
...
.\\\\
Per ulteriori dettagli è possibile consultare il verbale esterno\textsubscript{\scalebox{0.6}{\textbf{G}}} dell'incontro disponibile al seguente link: \href{https://bugbustersunipd.github.io/DocumentazioneSWE/CANDIDATURA/VERBALI/Esterni/VE_2025-10-24%20%5BM31%5D/VE_2025-10-24%5BM31%5D.pdf}{Verbale Esterno\textsubscript{\scalebox{0.6}{\textbf{G}}} - M31 (24/10/2025)}.
...
& Ci aspettiamo che lo decidiate voi, dopo un attento studio. L'idea è far si che per il PoC\textsubscript{\scalebox{0.6}{\textbf{G}}} questo avvenga manualmente attraverso l'interfaccia\textsubscript{\scalebox{0.6}{\textbf{G}}}.\\
\hline
...
, ma grazie all'esperienza pregressa sappiamo cosa aspettarci in termini di output e possiamo venirvi incontro.
 ...
 \item Un'altra possibilità è quella di utilizzare un'unica tecnologia per lo sviluppo dei vari componenti, sfruttando ad esempio TypeScript — con Node.js per la parte cloud e per il simulatore gateway, e Angular\textsubscript{\scalebox{0.6}{\textbf{G}}} per la dashboard\textsubscript{\scalebox{0.6}{\textbf{G}}}
.
...
) , Go (componenti ad alte prestazioni) , Angular\textsubscript{\scalebox{0.6}{\textbf{G}}} (front-end\textsubscript{\scalebox{0.6}{\textbf{G}}}
 SPA) , MongoDB (database NoSQL) , PostgreSQL\textsubscript{\scalebox{0.6}{\textbf{G}}} (database SQL) , Redis (caching) , Google Cloud Platform (infrastruttura cloud) , Kubernetes (orchestrazione container) , NATS o Kafka (comunicazione asincrona) , e Prometheus con Grafana (monitoring).
\end{enumerate}
 & \begin{enumerate}
...
\item 	I requisiti\textsubscript{\scalebox{0.6}{\textbf{G}}}
 ...
 on-demand e streaming, alla UI, al monitoring, alla sicurezza\textsubscript{\scalebox{0.6}{\textbf{G}}}). C'è il concreto rischio\textsubscript{\scalebox{0.6}{\textbf{G}}} di dover sacrificare la profondità di alcune funzionalità\textsubscript{\scalebox{0.6}{\textbf{G}}}
...
:} Tesseract OCR, EasyOCR, Convolutional Neural Networks (CNN), Vision Transformer (ViT).
 ...
 dal database.
 \item \textbf{Interfaccia\textsubscript{\scalebox{0.6}{\textbf{G}}} utente:} .NET Blazor, React.js, Angular\textsubscript{\scalebox{0.6}{\textbf{G}}}.
\end{itemize}
...
\begin{itemize}
  ...
  \item Deve \textbf{utilizzare l'interfaccia\textsubscript{\scalebox{0.6}{\textbf{G}}} API\textsubscript{\scalebox{0.6}{\textbf{G}}} KNX IoT} fornita da Vimar per comunicare con gli impianti.
...
\begin{itemize}
 ...
 \item \textbf{Applicativo web:} deve prevedere l'utilizzo della tecnologia \textbf{KNX IoT 3rd Party API\textsubscript{\scalebox{0.6}{\textbf{G}}}}.
...
\item Generalmente si parte dalla progettazione, poi implementazione\textsubscript{\scalebox{0.6}{\textbf{G}}} test-driven o modulare.
\end{itemize} \\
\hline
...
moderne e versatili, come Docker, AWS\textsubscript{\scalebox{0.6}{\textbf{G}}}
 e framework web come Angular\textsubscript{\scalebox{0.6}{\textbf{G}}} o React,
