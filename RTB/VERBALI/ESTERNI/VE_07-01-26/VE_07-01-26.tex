...
\begin{enumerate}
    ...
    \item \label{itm:analisi_requisiti} Discussione su eventuali modifiche al documento relativo all'analisi dei requisiti.
...
\paragraph{2} Per il secondo modulo, invece, Eggon ha confermato che il modello è appropriato solo nel contesto del POC. Per il prodotto finale si dovranno utilizzare modelli più potenti come \textit{AWS Comprehend} e \textit{AWS Textract}.

\subsection*{\ref{itm:analisi_requisiti}. Discussione su eventuali modifiche al documento relativo all'analisi dei requisiti.}
...
\hline
\DecisionRow{\href{https://github.com/BugBustersUnipd/DocumentazioneSWE/issues/104}{RTB67}}{Redazione del verbale corrente e invio del documento di analisi dei requisiti}{Linor Sadè}
