...
Verbale esterno relativo alla riunione tenutasi in data 17/12/2025 tra il team BugBusters e l'azienda Eggon, per la presentazione del POC aggiornato alla data del 7 gennaio 2026. Nel verbale sono riportati i punti salienti della presentazione, le problematiche riscontrate, le domande relative ai modelli in uso e la discussione su eventuali modifiche al documento relativo all'analisi dei requisiti.
\end{tcolorbox}
\end{center}
...
\hline
\DecisionRow{\href{https://github.com/BugBustersUnipd/DocumentazioneSWE/issues/}{RTB}}{ Inviare il documento di analisi dei requisiti }{Linor Sadè}
\end{tabularx}
\fussy
