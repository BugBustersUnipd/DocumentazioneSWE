...
aspetti tecnici e funzionali del progetto\G{}. È stata visionata una possibile interfaccia\G{} utente per il POC che bisognerà sviluppare,
...
\begin{enumerate}
    \item \label{itm:poc} Presentazione interfaccia\G{} utente per il POC.
...
\subsection*{\ref{itm:poc}. Presentazione interfaccia\G{} utente per il POC.}
Il team ha presentato a Eggon un'idea di una possibile interfaccia\G{} di quello che sarà poi il POC.
