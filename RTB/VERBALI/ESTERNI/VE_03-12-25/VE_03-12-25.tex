...
<<<<<<< HEAD
Questo verbale\textsubscript{\scalebox{0.6}{\textbf{G}}} documenta la riunione esterna del 3 dicembre 2025 con l'azienda Eggon, durante la quale sono stati discussi 
aspetti tecnici e funzionali del progetto\textsubscript{\scalebox{0.6}{\textbf{G}}}. Sono stati chiariti dubbi relativi all'autenticazione, alla gestione dei cedolini\textsubscript{\scalebox{0.6}{\textbf{G}}},
=======
...
>>>>>>> origin/verifica
 ...
 più precisamente i requisiti\textsubscript{\scalebox{0.6}{\textbf{G}}} dell'applicazione.
\end{tcolorbox}
\end{center}
...
\begin{enumerate}
<<<<<<< HEAD
    \item \label{itm:autenticazione} Richiesta sull'autenticazione riguardo alle app stand alone.
    \item \label{itm:SeparazioneDoc} Richiesta feature separazione documenti su CDL.
    \item \label{itm:Cedolini} Richiesta se dobbiamo implementare la funzione di visualizzazione dei cedolini\textsubscript{\scalebox{0.6}{\textbf{G}}}.
=======
    \item \label{itm:autenticazione} Richiesta sull'autenticazione riguardo alle app standalone.
    \item \label{itm:SeparazioneDOc} Richiesta feature separazione documenti su CDL.
...
<<<<<<< HEAD
\subsection*{\ref{itm:autenticazione}. Richiesta sull'autenticazione riguardo alle app stand alone}
...
il team ha chiesto se l'autenticazione degli utenti potrà essere gestita tramite un sistema di autenticazione separato o se non sará requisito\textsubscript{\scalebox{0.6}{\textbf{G}}} necessario.
Luca Iuzzolino ha tenuto a ribadire che non é parte richiesta dal progetto\textsubscript{\scalebox{0.6}{\textbf{G}}} e non interessante per noi.\\

\subsection*{\ref{itm:SeparazioneDoc}. Richiesta feature separazione documenti su CDL.}
È stata discussa la funzionalità\textsubscript{\scalebox{0.6}{\textbf{G}}} di separazione (split) dei documenti caricati su CDL: il team ha chiesto che venga resa opzionale, 
poiché non sempre ne percepisce l'utilità. \\
Luca Iuzzolino ha precisato che la funzione è utile quando i software che generano i cedolini\textsubscript{\scalebox{0.6}{\textbf{G}}} 
producono file PDF contenenti più cedolini\textsubscript{\scalebox{0.6}{\textbf{G}}} in un unico documento. Si è concordato dunque che la funzionalitá resterá primaria.

\subsection*{\ref{itm:Cedolini}. Richiesta se dobbiamo implementare la funzione di visualizzazione dei cedolini\textsubscript{\scalebox{0.6}{\textbf{G}}}}
I cedolini\textsubscript{\scalebox{0.6}{\textbf{G}}} sono gestiti all'interno di NEXUM. 
Poiché la nostra applicazione sarà stand-alone e non integrata in NEXUM, 
il team ha chiesto se sia necessario implementare una funzionalità\textsubscript{\scalebox{0.6}{\textbf{G}}} per la 
visualizzazione dei cedolini\textsubscript{\scalebox{0.6}{\textbf{G}}}\textsubscript{\scalebox{0.6}{\textbf{G}}}. Luca Iuzzolino ha risposto che non è richiesto: 
l'applicazione dovrà occuparsi esclusivamente dell'invio dei cedolini\textsubscript{\scalebox{0.6}{\textbf{G}}} tramite 
=======
\subsection*{\ref{itm:autenticazione}. Richiesta sull'autenticazione riguardo alle app standalone}
Visto che l'applicazione che verrà sviluppata dal gruppo BugBusters non sarà integrata direttamente nell'applicazione NEXUM, ma verrà sviluppata come app standalone, 
...
l'applicazione dovrà occuparsi esclusivamente dell'invio dei cedolini\G{} tramite 
>>>>>>> origin/verifica
...
Il team domanda ulteriori iformazioni riguardo alla funzionalitá duplica/riutilizza prompt\textsubscript{\scalebox{0.6}{\textbf{G}}}\textsubscript{\scalebox{0.6}{\textbf{G}}}: la funzionalitá di duplicazione permette di copiare un prompt\textsubscript{\scalebox{0.6}{\textbf{G}}} esistente e modificarlo per creare un nuovo prompt\textsubscript{\scalebox{0.6}{\textbf{G}}},
mentre la funzionalitá di riutilizzo consente di utilizzare un prompt\textsubscript{\scalebox{0.6}{\textbf{G}}} esistente senza modificarlo.\\
=======
...
\hline
<<<<<<< HEAD
\DecisionRow{\href{https://github.com/BugBustersUnipd/DocumentazioneSWE/issues/29}{RTB26} \label{RTB26}}{Rivedere analisi requisiti\textsubscript{\scalebox{0.6}{\textbf{G}}} dopo i chiarimenti con la proponente\textsubscript{\scalebox{0.6}{\textbf{G}}}.}{Leonardo Salviato}
=======
...
Si ringraziano l'azienda Eggon e i rappresentanti Gianpaolo Ferrarin e Luca Iuzzolino per la disponibilità\textsubscript{\scalebox{0.6}{\textbf{G}}} dimostrata.
=======
