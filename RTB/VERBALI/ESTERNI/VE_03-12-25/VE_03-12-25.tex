...
aspetti tecnici e funzionali del progetto\G{}. Sono stati chiariti dubbi relativi all'autenticazione, alla gestione dei cedolini\G{},
 ...
 più precisamente i requisiti\G dell'applicazione.
\end{tcolorbox}
\end{center}
...
\begin{enumerate}
    ...
    \item \label{itm:SeparazioneDOc} Richiesta feature separazione documenti su CDL\G.
...
\subsection*{\ref{itm:SeparazioneDOc}. Richiesta feature separazione documenti su CDL\G.}
È stata discussa la funzionalità\G{} di separazione (split) dei documenti caricati su CDL\G: il team ha chiesto che venga resa opzionale, 
...
sistemi di notifica, mentre la visualizzazione rimane a carico di Eggon.
...
Il team chiede se è possibile avere un account Bedrock\textsubscript{\scalebox{0.6}{\textbf{G}}} per poter iniziare a sperimentare le tecnologie richieste. La risposta è stata positiva.\\
...
\hline
\DecisionRow{\href{https://github.com/BugBustersUnipd/DocumentazioneSWE/issues/29}{RTB26} \label{RTB26}}{Rivedere Analisi dei requisiti\G dopo i chiarimenti con la proponente\G{}.}{Leonardo Salviato}
\end{tabularx}
\fussy
