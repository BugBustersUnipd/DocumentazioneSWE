...
Verbale riguardante il colloquio tramite Google Meet\textsubscript{\scalebox{0.6}{\textbf{G}}} con Eggon. Sono stati discussi i punti riguardanti il progetto\textsubscript{\scalebox{0.6}{\textbf{G}}} su cui il team aveva dei dubbi ed è stato definito il prossimo meeting con i rappresentanti Eggon. 
\end{tcolorbox}
\end{center}
...
\begin{enumerate}
    ...
    \item \label{itm:applicazioneStandalone} Discussione riguardo a come il gruppo procederà per sviluppare i moduli richiesti nel capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}.
\end{enumerate}
...
\subsection*{\ref{itm:applicazioneStandalone}. Discussione riguardo a come il gruppo procederà per sviluppare i moduli richiesti nel capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}}
Il gruppo, a seguito del consiglio fornito dall'azienda durante la riunione precedente, ha deciso di sviluppare i moduli esposti nel capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}} non direttamente come integrazione dell'applicazione NEXUM, bensì come applicazioni standalone che mirano a svolgere le funzionalità\textsubscript{\scalebox{0.6}{\textbf{G}}} richieste (simulando comportamenti NEXUM dove necessario), in modo da poter essere integrate successivamente nell'applicazione principale.\\
