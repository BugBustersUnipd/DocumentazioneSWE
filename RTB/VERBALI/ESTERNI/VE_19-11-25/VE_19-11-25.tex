...
\begin{enumerate}
   ...
   \item \label{itm:applicazioneStand-alone} Discussione riguardo a come il gruppo procederà per sviluppare i moduli\textsubscript{\scalebox{0.6}{\textbf{G}}} richiesti nel capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}};
\end{enumerate}
...
\subsection*{\ref{itm:applicazioneStand-alone}. Discussione riguardo a come il gruppo procederà per sviluppare i moduli\textsubscript{\scalebox{0.6}{\textbf{G}}} richiesti nel capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}}}
Il gruppo, a seguito del consiglio fornito dall'azienda durante la riunione precedente, ha deciso di sviluppare i moduli\textsubscript{\scalebox{0.6}{\textbf{G}}} esposti nel capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}} non direttamente come integrazione dell'applicazione NEXUM, bensì come applicazioni stand-alone\textsubscript{\scalebox{0.6}{\textbf{G}}} che mirano a svolgere le funzionalità\textsubscript{\scalebox{0.6}{\textbf{G}}} richieste (simulando comportamenti NEXUM dove necessario), in modo da poter essere integrate successivamente nell'applicazione principale.\\
