...
\textbf{Verificatore\textsubscript{\scalebox{0.6}{\textbf{G}}}}    &  Alberto Autiero  \\
\textbf{Uso}          & Interno \\
...
\begin{enumerate}
    ...
    \end{enumerate}
    \item \label{itm:scrittura_diario_di_bordo} Inizio stesura del diario di bordo: discussione su difficoltà nell'inizio o avanzamento attività già iniziate;
\end{enumerate}
...
Si è discusso brevemente dello sprint\textsubscript{\scalebox{0.6}{\textbf{G}}} precedente, evidenziando il rallentamento subito dal periodo festivo e gli impegni che hanno influito sull'avanzamento del POC\textsubscript{\scalebox{0.6}{\textbf{G}}}, rispetto ciò che era stato pianificato.\\
...
\begin{itemize}
    ...
    \item Concordare con l'azienda la gestione delle modifiche al prompt\textsubscript{\scalebox{0.6}{\textbf{G}}} nel modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} Ai Assistant\textsubscript{\scalebox{0.6}{\textbf{G}}} Generativo: nel POC\textsubscript{\scalebox{0.6}{\textbf{G}}} manteniamo la possibilità di iterazioni conversazionali, ma l'analisi dei requisiti\textsubscript{\scalebox{0.6}{\textbf{G}}} prevede solo la modifica diretta del prompt\textsubscript{\scalebox{0.6}{\textbf{G}}}, senza conversazione;;  
\end{itemize}
...
Il POC\textsubscript{\scalebox{0.6}{\textbf{G}}} deve essere completato entro il 07/01/2026, data dell'incontro con Eggon.\\ Al momento della riunione, il POC\textsubscript{\scalebox{0.6}{\textbf{G}}} comprendeva: un backend\textsubscript{\scalebox{0.6}{\textbf{G}}} funzionante con API\textsubscript{\scalebox{0.6}{\textbf{G}}} per l'Ai Assistant\textsubscript{\scalebox{0.6}{\textbf{G}}} Generativo (senza generazione di immagini), un frontend\textsubscript{\scalebox{0.6}{\textbf{G}}} con interfaccia\textsubscript{\scalebox{0.6}{\textbf{G}}} più avanzata rispetto alle funzionalità\textsubscript{\scalebox{0.6}{\textbf{G}}} previste per il POC\textsubscript{\scalebox{0.6}{\textbf{G}}}, e il collegamento tra frontend\textsubscript{\scalebox{0.6}{\textbf{G}}} e backend\textsubscript{\scalebox{0.6}{\textbf{G}}}.
Per dialogare efficacemente sulle scelte da fare sono stati condivisi in diretta da un membro alcuni mockup delle schermate principali del POC\textsubscript{\scalebox{0.6}{\textbf{G}}}.\\
...
Inoltre la funzionalità\textsubscript{\scalebox{0.6}{\textbf{G}}} di split e data analysis non saranno implementati nel POC\textsubscript{\scalebox{0.6}{\textbf{G}}} (verranno discussi con Eggon per capire se sono necessari per l'RTB\textsubscript{\scalebox{0.6}{\textbf{G}}}). 
\begin{adjustwidth}{1cm}{1cm} % per un rientro a sinistra e destra
    ...
    \begin{itemize}
        ...
        \item controllare che esista una funzione che raccoglie i risultati dei documenti caricati (per lo storico), eventualmente aggiungerla;
    ...
    In particolare:
    \begin{itemize}
        \item implementare lo storico delle richieste fatte all'AI\textsubscript{\scalebox{0.6}{\textbf{G}}} Assistant Generativo;
        ...
        \item aggiungere l'immagine generata al risultato dell'AI\textsubscript{\scalebox{0.6}{\textbf{G}}} Assistant Generativo; 
...
\subsection*{\ref{itm:scrittura_diario_di_bordo}. Inizio stesura del diario di bordo: discussione su difficoltà nell'inizio o avanzamento attività già iniziate}
...
\hline
\rowcolor{secondaryblue!10} \href{https://github.com/BugBustersUnipd/DocumentazioneSWE/issues/80}{RTB50-53}  & Completamento delle attività backend\textsubscript{\scalebox{0.6}{\textbf{G}}} per Ai Co-pilot\textsubscript{\scalebox{0.6}{\textbf{G}}} per Cdl\textsubscript{\scalebox{0.6}{\textbf{G}}} & Luca Slongo \\
\hline
\rowcolor{secondaryblue!10} \href{https://github.com/BugBustersUnipd/DocumentazioneSWE/issues/81}{RTB54-62}  & Completamento delle attività frontend\textsubscript{\scalebox{0.6}{\textbf{G}}} per Ai\textsubscript{\scalebox{0.6}{\textbf{G}}} Assitant Generativo e Ai Co-pilot\textsubscript{\scalebox{0.6}{\textbf{G}}} per Cdl\textsubscript{\scalebox{0.6}{\textbf{G}}} & Alberto Pignat, Marco Piro, Linor Sadè\\
\hline
\rowcolor{secondaryblue!10} \href{https://github.com/BugBustersUnipd/DocumentazioneSWE/issues/99}{RTB63}& Ricerca e costruzione di documenti per testare AI Co-pilot\textsubscript{\scalebox{0.6}{\textbf{G}}} per Cdl\textsubscript{\scalebox{0.6}{\textbf{G}}} & Alberto Autiero \\
\hline
