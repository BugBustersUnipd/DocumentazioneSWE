...
\hline
\rowcolor{secondaryblue!10} RTB17 \label{RTB17} & Definire domande tramite google docs condiviso da porre alla proponente. & Tutti \\
\hline
\rowcolor{secondaryblue!10} RTB18 \label{RTB18} & Informarsi e implementare automazioni per aggiornare il sito web e per chiudere automaticamente le issue nei commit. & Marco Favero \\
\hline
\rowcolor{secondaryblue!10} RTB19 \label{RTB19} & Avanzamento Analisi dei Requisiti. & Leonardo Salviato, Marco Piro \\
\hline
\rowcolor{secondaryblue!10} RTB20 \label{RTB20} & Avanzamento Norme. & Marco Favero, Albero Pignat \\
\hline
\rowcolor{secondaryblue!10} RTB21 \label{RTB21} & Informarsi riguardo al Piano di Qualifica. & Luca Slongo \\
\hline
\rowcolor{secondaryblue!10} RTB22 \label{RTB22} & Informarsi riguardo al Piano di Progetto, eventualmente scrivere bozza. & Alberto Autiero \\
\hline
\rowcolor{secondaryblue!10} RTB23 \label{RTB23} & Verificare questo verbale & Linor Sadè \\
\hline
\rowcolor{secondaryblue!10} RTB24 \label{RTB24} & Verificare Norme & Linor Sadè \\
\hline
\rowcolor{secondaryblue!10} RTB25 \label{RTB25} & Verificare Analisi dei Requisiti & Linor Sadè \\
\hline
\end{tabularx}
\fussy
