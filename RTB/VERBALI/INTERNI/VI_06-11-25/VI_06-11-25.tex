...
\hline
\rowcolor{secondaryblue!10} RTB3 \label{RTB3} & Riprogettazione sito web e repository\textsubscript{\textbf{G}} GitHub\textsubscript{\textbf{G}} in linea con i feedback del professore e regole di accessibilità (vedi \hyperref[par:sito]{dettagli}). & Marco Favero \\
\hline
\rowcolor{secondaryblue!10} RTB4 \label{RTB4} & Studio e prosecuzione della redazione del glossario\textsubscript{\textbf{G}}. (vedi \hyperref[par:glossario]{dettagli}) & Alberto Autiero \\
\hline
