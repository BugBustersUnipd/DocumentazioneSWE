...
\begin{adjustwidth}{1cm}{1cm} % per un rientro a sinistra e destra
 ...
 issue, persona/e incaricate, descrizione della decisione con relative azioni).\\
 ...
 hanno il compito di controllare la correttezza e la conformità del documento;
    ...
    \item Il file README.md viene modificato aggiungendo le istruzioni per la creazione di un documento LaTeX, la pubblicazione su GitHub\textsubscript{\scalebox{0.6}{\textbf{G}}}
 e sul sito.
\end{itemize}
...
A questo proposito abbiamo discusso della necessità di dialogare con l'azienda proponente\textsubscript{\scalebox{0.6}{\textbf{G}}}
 per valutare la corretta prosecuzione del progetto.\\
