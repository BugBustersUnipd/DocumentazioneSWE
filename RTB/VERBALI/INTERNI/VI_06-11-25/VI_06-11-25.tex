...
\begin{adjustwidth}{1cm}{1cm} % per un rientro a sinistra e destra
    ...
    \item Per la \textbf{creazione di un nuovo documento\textsubscript{\textbf{G}}} per tutti i documenti che non sono verbali si decide di:
    \begin{itemize}
        \item creare un branch\textsubscript{\textbf{G}} dedicato allo sviluppo del documento\textsubscript{\textbf{G}};
        ...
        \item una volta approvato, il documento\textsubscript{\textbf{G}} viene fuso nel branch\textsubscript{\textbf{G}} \texttt{main}, segnando la versione \textbf1.0.0.
    \end{itemize}
