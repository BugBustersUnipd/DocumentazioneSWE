...
\begin{adjustwidth}{1cm}{1cm} % per un rientro a sinistra e destra
    ...
    \item Per la \textbf{creazione di un nuovo documento} si decide di:
    \begin{itemize}
        \item creare un \textbf{branch di tipo \texttt{feature}} dedicato allo sviluppo del documento;
        \item al termine della stesura, aprire una \textbf{pull request} verso il branch \texttt{dev};
        \item i \textbf{verificatori} hanno il compito di controllare la correttezza e la conformità del documento;
        \item una volta approvato, il documento viene \textbf{fuso nel branch \texttt{main}}, segnando la versione \textbf{1.0.0}.
    \end{itemize}
    
    \item La \textbf{pubblicazione sul sito web} avviene \textbf{solo con i file presenti nel branch \texttt{main}}.
...
\begin{itemize}[leftmargin=1cm, rightmargin=1cm]
    \item Una scheda dedicata per ciascuno sprint;
...
\hline
\rowcolor{secondaryblue!10} RTB1 & Integrazione delle regole di rotazione nel documento di dichiarazione degli impegni. (vedi) & Luca Slongo \\
\hline
\rowcolor{secondaryblue!10} RTB2 & Redigere il verbale della corrente riunione e definire la sezione decisione~-~azioni tracciabili nel sistema (inizio a partire dal verbale corrente). & Linor Sadè \\
\hline
\rowcolor{secondaryblue!10} RTB3 & Riprogettazione sito web e repository GitHub in linea con il resocontro del professore e regole di accessibilità. (vedi)  & Marco Favero \\
\hline
\rowcolor{secondaryblue!10} RTB4 & Studio e continuo della redazione del glossario. (vedi )& Alberto Autiero \\
\hline
\rowcolor{secondaryblue!10} RTB5 & Scrittura del foglio di calcolo per la rendicontazione ore, seguendo l'esempio definito (vedi \hyperref[itm:esempio]{qui}).  & Leonardo Salviato \\
\hline
\rowcolor{secondaryblue!10} RTB6 & Approvazione del seguente verbale, scrittura all'azienda, migliorie grafiche alla firma e-mail. & Alberto Pignat \\
\hline
\rowcolor{secondaryblue!10} RTB7 & Inizio studio tecnologie (vedi ) & Alberto Pignat \\
\hline
\end{tabularx}
\fussy
