...
\begin{adjustwidth}{1cm}{1cm} % per un rientro a sinistra e destra
    ...
    \begin{itemize}
        \item creare un branch di tipo \texttt{feature} dedicato allo sviluppo del documento;
        \item al termine della stesura, aprire una pull request verso il branch \texttt{dev};
    ...
    \item La pubblicazione sul sito web avviene solo con i file presenti nel branch \texttt{main}.
...
\hline
\rowcolor{secondaryblue!10} RTB1 \label{RTB1} & Integrazione delle regole di rotazione nel documento di dichiarazione degli impegni (vedi \hyperref[par:ruoli]{dettagli}). & Luca Slongo \\
\hline
\rowcolor{secondaryblue!10} RTB2 \label{RTB2} & Redigere il verbale della corrente riunione e definire la sezione decisione~-~azioni tracciabili nel sistema (vedi \hyperref[par:tracciabilita]{dettagli}). & Linor Sadè \\
\hline
\rowcolor{secondaryblue!10} RTB3 \label{RTB3} & Riprogettazione sito web e repository GitHub in linea con il resocontro del professore e regole di accessibilità (vedi \hyperref[par:sito]{dettagli}). & Marco Favero \\
\hline
\rowcolor{secondaryblue!10} RTB4 \label{RTB4} & Studio e continuo della redazione del glossario. (vedi \hyperref[par:glossario]{dettagli}) & Alberto Autiero \\
\hline
...
\hline
\rowcolor{secondaryblue!10} RTB7 \label{RTB7} & Inizio studio tecnologie (vedi \hyperref[par:studiotec]{dettagli}). & Tutti \\
\hline
\end{tabularx}
\fussy
