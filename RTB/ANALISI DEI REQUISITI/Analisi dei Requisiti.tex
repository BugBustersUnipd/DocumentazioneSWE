...
\hline
\autoRF & Il sistema deve permettere all'utente registrato di effettuare il login (autenticazione). & \hyperref[UC-0B]{UC-0B} & Opzionale\textsubscript{\scalebox{0.6}{\textbf{G}}} \\
\hline
