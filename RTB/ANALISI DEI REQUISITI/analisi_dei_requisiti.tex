...
Questo documento di Analisi dei Requisiti\textsubscript{\scalebox{0.6}{\textbf{G}}}, adottato da parte di BugBusters durante lo svolgimento del progetto\textsubscript{\scalebox{0.6}{\textbf{G}}} didattico, 
ha lo scopo di definire in maniera precisa e dettagliata i requisiti funzionali\textsubscript{\scalebox{0.6}{\textbf{G}}} e non funzionali del Sistema software da sviluppare.
...
\textbf{applicazione standalone}, autonoma e indipendente da essa. 
...
\textbf{Post-condizioni}
\begin{itemize}
    \item Il documento é stato analizzato tramite l'AI e i dati sono stati inviati al sistema
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item UC-2F.5 - Rigenera messaggio
    \end{itemize}
\end{itemize}
...
\subsubsection{UC-2F.5 – Rigenera messaggio}\label{sec:uc-2f-5}
...
\textbf{Pre-condizioni}
\begin{itemize}
    \item Sono stati selezionati i parametri (es. tono, stile).
\end{itemize}
...
\textbf{Scenario principale}
\begin{enumerate}
    \item L'utente clicca sul pulsante "Rigenera messaggio"
