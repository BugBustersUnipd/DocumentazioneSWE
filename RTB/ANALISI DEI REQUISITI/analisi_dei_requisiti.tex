...
\begin{itemize}
    \item \textit{include}:
    \begin{itemize}
        \item nessuno (la registrazione è un punto di ingresso al Sistema).
    \end{itemize}
    \item \textit{extend}: 
    \begin{itemize}
...
\begin{itemize}
    \item \textit{include}:
    \begin{itemize}
        \item nessuno (caso d’uso base di autenticazione).
    \end{itemize}
    \item \textit{extend}: 
    \begin{itemize}
        \item nessuno (questo caso d’uso è base e viene richiamato da altri, ma non estende ulteriori flussi).
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    \item \textit{include}: 
    \begin{itemize}
        \item UC-0B – Login / Autenticazione utente (è necessario che l’utente sia autenticato).
    \end{itemize}
    \item \textit{extend}: 
    \begin{itemize}
        \item nessuno.
...
\begin{itemize}
    \item \textit{include}: 
    \begin{itemize}
        \item UC-0B – Login / Autenticazione utente (l’Amministratore deve essere autenticato come Admin).
    \end{itemize}
    \item \textit{extend}: 
    \begin{itemize}
        \item nessuno.
...
\begin{itemize}
    \item \textit{include}: 
    \begin{itemize}
        \item UC-0B – Login / Autenticazione utente (per poter effettuare il logout è necessaria una sessione attiva).
    \end{itemize}
    \item \textit{extend}:
    \begin{itemize}
        \item Nessuno.
...
\begin{itemize}
    \item \textit{include}: 
    \begin{itemize}
        \item UC-1D – Salvataggio e gestione dei prompt (il prompt utilizzato viene sempre salvato nello storico).
    \end{itemize}
    \item \textit{extend}: 
    \begin{itemize}
        \item Nessuna.
...
\begin{itemize}
    \item \textit{include}: 
    \begin{itemize}
        \item UC-1A – Creazione di un nuovo contenuto tramite prompt (è necessario che esista un contenuto generato da modificare).
    \end{itemize}
    \item \textit{extend}: 
    \begin{itemize}
        \item UC-1F – Rigenerazione del contenuto (la modifica può essere arricchita da rigenerazioni automatiche di parti del testo).
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    \item \textit{include}: 
    \begin{itemize}
        \item UC-1A – Creazione di un nuovo contenuto tramite prompt (i prompt derivano da richieste di generazione).
    \end{itemize}
    \item \textit{extend}: 
    \begin{itemize}
        \item UC-1A – Creazione di un nuovo contenuto tramite prompt (variante in cui il contenuto viene generato a partire da un prompt già presente nello storico anziché da un nuovo prompt).
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    \item \textit{include}: 
    \begin{itemize}
        \item UC-1A – Creazione di un nuovo contenuto tramite prompt (deve esistere un contenuto visualizzabile).
    \end{itemize}
    \item \textit{extend}: 
    \begin{itemize}
...
\begin{itemize}
    \item \textit{include}:
    \begin{itemize}
        \item UC-1A – Creazione di un nuovo contenuto tramite prompt (deve esistere una
            prima versione generata).
    \end{itemize}
...
\begin{itemize}
    ...
    \item \textit{extend}: 
    \begin{itemize}
        \item UC-1C – Pubblicazione o scarto del contenuto (la revisione si inserisce come passo alternativo prima della decisione finale).
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    \item \textit{include}: 
    \begin{itemize}
        \item nessuna (usa i dati storici già presenti).
    \end{itemize}
    \item \textit{extend}: 
    \begin{itemize}
...
\subsubsection{UC-2I – Monitoraggio qualità AI e miglioramento continuo}
