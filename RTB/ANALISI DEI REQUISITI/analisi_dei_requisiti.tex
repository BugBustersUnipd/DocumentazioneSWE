...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item ITra le opzioni disponibili nella scelta dei toni per la generazione di un contenuto adesso è presente il nuovo tono inserito
\end{itemize}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item ITra le opzioni disponibili nella scelta dei toni per la generazione di un contenuto adesso non si trova più un tono precedentemente inserito
\end{itemize}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item ITra le opzioni disponibili nella scelta degli stili per la generazione di un contenuto adesso è presente il nuovo stile inserito
\end{itemize}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item ITra le opzioni disponibili nella scelta degli stili per la generazione di un contenuto adesso non si trova più uno stile precedentemente inserito
\end{itemize}
