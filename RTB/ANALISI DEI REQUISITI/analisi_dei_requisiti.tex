...
\newcommand{\subUseCase}[1]{%
    ...
    \label{\currentSubUCID}% Label per i riferimenti
...
\begin{figure}[H]
    ...
    \caption{Diagramma del caso d'uso UC-0D – Visualizzazione dati profilo utente}
\end{figure}
...
\subUseCase{Uscita senza salvare profilo utente}
...
\subUseCase{Visualizzazione lista elementi storico filtrata}
...
\useCase{Elimina template messagio}
...
\useCase{Visualizzazione lista template salvati}
...
\subUseCase{Nessun template salvato}
...
\subUseCase{Visualizzazione elemento da lista template salvati}
\textbf{Attori\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Operatore CdL\textsubscript{\scalebox{0.6}{\textbf{G}}}
\end{itemize}
...
\subUseCase{Visualizzazione oggetto messaggio}
...
\subUseCase{Visualizzazione lista documenti filtrata}
...
\subUseCase{Visualizzazione lista destinatari filtrata}
...
\subUseCase{Visualizzazione lista storico documenti filtrata}
...
\endlastfoot
    ...
    \autoRF & Un utente deve potersi registrare all'interno del sistema & \hyperref[sec:uc-0a]{UC-0A} & Opzionale \\
    \hline
    \autoRF & L'utente deve poter inserire la propria email & \hyperref[sec:uc-0a-1]{UC-0A.1} & Opzionale \\
    \hline
    \autoRF & L'utente deve poter inserire password & \hyperref[sec:uc-0a-2]{UC-0A.2} & Opzionale \\
    \hline
    \autoRF & L'utente deve poter inserire username & \hyperref[sec:uc-0a-3]{UC-0A.3} & Opzionale \\
    \hline
    \autoRF & L'utente deve poter inserire nome & \hyperref[sec:uc-0a-4]{UC-0A.4} & Opzionale \\
    \hline
    \autoRF & L'utente deve poter inserire cognome & \hyperref[sec:uc-0a-5]{UC-0A.5} & Opzionale \\
    \hline
    \autoRF & L'utente deve poter inserire matricola & \hyperref[sec:uc-0a-6]{UC-0A.6} & Opzionale \\
    \hline
    \autoRF & Deve esserci un controllo per "Email non valida" & \hyperref[sec:uc-0a-7]{UC-0A.7} & Opzionale \\
    \hline
    \autoRF & Deve esserci un controllo per "Password non valida" & \hyperref[sec:uc-0a-8]{UC-0A.8} & Opzionale \\
    \hline
    \autoRF & Deve esserci un controllo per "Email già registrata" & \hyperref[sec:uc-0a-9]{UC-0A.9} & Opzionale \\
    \hline
    \autoRF & Deve esserci un controllo per "Username già registrato" & \hyperref[sec:uc-0a-10]{UC-0A.10} & Opzionale \\
    \hline
    \autoRF & Deve esserci un controllo per "Matricola già registrata" & \hyperref[sec:uc-0a-11]{UC-0A.11} & Opzionale \\
    \hline
    \autoRF & Deve esserci un controllo per "Matricola non valida" & \hyperref[sec:uc-0a-12]{UC-0A.12} & Opzionale \\
    \hline

    \autoRF & L'utente deve avere la possibilità di autenticarsi & \hyperref[sec:uc-0b]{UC-0B} & Opzionale \\
    \hline
    \autoRF & Deve esserci un controllo per "Email non registrata" & \hyperref[sec:uc-0b-1]{UC-0B.1} & Opzionale \\
    \hline
    \autoRF & Deve esserci un controllo per "Password errata" & \hyperref[sec:uc-0b-2]{UC-0B.2} & Opzionale \\
    \hline

    \autoRF & L'utente a seguito del login deve avere la possibilità di raggiungere la Dashboard\textsubscript{\scalebox{0.6}{\textbf{G}}} & \hyperref[sec:uc-0c]{UC-0C} & Obbligatorio \\
    \hline

    \autoRF & L'utente deve avere la possibilità di gestire il proprio profilo utente & \hyperref[sec:uc-0d]{UC-0D} & Opzionale \\
    \hline
    \autoRF & L'utente deve avere la possibilità di visualizzare la propria email & \hyperref[sec:uc-0d-1]{UC-0D.1} & Opzionale \\
    \hline
    \autoRF & L'utente deve avere la possibilità di visualizzare la propria password & \hyperref[sec:uc-0d-2]{UC-0D.2} & Opzionale \\
    \hline
    \autoRF & L'utente deve avere la possibilità di visualizzare il proprio username & \hyperref[sec:uc-0d-3]{UC-0D.3} & Opzionale \\
    \hline
    \autoRF & L'utente deve avere la possibilità di visualizzare il proprio nome & \hyperref[sec:uc-0d-4]{UC-0D.4} & Opzionale \\
    \hline
    \autoRF & L'utente deve avere la possibilità di visualizzare il proprio cognome & \hyperref[sec:uc-0d-5]{UC-0D.5} & Opzionale \\
    \hline
    \autoRF & L'utente deve avere la possibilità di visualizzare la propria matricola & \hyperref[sec:uc-0d-6]{UC-0D.6} & Opzionale \\
    \hline
    \autoRF & L'utente deve avere la possibilità di modificare le informazioni nel proprio profilo utente & \hyperref[sec:uc-0d-7]{UC-0D.7} & Opzionale \\
    \hline
    \autoRF & L'utente deve avere la possibilità di non salvare le modifiche al profilo utente & \hyperref[sec:uc-0d-8]{UC-0D.8} & Opzionale \\
    \hline
    \autoRF & L'utente deve avere la possibilità di salvare le modifiche al profilo utente & \hyperref[sec:uc-0d-9]{UC-0D.9} & Opzionale \\
    \hline

    \autoRF & Un utente con titolo di admin deve avere la possibilità di gestire i ruoli degli altri utenti & \hyperref[sec:uc-0e]{UC-0E} & Opzionale \\
    \hline
    \autoRF & Un utente con titolo di admin deve poter visualizzare lista utenti registrati & \hyperref[sec:uc-0e-1]{UC-0E.1} & Opzionale \\
    \hline
    \autoRF & Un utente con titolo di admin deve poter visualizzare un elemento della lista utenti registrati & \hyperref[sec:uc-0e-2]{UC-0E.2} & Opzionale \\
    \hline
    \autoRF & Un utente con titolo di admin deve poter visualizzare il ruolo di utente registrato & \hyperref[sec:uc-0e-3]{UC-0E.3} & Opzionale \\
    \hline
    \autoRF & Un utente con titolo di admin deve poter visualizzare il nome di utente registrato & \hyperref[sec:uc-0e-4]{UC-0E.4} & Opzionale \\
    \hline
    \autoRF & Un utente con titolo di admin deve poter visualizzare il cognome di utente registrato & \hyperref[sec:uc-0e-5]{UC-0E.5} & Opzionale \\
    \hline
    \autoRF & Un utente con titolo di admin deve poter modificare il ruolo di utente registrato & \hyperref[sec:uc-0e-6]{UC-0E.6} & Opzionale \\
    \hline
    \autoRF & Deve esserci un controllo "Utente non autorizzato" quando esso prova ad accedere alla sezione "Gestione ruoli utenti" & \hyperref[sec:uc-0e-7]{UC-0E.7} & Opzionale \\
    \hline
    \autoRF & Un utente con titolo di admin deve poter annullare la modifica al ruolo utente registrato & \hyperref[sec:uc-0e-8]{UC-0E.8} & Opzionale \\
    \hline
    \autoRF & Deve esserci un controllo che prevenga l'assegnamento di un ruolo non valido & \hyperref[sec:uc-0e-9]{UC-0E.9} & Opzionale \\
    \hline

    \autoRF & Un utente deve aver la possibilità di uscire al proprio profilo (Logout) & \hyperref[sec:uc-0f]{UC-0F} & Opzionale \\
    \hline


    \autoRF & Un utente deve avere la possibilità di generare un contenuto tramite AI & \hyperref[sec:uc-1a]{UC-1A} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di inserire un prompt\textsubscript{\scalebox{0.6}{\textbf{G}}} per la propria generazione & \hyperref[sec:uc-1a-1]{UC-1A.1} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di selezionare un tono per la propria generazione & \hyperref[sec:uc-1a-2]{UC-1A.2} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di selezionare uno stile per la propria generazione & \hyperref[sec:uc-1a-3]{UC-1A.3} & Obbligatorio \\
    \hline
    \autoRF & Deve avvenire il salvataggio di ogni generazione nello storico & capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}} & Obbligatorio \\
    \hline

    \autoRF & Un utente deve avere la possibilità di visualizzare la lista degli elementi presenti nello storico & \hyperref[sec:uc-1b]{UC-1B} & Obbligatorio \\
    \hline
    \autoRF & C'è la possibilità che il prompt\textsubscript{\scalebox{0.6}{\textbf{G}}} non abbia neanche un elemento data la mancanza di generazioni & \hyperref[sec:uc-1b-1]{UC-1B.1} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare un elemento dalla lista mostrata nello storico & \hyperref[sec:uc-1b-2]{UC-1B.2} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare lo stile di una generazione & \hyperref[sec:uc-1b-3]{UC-1B.3} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare il risultato della generazione & \hyperref[sec:uc-1b-4]{UC-1B.4} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare il timestamp di una generazione & \hyperref[sec:uc-1b-5]{UC-1B.5} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare la valutazione di una generazione & \hyperref[sec:uc-1b-6]{UC-1B.6} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare il prompt\textsubscript{\scalebox{0.6}{\textbf{G}}} id una generazione & \hyperref[sec:uc-1b-7]{UC-1B.7} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare il tono di una generazione & \hyperref[sec:uc-1b-8]{UC-1B.8} & Obbligatorio \\
    \hline

    \autoRF & Un utente deve avere la possibilità di visualizzare un contenuto prima di pubblicarlo & \hyperref[sec:uc-1c]{UC-1C} & Obbligatorio \\
    \hline

    \autoRF & Un utente deve avere la possibilità di effettuare modifiche al contenuto generato & \hyperref[sec:uc-1d]{UC-1D} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di modificare l'immagine di un contenuto generato & \hyperref[sec:uc-1d-1]{UC-1D.1} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di modificare il titolo di un contenuto generato & \hyperref[sec:uc-1d-2]{UC-1D.2} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di modificare il testo di un contenuto generato & \hyperref[sec:uc-1d-3]{UC-1D.3} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di salvare le modifiche effettuate a un contenuto generato & \hyperref[sec:uc-1d-4]{UC-1D.4} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di annullare le modifiche effettuate a un contenuto generato & \hyperref[sec:uc-1d-5]{UC-1D.5} & Obbligatorio \\
    \hline
    \autoRF & Deve esserci un controllo per "File immagine non valido" & \hyperref[sec:uc-1d-6]{UC-1D.6} & Obbligatorio \\
    \hline

    \autoRF & Un utente deve avere la possibilità di riutilizzare una generazione & \hyperref[sec:uc-1e]{UC-1E} & Obbligatorio \\
    \hline

    \autoRF & Un utente deve avere la possibilità di duplicare una generazione & \hyperref[sec:uc-1f]{UC-1F} & Obbligatorio \\
    \hline

    \autoRF & Un utente deve avere la possibilità applicare un filtro alla lista dello storico & \hyperref[sec:uc-1g]{UC-1G} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare la lista dopo aver applicato il filtro & \hyperref[sec:uc-1g-1]{UC-1G.1} & Obbligatorio \\
    \hline


    \autoRF & Un utente deve avere la possibilità di rigenerare un contenuto tramite AI & \hyperref[sec:uc-1h]{UC-1H} & Obbligatorio \\
    \hline

    \autoRF & Deve avvenire una valutazione di ogni contenuto generato & \hyperref[sec:uc-1i]{UC-1i} & Obbligatorio \\
    \hline

    \autoRF & Un utente deve avere la possibilità di scartare un contenuto generato & \hyperref[sec:uc-1j]{UC-1J} & Obbligatorio \\
    \hline

    \autoRF & Un utente deve avere la possibilità di salvare il contenuto generato e eventualmente modificato & \hyperref[sec:uc-1k]{UC-1K} & Obbligatorio \\
    \hline


    \autoRF & Un utente deve avere la possibilità di far analizzare un documento al sistema AI & \hyperref[sec:uc-2a]{UC-2A} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di caricare un file all'interno del Modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} di upload e gestione documentale & \hyperref[sec:uc-2a-1]{UC-2A.1} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di inserire la categoria del documento all'interno del Modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} di upload e gestione documentale & \hyperref[sec:uc-2a-2]{UC-2A.2} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di inserire il mese/anno di competenza di un documento all'interno del Modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} di upload e gestione documentale & \hyperref[sec:uc-2a-3]{UC-2A.3} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di inserire l'azienda di appartenenza del documento all'interno del Modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} di upload e gestione documentale & \hyperref[sec:uc-2a-4]{UC-2A.4} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di inserire il reparto di appartenenza del documento all'interno del Modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} di upload e gestione documentale & \hyperref[sec:uc-2a-5]{UC-2A.5} & Obbligatorio \\
    \hline


    \autoRF & Un utente deve avere la possibilità di visualizzare la lista delle informazioni dei documenti partizionati dall'AI in seguito all'upload & \hyperref[sec:uc-2b]{UC-2B} & Obbligatorio \\
    \hline
    \autoRF & Deve esserci un controllo per "Nessun documento riconosciuto" & \hyperref[sec:uc-2b-1]{UC-2B.1} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare un elemento dalla lista delle informazioni dei documenti partizionati dall'AI in seguito all'upload & \hyperref[sec:uc-2b-2]{UC-2B.2} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare il campo di competenza di un documento & \hyperref[sec:uc-2b-3]{UC-2B.3} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare l'azienda di appartenenza di un documento & \hyperref[sec:uc-2b-4]{UC-2B.4} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare la causale di un documento & \hyperref[sec:uc-2b-5]{UC-2B.5} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare la lingua di un documento & \hyperref[sec:uc-2b-6]{UC-2B.6} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare il numero di pagine documento & \hyperref[sec:uc-2b-7]{UC-2B.7} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare il nome del documento originale & \hyperref[sec:uc-2b-8]{UC-2B.8} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare la data i redazione documento & \hyperref[sec:uc-2b-9]{UC-2B.9} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare il codice di un documento & \hyperref[sec:uc-2b-10]{UC-2B.10} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare la tipologia di un documento & \hyperref[sec:uc-2b-11]{UC-2B.11} & Obbligatorio \\
    \hline



    \autoRF & Un utente deve avere la possibilità di aprire il Modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} di gestione del documento & \hyperref[sec:uc-2c]{UC-2C} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare l'anteprima di un documento prima di inviarlo & \hyperref[sec:uc-2c-1]{UC-2C.1} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di modificare il destinatario a un documento & \hyperref[sec:uc-2c-2]{UC-2C.2} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di modificare la tipologia a un documento & \hyperref[sec:uc-2c-3]{UC-2C.3} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di rivalutare la percentuale di confidenza di un documento& \hyperref[sec:uc-2c-4]{UC-2C.4} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di salvare le modifiche apportate a un documento & \hyperref[sec:uc-2c-5]{UC-2C.5} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di aprire il Modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} riguardante le informazioni dei destinatari & \hyperref[sec:uc-2d]{UC-2D} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare la lista informazioni destinatari & \hyperref[sec:uc-2d]{UC-2D} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare un elemento dalla lista informazioni destinatari & \hyperref[sec:uc-2d-1]{UC-2D.1} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare la matricola di un destinatario & \hyperref[sec:uc-2d-3]{UC-2D.3} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare il reparto di un destinatario & \hyperref[sec:uc-2d-4]{UC-2D.4} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare il nome di un destinatario & \hyperref[sec:uc-2d-5]{UC-2D.5} & Obbligatorio \\
    \hline
    \autoRF & Deve esserci un controllo per "Nessun destinatario riconosciuto" & \hyperref[sec:uc-2b-6]{UC-2B.6} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare il codice fiscale di un destinatario & \hyperref[sec:uc-2d-2]{UC-2D.2} & Obbligatorio \\
    \hline


    \autoRF & Un utente deve avere la possibilità di visualizzare la lista storico documenti & \hyperref[sec:uc-2e]{UC-2E} & Obbligatorio \\
    \hline
    \autoRF & C'è la possibilitá che non siano mai stati registrati documenti e che quindi l'applicativo agisca di conseguenza & \hyperref[sec:uc-2e-1]{UC-2E.1} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare un elemento dalla lista storico documenti & \hyperref[sec:uc-2e-2]{UC-2E.2} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare la percentuale di confidenza di un elemento & \hyperref[sec:uc-2e-3]{UC-2E.3} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare la lista di appartenenza di un elemento & \hyperref[sec:uc-2e-4]{UC-2E.4} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare lo stato da un elemento& \hyperref[sec:uc-2e-5]{UC-2E.5} & Obbligatorio \\
    \hline

    \autoRF & Un utente deve avere la possibilità di creare un messaggio da inviare con i documenti & \hyperref[sec:uc-2f]{UC-2F} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di salvare il template di un messaaggio in uno storico per poterlo riutilizzare in futuro & \hyperref[sec:uc-2f-1]{UC-2F.1} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di modificare l'oggetto di un messaggio & \hyperref[sec:uc-2f-2]{UC-2F.2} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di modificare il testo di messaggio & \hyperref[sec:uc-2f-3]{UC-2F.3} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di confermare le modifiche apportate ad un messaggio & \hyperref[sec:uc-2f-4]{UC-2F.4} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di annullare le modifiche apportate ad un messaggio & \hyperref[sec:uc-2f-5]{UC-2F.5} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare l'oggetto di un messaggio & \hyperref[sec:uc-2f-6]{UC-2F.6} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare il testo di messaggio & \hyperref[sec:uc-2f-7]{UC-2F.7} & Obbligatorio \\
    \hline

    \autoRF & Un utente deve avere la possibilità di accedere alla pagina dei template salvati & \hyperref[sec:uc-2g]{UC-2G} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di eliminare template dalla tabella dei template salvati& \hyperref[sec:uc-2g-1]{UC-2G.1} & Obbligatorio \\
    \hline
    \autoRF & Il sistema non deve mostrare niente se nessun template è stato salvato all'interno dello storico & \hyperref[sec:uc-2g-2]{UC-2G.2} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di caricare un template per riutilizzarlo & \hyperref[sec:uc-2g-3]{UC-2G.3} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare la lista dei template salvati & \hyperref[sec:uc-2g-4]{UC-2G.4} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare un elemento dall lista template salvati & \hyperref[sec:uc-2g-5]{UC-2G.5} & Obbligatorio \\
    \hline

    \autoRF & Un utente deve avere la possibilità di inviare un documento con il relativo messaggio & \hyperref[sec:uc-2h]{UC-2H} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare allegare un file con il documento che sta inviando & \hyperref[sec:uc-2h-1]{UC-2H.1} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di pianificare l'invio di un documento & \hyperref[sec:uc-2h-2]{UC-2H.2} & Obbligatorio \\
    \hline

    \autoRF & Un utente deve avere la possibilità di filtrare la lista dei documenti & \hyperref[sec:uc-2i]{UC-2I} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare la lista filtrata delle informazioni dei documenti partizionati dall'AI in seguito all'upload & \hyperref[sec:uc-2i-1]{UC-2I.1} & Obbligatorio \\
    \hline

    \autoRF & Un utente deve avere la possibilità di filtrare la lista dei destinatari & \hyperref[sec:uc-2j]{UC-2J} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare la lista filtrata dei destinatari & \hyperref[sec:uc-2j-1]{UC-2J.1} & Obbligatorio \\
    \hline

    \autoRF & Un utente deve avere la possibilitá di filtrare i documenti nello storico per favorire la ricerca & \hyperref[sec:uc-2k]{UC-2K} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare la lista filtrata storico documenti & \hyperref[sec:uc-2k-1]{UC-2K.1} & Obbligatorio \\
    \hline



    \autoRF & Un utente deve avere la possibilità di accedere alla Dashboard\textsubscript{\scalebox{0.6}{\textbf{G}}} di analisi e Monitoraggio AI & \hyperref[sec:uc-3a]{UC-3A} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare l'elenco dati AI Assistant\textsubscript{\scalebox{0.6}{\textbf{G}}} & \hyperref[sec:uc-3a-1]{UC-3A.1} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare il numero di prompt\textsubscript{\scalebox{0.6}{\textbf{G}}} generati & \hyperref[sec:uc-3a-2]{UC-3A.2} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare il rating medio prompt\textsubscript{\scalebox{0.6}{\textbf{G}}} generati & \hyperref[sec:uc-3a-3]{UC-3A.3} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare il numero rigenerazioni prompt\textsubscript{\scalebox{0.6}{\textbf{G}}} & \hyperref[sec:uc-3a-4]{UC-3A.4} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare i toni più usati & \hyperref[sec:uc-3a-5]{UC-3A.5} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare gli stili più usati & \hyperref[sec:uc-3a-6]{UC-3A.6} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare l'elenco dati AI Co-Pilot\textsubscript{\scalebox{0.6}{\textbf{G}}} & \hyperref[sec:uc-3a-7]{UC-3A.7} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare la confidenza media & \hyperref[sec:uc-3a-8]{UC-3A.8} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare la percentuale interventi manuali & \hyperref[sec:uc-3a-9]{UC-3A.9} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare l'accuratezza mapping & \hyperref[sec:uc-3a-10]{UC-3A.10} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare i tempi medi analisi & \hyperref[sec:uc-3a-11]{UC-3A.11} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare inserire la data d'inizio delle statistiche & \hyperref[sec:uc-3a-12]{UC-3A.12} & Obbligatorio \\
    \hline
    \autoRF & Un utente deve avere la possibilità di visualizzare inserire la data di fine delle statistiche & \hyperref[sec:uc-3a-13]{UC-3A.13} & Obbligatorio \\
    \hline
