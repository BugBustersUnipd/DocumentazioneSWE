...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item UC-1A.4 - Generazione contenuto tramite AI
...
\subsubsection{UC-1A.4 - Generazione contenuto tramite AI}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Diagrammi casi d'uso/UC1A.jpg}
    \caption{Diagramma del caso d'uso UC-1A.4 - Generazione contenuto tramite AI}
\end{figure}
...
\begin{itemize}
    \item \textit{include}: 
    \begin{itemize}
        \item UC-1C – Visualizzazione pagina contenuto generato.
    \end{itemize}
    \item \textit{extend}: 
    \begin{itemize}
        \item 
...
\begin{itemize}
    \item L’utente dispone dei permessi necessari per utilizzare il modulo AI Assistant.
    \item L’utente ha inserito un prompt.
    \item L’utente ha selezionato tono desiderato.
    \item L’utente ha selezionato stile desiderato.
\end{itemize}

\textbf{Scenario principale}
\begin{enumerate}
    \item L’utente accede alla sezione “AI Assistant Generativo”.
    \item L’utente inserisce un prompt descrittivo del contenuto desiderato.
    \item L’utente seleziona il tono (es. formale, informale) e lo stile (es. sintetico, dettagliato).
    \item L’utente avvia la generazione del contenuto.
\end{enumerate}

\textbf{Post-condizioni}
\begin{itemize}
    \item Una bozza temporanea del contenuto risulta generata e visibile in anteprima (vedi UC-1C).
    \item Il prompt utilizzato è stato salvato nello storico (vedi UC-1).
\end{itemize}
...
\begin{figure}[H]
    ...
    \caption{Diagramma del caso d'uso UC-1B – Visualizzazione storico prompt}
\end{figure}
