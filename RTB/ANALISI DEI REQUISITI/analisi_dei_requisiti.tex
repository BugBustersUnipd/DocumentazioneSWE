...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item UC-0A.6 – Registrazione fallita.
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Visualizzazione modulo di upload e gestione documentale.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item UC-0D.6 - Visualizzazione id
    \end{itemize}
    \item \textit{extend}: 
    \begin{itemize}
        \item UC-0A.1 - Inserimento email
        ...
        \item UC-0A.4 - Inserimento nome 
        \item UC-0A.5 - Inserimento cognome
        \item UC-0D.7 – Salva profilo utente.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item UC-1A.4 - Visualizzazione storico prompt
        \item UC-1A.5 - Generazione contenuto tramite AI
    \end{itemize}
\end{itemize}
