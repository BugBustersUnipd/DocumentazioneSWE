...
Aggiungto modulo 3\end{minipage} 
& Marco Piro & - \\
\hline
0.0.10 & 10/12/2025 & 
\begin{minipage}[t]{\linewidth}
Rinominazione casi d'uso, aggiunta sotto-casi d'uso alle prime due sezioni.
\end{minipage} 
& Leonardo Salviato & - \\
\hline
0.0.9 & 06/12/2025 & 
...
\begin{itemize}
    ...
    \item \textit{extend}: 
    \begin{itemize}
        \item UC-2E.6 - Filtraggio documenti
        \item UC-2E.7 - visualizzazione informazioni documentazione %che dentro avrá i seguenti casi d'uso come include
        % \item UC-2B.1 – Visualizzazione codice documento
        ...
        \item UC-2E.5 - Documenti assenti.
    \end{itemize}
\end{itemize}
