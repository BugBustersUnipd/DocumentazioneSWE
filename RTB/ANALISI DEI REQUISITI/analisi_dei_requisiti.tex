...
\quad 2.4.3 UC-0C: Visualizzazione pagina principale / dashboard \\
\quad 2.4.4 UC-0D: Visualizzazione gestione profilo utente \\
\quad 2.4.5 UC-0E: Visualizzazione gestione ruoli (Admin / Editor)\\
\quad 2.4.6 UC-0F: Logout \\
2.5 Sezione 1 – Modulo “AI Assistant Generativo\\
\quad 2.5.1 UC-1A: Visualizzazione modulo di generazione contenuti AI\\
\quad 2.5.2 UC-1B: Visualizzazione storico prompt\\
\quad 2.5.3 UC-1C: Visualizzazione pagina contenuto generato\\
\quad 2.5.4 UC-1D: Visualizzazione pagina modifica contenuto generato\\

2.6 Sezione 2 – Modulo "AI Co-Pilot per i CdL"\\
\quad 2.6.1 UC-2A: Visualizzazione modulo di upload e gestione documentale\\
\quad 2.6.2 UC-2B: Visualizzazione pagina lista documenti\\
\quad 2.6.3 UC-2C: Visualizzazione pagina documento\\
\quad 2.6.4 UC-2D: Visualizzazione pagina destinatario\\
\quad 2.6.5 UC-2E: Visualizzazione pagina storico documenti\\
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \item UC-1C.3 – Salva post generato nello storico.
    \end{itemize}
    \item \textit{extend}: 
    \begin{itemize}
