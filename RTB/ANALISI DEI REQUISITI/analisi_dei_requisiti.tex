...
\textbf{Post-condizioni}
\begin{itemize}
    \item L'utente ha fatto generare un contenuto pubblicabile al sistema
...
\begin{enumerate}
    ...
    \item L'utente ottiene le informazioni ricercate
\end{enumerate}
...
\textbf{Pre-condizioni}
\begin{itemize}
    \item Si é selezionato un documento da una delle liste disponibili
\end{itemize}
...
\endlastfoot
    ...
    \hline
    RF-052 & C'é la possibilità che il prompt non abbia neanche un elemento data la mancanza di generazioni & \hyperref[sec:uc-1b-1]{UC-1B.1} & Obbligatorio \\
    \hline
