...
\newcommand{\useCase}[2]{%
    ...
    \subsubsection{\currentUCID\ – #1}\label{#2}%
}
...
\newcommand{\subUseCase}[2]{%
    ...
    % 1. Spaziatura verticale prima del titolo
    \par\vspace{10pt}%
    
    % 2. Ancora per i link (se usi hyperref)
    \phantomsection
    
    % 3. Inserimento MANUALE nell'indice (livello paragraph = 4)
    \addcontentsline{toc}{paragraph}{\numberline{}\currentSubUCID\ – #1}%
    
    % 4. Stampa visiva del titolo
    \noindent\textbf{\currentSubUCID\ – #1}% Titolo in Grassetto
    \label{#2}% Label per i riferimenti
    
    % 5. A capo forzato con piccolo spazio dopo
    \par\vspace{2pt}%
    % Ora il testo successivo inizierà sicuramente a capo
}
...
\begin{itemize}
    ...
    \item \textbf{HR Manager}: È la figura responsabile\textsubscript{\scalebox{0.6}{\textbf{G}}} della comunicazione interna. Utilizza il Modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} AI Assistant\textsubscript{\scalebox{0.6}{\textbf{G}}} per generare, revisionare e pubblicare messaggi o avvisi rivolti ai dipendenti, definendone tono e stile.
    ...
    \item \textbf{Auditor interno}: Utente con permessi di sola lettura focalizzato sul controllo. verifica\textsubscript{\scalebox{0.6}{\textbf{G}}} lo storico delle operazioni (audit trail) per garantire la tracciabilità\textsubscript{\scalebox{0.6}{\textbf{G}}} e la sicurezza dei flussi documentali.
...
\useCase{Registrazione nuovo utente}{sec:uc-0a-1}{
...
\textbf{Relazioni con altri Casi d'uso\textsubscript{\scalebox{0.6}{\textbf{G}}} (\textit{include} / \textit{extend})}
\begin{itemize}
    \item \textit{include}:
    \begin{itemize}
...
\subUseCase{Inserimento email}{sec:uc-0a-1}
...
\subUseCase{Inserimento password}{sec:uc-0a-2}
...
\subUseCase{Inserimento username}{sec:uc-0a-3}
...
\subUseCase{Inserimento nome}{sec:uc-0a-4}
...
\subUseCase{Inserimento cognome}{sec:uc-0a-5}
...
\subUseCase{Inserimento matricola}{sec:uc-0a-6}
...
\subUseCase{Email non valida}{sec:uc-0a-7}
...
\subUseCase{Password non valida}{sec:uc-0a-8}
...
\subUseCase{Email già registrata}{sec:uc-0a-9}
...
\subUseCase{Username già registrato}{sec:uc-0a-10}
...
\subUseCase{Matricola già registrata}{sec:uc-0a-11}
...
\subUseCase{Matricola non valida}{sec:uc-0a-12}
...
\useCase{Login / Autenticazione utente}{sec:uc-0b}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Diagrammi casi d'uso/UC0Bb.jpg}
...
\subUseCase{Email non registrata}{sec:uc-0b-1}
...
\subUseCase{Password errata}{sec:uc-0b-2}
...
\useCase{Apertura Dashboard\textsubscript{\scalebox{0.6}{\textbf{G}}}}{sec:uc-0c}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Diagrammi casi d'uso/UC0C.jpg}
    \caption{Diagramma del caso d'uso UC-0C – Apertura Dashboard\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\end{figure}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item L'utente autenticato si può eseguire diverse azioni dal Modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} Dashboard\textsubscript{\scalebox{0.6}{\textbf{G}}}
\end{itemize}
...
\useCase{Gestione profilo utente}{sec:uc-0d}
...
\subUseCase{Visualizzazione email}{sec:uc-0d-1}
...
\subUseCase{Visualizzazione password}{sec:uc-0d-2}
...
\subUseCase{Visualizzazione username}{sec:uc-0d-3}
...
\subUseCase{Visualizzazione nome}{sec:uc-0d-4}
...
\subUseCase{Visualizzazione cognome}{sec:uc-0d-5}
...
\subUseCase{Visualizzazione matricola}{sec:uc-0d-6}
...
\subUseCase{Modifica informazioni profilo utente}{sec:uc-0d-9}
...
\subUseCase{Uscita senza salvare profilo utente}{sec:uc-0d-8}
...
\subUseCase{Salva profilo utente}{sec:uc-0d-7}
...
\begin{enumerate}
    ...
    \item Il sistema verifica\textsubscript{\scalebox{0.6}{\textbf{G}}} la validità dei nuovi dati inseriti (controllo formato, unicità email/username/matricola analogamente alla fase di registrazione)
...
\useCase{Revisione ruoli}{sec:uc-0e}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Diagrammi casi d'uso/UC0E.jpg}
    \caption{Diagramma del caso d'uso UC-0E – Revisione ruoli}
\end{figure}
...
\textbf{Pre-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item L'utente Amministratore\textsubscript{\scalebox{0.6}{\textbf{G}}} ha effettuato il login ed è autenticato come "Admin".
    \item Esistono uno o più account utente registrati nel sistema.
    \item L'utente Amministratore\textsubscript{\scalebox{0.6}{\textbf{G}}} è entrato nel Modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} di gestione ruoli dalla Dashboard\textsubscript{\scalebox{0.6}{\textbf{G}}} principale.
\end{itemize}

\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item L'Amministratore\textsubscript{\scalebox{0.6}{\textbf{G}}} vede gli utenti registrati con i rispettivi ruoli e sono corretti
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'Amministratore\textsubscript{\scalebox{0.6}{\textbf{G}}} accede alla sezione di amministrazione utenti.
    \item Il sistema mostra l'elenco degli utenti registrati, con i rispettivi ruoli correnti.
    \item L'Amministratore\textsubscript{\scalebox{0.6}{\textbf{G}}} è soddisfatto della situazione attuale e non apporta modifiche.
\end{enumerate}

\textbf{Scenario secondario\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item Un utente non autorizzato tenta di accedere al Modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} di gestione ruoli.
    \item Un utente Amministratore\textsubscript{\scalebox{0.6}{\textbf{G}}} non è soddisfatto dei ruoli attuali e decide di modificarli.
\end{enumerate}
...
\subUseCase{Visualizzazione lista utenti registrati}{sec:uc-0e-1}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Diagrammi casi d'uso/UC0E-1.jpg}
    \caption{Diagramma del caso d'uso UC-0E.1 – Visualizzazione lista utenti registrati}
\end{figure}
...
\subUseCase{Visualizzazione elemento lista utenti registrati}{sec:uc-0e-2}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Diagrammi casi d'uso/UC0E-2.jpg}
    \caption{Diagramma del caso d'uso UC-0E.2 – Visualizzazione elemento lista utenti registrati}
\end{figure}
...
\subUseCase{Visualizzazione ruolo utente registrato}{sec:uc-0e-3}
...
\subUseCase{Visualizzazione nome utente registrato}{sec:uc-0e-4}
...
\subUseCase{Visualizzazione cognome utente registrato}{sec:uc-0e-5}
...
\subUseCase{Modifica ruolo utente registrato}{sec:uc-0e-6}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item L'interfaccia\textsubscript{\scalebox{0.6}{\textbf{G}}} permette la selezione di un nuovo ruolo per l'utente scelto
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'Amministratore\textsubscript{\scalebox{0.6}{\textbf{G}}} interagisce con il campo relativo al ruolo apportando delle modifiche che verranno salvate nel sistema
\end{enumerate}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item UC-0E.9 - Errore modifica ruolo utente registrato.
    \end{itemize}
...
\subUseCase{Utente non autorizzato}{sec:uc-0e-7}

\textbf{Attori\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Utente generico (non Amministratore\textsubscript{\scalebox{0.6}{\textbf{G}}})
\end{itemize}

\textbf{Pre-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Un utente senza privilegi di amministrazione tenta di accedere a funzionalità\textsubscript{\scalebox{0.6}{\textbf{G}}} o pagine riservate alla gestione ruoli
\end{itemize}
...
\begin{enumerate}
    ...
    \item Il sistema verifica\textsubscript{\scalebox{0.6}{\textbf{G}}} i permessi, rileva l'assenza del ruolo di Amministratore\textsubscript{\scalebox{0.6}{\textbf{G}}} e blocca l'operazione
\end{enumerate}


\vspace{0.5cm}

\subUseCase{Annulla modifica ruolo utente registrato}{sec:uc-0e-8}
...
\subUseCase{Errore modifica ruolo utente registrato}{sec:uc-0e-9}
...
\begin{itemize}
    \item L'Amministratore\textsubscript{\scalebox{0.6}{\textbf{G}}} sta modificando il ruolo di un utente
    \item L'Amministratore\textsubscript{\scalebox{0.6}{\textbf{G}}} cerca di assegnare un ruolo a un utente non idoneo (es. assegnare il ruolo di Admin a un utente già Admin)
\end{itemize}

\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item L'assegnamento del ruolo viene impedito e viene mostrato un messaggio di errore
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'Amministratore\textsubscript{\scalebox{0.6}{\textbf{G}}} esegue un'operazione non valida
...
\useCase{Logout}{sec:uc-0f}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{Diagrammi casi d'uso/UC0F.jpg}
...
\begin{itemize}
    ...
    \item Per accedere nuovamente alle funzionalità\textsubscript{\scalebox{0.6}{\textbf{G}}} riservate è necessario eseguire un nuovo login.
\end{itemize}
...
\useCase{Generazione contenuti AI}{sec:uc-1a}
...
\textbf{Attori\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item HR manager/Redattore\textsubscript{\scalebox{0.6}{\textbf{G}}}
\end{itemize}
...
\subUseCase{Inserimento prompt\textsubscript{\scalebox{0.6}{\textbf{G}}}}{sec:uc-1a-1}
...
\textbf{Pre-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item L'utente si trova nell'interfaccia\textsubscript{\scalebox{0.6}{\textbf{G}}} di generazione contenuti AI (UC-1A)
    \item La casella di testo del prompt\textsubscript{\scalebox{0.6}{\textbf{G}}} è vuota o modificabile
\end{itemize}

\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item La casella di testo contiene la descrizione (prompt\textsubscript{\scalebox{0.6}{\textbf{G}}}) inserita dall'utente
\end{itemize}
...
\subUseCase{Selezione tono}{sec:uc-1a-2}
...
\textbf{Pre-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item L'utente si trova nell'interfaccia\textsubscript{\scalebox{0.6}{\textbf{G}}} di generazione contenuti AI
\end{itemize}
...
\subUseCase{Selezione stile}{sec:uc-1a-3}
...
\useCase{Visualizzazione lista elementi storico}{sec:uc-1b}
...
\subUseCase{Nessun prompt\textsubscript{\scalebox{0.6}{\textbf{G}}} salvato}{sec:uc-1b-1}
...
\begin{enumerate}
    ...
    \item Il sistema non trova record associati all'utente e mostra un messaggio del tipo "Nessun prompt\textsubscript{\scalebox{0.6}{\textbf{G}}} presente nello storico"
\end{enumerate}


\vspace{0.5cm}

\subUseCase{Visualizzazione informazioni elemento}{sec:uc-1b-2}
...
\subUseCase{Visualizzazione stile}{sec:uc-1b-3}
...
\subUseCase{Visualizzazione risultato}{sec:uc-1b-4}
...
\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item Il sistema mostra il contenuto testuale prodotto dall'AI in risposta al prompt\textsubscript{\scalebox{0.6}{\textbf{G}}}, mantenendo la formattazione originale se presente
\end{enumerate}


\vspace{0.5cm}

\subUseCase{Visualizzazione timestamp}{sec:uc-1b-5}
...
\subUseCase{Visualizzazione valutazione}{sec:uc-1b-6}
...
\subUseCase{Visualizzazione prompt\textsubscript{\scalebox{0.6}{\textbf{G}}}}{sec:uc-1b-7}
...
\subUseCase{Visualizzazione tono}{sec:uc-1b-8}
...
\useCase{Visualizzazione anteprima contenuto generato}{sec:uc-1c}
...
\useCase{Revisione contenuto generato}{sec:uc-1d}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Diagrammi casi d'uso/UC1D.jpg}
    \caption{Diagramma del caso d'uso UC-1D – Revisione contenuto generato}
\end{figure}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item L'utente ha revisionato il risultato ed è soddisfatto del contenuto finale.
\end{itemize}
...
\begin{enumerate}
    ...
    \item L'utente seleziona l'opzione di revisione del contenuto generato.
    \item L'utente è soddisfatto del contenuto generato e decide di lasciarlo così com'è.
\end{enumerate}

\textbf{Scenario secondario\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente non è soddisfatto del contenuto generato e decide di modificarlo.
\end{enumerate}
...
\begin{itemize}
    \item \textit{include}: 
    \begin{itemize}
        \item UC-1C – Visualizzazione anteprima contenuto generato
    \end{itemize}
    \item \textit{extend}: 
    \begin{itemize}
...
\subUseCase{Modifica immagine}{sec:uc-1d-1}
...
\subUseCase{Modifica titolo}{sec:uc-1d-2}
...
\subUseCase{Modifica testo}{sec:uc-1d-3}
...
\subUseCase{Salva modifiche}{sec:uc-1d-4}
...
\subUseCase{Annulla modifiche}{sec:uc-1d-5}
...
\subUseCase{File immagine non valido}{sec:uc-1d-6}
...
\useCase{Ricerca generazione}{sec:uc-1g}
...
\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente inserisce una parola chiave (es. parte del prompt\textsubscript{\scalebox{0.6}{\textbf{G}}} o data) nella barra di ricerca
...
\subUseCase{Visualizzazione lista elementi storico filtrata}{sec:uc-1g-1}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Diagrammi casi d'uso/UC1G-1.jpg}
    \caption{Diagramma del caso d'uso UC-1G.1 – Visualizzazione lista elementi storico filtrata}
\end{figure}
...
\useCase{Rigenera contenuto tramite AI}{sec:uc-1h}
...
\useCase{Valuta contenuto generato}{sec:uc-1i}
...
\useCase{Scarta contenuto generato}{sec:uc-1j}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Il contenuto attuale viene rimosso dalla vista e l'utente ritorna alla fase di inserimento prompt\textsubscript{\scalebox{0.6}{\textbf{G}}}
...
\useCase{Salvataggio contenuto generato}{sec:uc-1k}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Diagrammi casi d'uso/UC1K.jpg}
    \caption{Diagramma del caso d'uso UC-1K – Salva contenuto generato}
\end{figure}
...
\useCase{Analisi e gestione documentale}{sec:uc-2a}
...
\subUseCase{Caricamento file}{sec:uc-2a-1}
...
\textbf{Pre-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Il Modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} AI Co-Pilot\textsubscript{\scalebox{0.6}{\textbf{G}}} é caricato
    \item L'utente dispone di file idonei al caricamento
\end{itemize}

\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Il file è stato selezionato e pre-caricato nell'applicativo, pronto per l'associazione dei metadati (oppure viene mostrato un errore)
\end{itemize}
...
\subUseCase{Inserimento categoria}{sec:uc-2a-2}
...
\subUseCase{Inserimento mese/anno di competenza}{sec:uc-2a-3}
...
\subUseCase{Inserimento azienda}{sec:uc-2a-4}
...
\subUseCase{Inserimento reparto}{sec:uc-2a-5}
...
\useCase{Visualizzazione lista documenti analisi}{sec:uc-2b}
...
\subUseCase{Nessun documento riconosciuto}{sec:uc-2b-1}
...
\subUseCase{Visualizzazione elemento da lista documenti}{sec:uc-2b-2}
\textbf{Attori\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Operatore CdL\textsubscript{\scalebox{0.6}{\textbf{G}}}
\end{itemize}
...
\subUseCase{Visualizzazione competenza documento}{sec:uc-2b-3}
...
\subUseCase{Visualizzazione azienda documento}{sec:uc-2b-4}
...
\subUseCase{Visualizzazione causale}{sec:uc-2b-5}
...
\subUseCase{Visualizzazione lingua}{sec:uc-2b-6}
...
\subUseCase{Visualizzazione numero pagine documento}{sec:uc-2b-7}
...
\subUseCase{Visualizzazione nome documento originale}{sec:uc-2b-8}
...
\subUseCase{Visualizzazione data redazione documento}{sec:uc-2b-9}
...
\subUseCase{Visualizzazione codice documento}{sec:uc-2b-10}
...
\subUseCase{Visualizzazione tipologia documento}{sec:uc-2b-11}
...
\useCase{Revisione documento analizzato}{sec:uc-2c}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Diagrammi casi d'uso/UC2Ca.jpg}
    \caption{Diagramma del caso d'uso UC-2C – Revisione documento analizzato(include)}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Diagrammi casi d'uso/UC2Cb.jpg}
    \caption{Diagramma del caso d'uso UC-2C – Revisione documento analizzato (extend)}
\end{figure}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item L'utente è soddisfatto delle informazioni del documento e i dati rimangono inalterati
\end{itemize}
...
\textbf{Scenario secondario\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente non è soddisfatto delle informazioni estratte automaticamente e decide di modificarle.
    \item L'utente apporta le modifiche necessarie (destinatario, tipologia, ricalcolo percentuale di confidenza).
    \item L'utente salva le modifiche apportate
\end{enumerate}
...
\subUseCase{Visualizzazione anteprima documento}{sec:uc-2c-1}
...
\subUseCase{Modifica destinatario}{sec:uc-2c-2}
...
\subUseCase{Modifica tipologia documento}{sec:uc-2c-3}
...
\subUseCase{Rivaluta percentuale confidenza}{sec:uc-2c-4}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item La percentuale di confidenza viene ricalcolata o impostata al 100\% (validazione\textsubscript{\scalebox{0.6}{\textbf{G}}} manuale).
\end{itemize}
...
\subUseCase{Salva modifiche documento}{sec:uc-2c-5}
...
\begin{itemize}
    ...
    \item I dati inseriti rispettano i vincoli di validazione\textsubscript{\scalebox{0.6}{\textbf{G}}}.
\end{itemize}
...
\textbf{Scenario secondario\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item Il sistema rileva dati mancanti o incongruenti (Errore validazione\textsubscript{\scalebox{0.6}{\textbf{G}}}).
    \item Il salvataggio viene bloccato e viene mostrato un messaggio di errore all'utente.
\end{enumerate}

\useCase{Visualizzazione lista informazioni destinatari analisi}{sec:uc-2d}
...
\begin{itemize}
    ...
    \item \textit{extend}: 
    \begin{itemize}
        \item UC-2D.6 – Nessun destinatario riconosciuto
    \end{itemize}
\end{itemize}

\vspace{0.5cm}

\subUseCase{Visualizzazione elemento da lista informazioni destinatari}{sec:uc-2d-1}
...
\subUseCase{Visualizzazione codice fiscale}{sec:uc-2d-2}
...
\subUseCase{Visualizzazione matricola}{sec:uc-2d-3}
...
\subUseCase{Visualizzazione reparto}{sec:uc-2d-4}
...
\subUseCase{Visualizzazione destinatario}{sec:uc-2d-5}
...
\subUseCase{Nessun destinatario riconosciuto}{sec:uc-2b-6}
...
\useCase{Visualizzazione lista storico documenti}{sec:uc-2e}
...
\begin{itemize}
    \item \textit{include}: 
    \begin{itemize}
        \item UC-2E.2 – Visualizzazione elemento da lista storico documenti
    \end{itemize}
    \item \textit{extend}: 
    \begin{itemize}
...
\subUseCase{Documenti assenti}{sec:uc-2e-1}
...
\subUseCase{Visualizzazione elemento da lista storico documenti}{sec:uc-2e-4}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Diagrammi casi d'uso/UC2E-2.jpg}
    \caption{Diagramma del caso d'uso UC-2E.2 – Visualizzazione elemento dalista storico documenti}
\end{figure}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item UC-2E.4 - Visualizzazione appartenenza lista distribuzione
...
\subUseCase{Visualizzazione percentuale confidenza}{sec:uc-2e-3}
...
\subUseCase{Visualizzazione appartenenza lista distribuzione}{sec:uc-2e-2}
...
\subUseCase{Visualizzazione stato}{sec:uc-2e-5}
...
\useCase{Creazione messaggio}{sec:uc-2f}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Diagrammi casi d'uso/UC2Fa.jpg}
    \caption{Diagramma del caso d'uso UC-2F – Creazione messaggio (include)}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Diagrammi casi d'uso/UC2Fb.jpg}
    \caption{Diagramma del caso d'uso UC-2F – Creazione messaggio (extend)}
\end{figure}
...
\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item Un utente ha selezionato uno o piú documenti da inviare a uno o piú destinatari 
    \item L'utente è soddisfatto con il messaggio generato da inviare assieme ai documenti.
\end{enumerate}

\textbf{Scenario secondario\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente non essere soddisfatto del messaggio generato automaticamente o preimpostato.
    \item L'utente apporta modifiche all'oggetto e/o al testo del messaggio.
    \item L'utente salva le modifiche apportate.
\end{enumerate}
...
\subUseCase{Salva template messaggio}{sec:uc-2f-1}
...
\subUseCase{Modifica oggetto messaggio}{sec:uc-2f-2}
...
\subUseCase{Modifica testo messaggio}{sec:uc-2f-3}
...
\subUseCase{Conferma modifica messaggio}{sec:uc-2f-4}
...
\subUseCase{Uscita senza salvare modifica messaggio}{sec:uc-2f-5}
...
\textbf{Pre-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Sono state apportate modifiche ai campi oggetto o testo
\end{itemize}

\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Le modifiche non vengono salvate in preparazione all'invio.
\end{itemize}

\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente termina la digitazione.
    \item L'utente esce senza confermare le modifiche
\end{enumerate}

\vspace{0.5cm}

\subUseCase{Visualizzazione oggetto messaggio}{sec:uc-2f-6}
...
\subUseCase{Visualizzazione testo messaggio}{sec:uc-2f-7}
...
\useCase{Gestione template salvati }{sec:uc-2g}
...
\subUseCase{Elimina template}{sec:uc-2g-1}
...
\subUseCase{Nessun template salvato}{sec:uc-2g-2}
...
\subUseCase{Carica template}{sec:uc-2g-3}
...
\subUseCase{Visualizzazione lista template salvati}{sec:uc-2g-4}
...
\subUseCase{Visualizzazione elemento da lista template salvati}{sec:uc-2g-5}
...
\useCase{Invio documento e messaggio}{sec:uc-2h}
...
\subUseCase{Allega file}{sec:uc-2h-1}
...
\subUseCase{Pianifica invio}{sec:uc-2h-2}
...
\useCase{Filtraggio documenti analisi}{sec:uc-2i}
...
\subUseCase{Visualizzazione lista documenti filtrata}{sec:uc-2i-1}
...
\useCase{Filtraggio destinatari analisi}{sec:uc-2j}
...
\subUseCase{Visualizzazione lista destinatari filtrata}{sec:uc-2j-1}
...
\useCase{Filtraggio documenti storico}{sec:uc-2k}
...
\subUseCase{Visualizzazione lista storico documenti filtrata}{sec:uc-2k-1}
...
\useCase{Analisi e Monitoraggio AI}{sec:uc-3a}
...
\textbf{Attori\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Auditor/Data Analyst\textsubscript{\scalebox{0.6}{\textbf{G}}}
\end{itemize}
...
\begin{itemize}
    ...
    \item L'utente accede alla sezione ``Analytics e Monitoraggio'' dalla Dashboard\textsubscript{\scalebox{0.6}{\textbf{G}}} principale.
\end{itemize}
...
\begin{itemize}
    \item \textit{include}: 
    \begin{itemize}
        \item UC-3A.1 - Visualizzazione elenco dati AI Assistant\textsubscript{\scalebox{0.6}{\textbf{G}}}
        \item UC-3A.7 - Visualizzazione elenco dati AI Co-Pilot\textsubscript{\scalebox{0.6}{\textbf{G}}}
    \end{itemize}
    \item \textit{extend}: 
    \begin{itemize}
...
\subUseCase{Visualizzazione elenco dati AI Assistant\textsubscript{\scalebox{0.6}{\textbf{G}}}}{sec:uc-3a-1}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Diagrammi casi d'uso/UC3A-1.jpg}
    \caption{Diagramma del caso d'uso UC-3A.1 – Visualizzazione elenco dati AI Assistant\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\end{figure}
...
\subUseCase{Visualizzazione numero prompt\textsubscript{\scalebox{0.6}{\textbf{G}}} generati}{sec:uc-3a-2}
...
\subUseCase{Visualizzazione rating medio prompt\textsubscript{\scalebox{0.6}{\textbf{G}}} generati}{sec:uc-3a-3}
...
\subUseCase{Visualizzazione numero rigenerazioni prompt\textsubscript{\scalebox{0.6}{\textbf{G}}}}{sec:uc-3a-4}
...
\subUseCase{Visualizzazione toni più usati}{sec:uc-3a-5}
...
\subUseCase{Visualizzazione stili più usati}{sec:uc-3a-6}
...
\subUseCase{Visualizzazione elenco dati AI Co-Pilot\textsubscript{\scalebox{0.6}{\textbf{G}}}}{sec:uc-3a-7}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Diagrammi casi d'uso/UC3A-7.jpg}
    \caption{Diagramma del caso d'uso UC-3A.7 – Visualizzazione elenco dati AI Co-Pilot\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\end{figure}
...
\subUseCase{Visualizzazione confidenza media}{sec:uc-3a-8}
...
\subUseCase{Visualizzazione percentuale interventi manuali}{sec:uc-3a-9}
...
\subUseCase{Visualizzazione accuratezza mapping}{sec:uc-3a-10}
...
\subUseCase{Visualizzazione tempi medi analisi}{sec:uc-3a-11}
...
\subUseCase{Inserimento data inizio}{sec:uc-3a-12}
...
\subUseCase{Inserimento data fine}{sec:uc-3a-13}
...
\begin{itemize}
    ...
    \item I dati mostrati nella Dashboard\textsubscript{\scalebox{0.6}{\textbf{G}}} vengono ricalcolati in base al nuovo intervallo chiuso (Start Date - End Date).
\end{itemize}
...
\begin{enumerate}
    ...
    \item Il sistema verifica\textsubscript{\scalebox{0.6}{\textbf{G}}} che la data sia successiva o uguale alla data di inizio.
    \item Il sistema avvia l'aggiornamento delle metriche visualizzate (refresh della Dashboard\textsubscript{\scalebox{0.6}{\textbf{G}}}).
\end{enumerate}
...
\endlastfoot
    ...
    \hline
    RF-002 & L'utente deve poter inserire la propria email & \hyperref[sec:uc-0a-1]{UC-0A.1} & Opzionale \\
    \hline
    ...
    RF-017 & L'utente a seguito del login deve avere la possibilità di raggiungere la Dashboard\textsubscript{\scalebox{0.6}{\textbf{G}}} & \hyperref[sec:uc-0c]{UC-0C} & Obbligatorio \\
    \hline
    ...
    \hline
    RF-025 & L'utente deve avere la possibilità di modificare le informazioni nel proprio profilo utente & \hyperref[sec:uc-0d-7]{UC-0D.7} & Opzionale \\
    \hline
    ...
    \hline
    RF-027 & L'utente deve avere la possibilità di salvare le modifiche al profilo utente & \hyperref[sec:uc-0d-9]{UC-0D.9} & Opzionale \\
    \hline

    RF-028 & Un utente con titolo di admin deve avere la possibilità di gestire i ruoli degli altri utenti & \hyperref[sec:uc-0e]{UC-0E} & Opzionale \\
    \hline
    RF-029 & Un utente con titolo di admin deve poter visualizzare lista utenti registrati & \hyperref[sec:uc-0e-1]{UC-0E.1} & Opzionale \\
    \hline
    RF-030 & Un utente con titolo di admin deve poter visualizzare un elemento della lista utenti registrati & \hyperref[sec:uc-0e-2]{UC-0E.2} & Opzionale \\
    \hline
    RF-031 & Un utente con titolo di admin deve poter visualizzare il ruolo di utente registrato & \hyperref[sec:uc-0e-3]{UC-0E.3} & Opzionale \\
    \hline
    RF-032 & Un utente con titolo di admin deve poter visualizzare il nome di utente registrato & \hyperref[sec:uc-0e-4]{UC-0E.4} & Opzionale \\
    \hline
    RF-033 & Un utente con titolo di admin deve poter visualizzare il cognome di utente registrato & \hyperref[sec:uc-0e-5]{UC-0E.5} & Opzionale \\
    \hline
    RF-034 & Un utente con titolo di admin deve poter modificare il ruolo di utente registrato & \hyperref[sec:uc-0e-6]{UC-0E.6} & Opzionale \\
    \hline
    RF-035 & Deve esserci un controllo "Utente non autorizzato" quando esso prova ad accedere alla sezione "Gestione ruoli utenti" & \hyperref[sec:uc-0e-7]{UC-0E.7} & Opzionale \\
    \hline
    RF-036 & Un utente con titolo di admin deve poter annullare la modifica al ruolo utente registrato & \hyperref[sec:uc-0e-8]{UC-0E.8} & Opzionale \\
    \hline
    RF-037 & Deve esserci un controllo che prevenga l'assegnamento di un ruolo non valido & \hyperref[sec:uc-0e-9]{UC-0E.9} & Opzionale \\
    \hline

    RF-038 & Un utente deve aver la possibilità di uscire al proprio profilo (Logout) & \hyperref[sec:uc-0f]{UC-0F} & Opzionale \\
    \hline


    RF-039 & Un utente deve avere la possibilità di generare un contenuto tramite AI & \hyperref[sec:uc-1a]{UC-1A} & Obbligatorio \\
    \hline
    RF-040 & Un utente deve avere la possibilità di inserire un prompt\textsubscript{\scalebox{0.6}{\textbf{G}}} per la propria generazione & \hyperref[sec:uc-1a-1]{UC-1A.1} & Obbligatorio \\
    \hline
    RF-041 & Un utente deve avere la possibilità di selezionare un tono per la propria generazione & \hyperref[sec:uc-1a-2]{UC-1A.2} & Obbligatorio \\
    \hline
    RF-042 & Un utente deve avere la possibilità di selezionare uno stile per la propria generazione & \hyperref[sec:uc-1a-3]{UC-1A.3} & Obbligatorio \\
    \hline
    RF-043 & Deve avvenire il salvataggio di ogni generazione nello storico & capitolato\textsubscript{\scalebox{0.6}{\textbf{G}}} & Obbligatorio \\
    \hline

    RF-044 & Un utente deve avere la possibilità di visualizzare la lista degli elementi presenti nello storico & \hyperref[sec:uc-1b]{UC-1B} & Obbligatorio \\
    \hline
    RF-045 & C'è la possibilità che il prompt\textsubscript{\scalebox{0.6}{\textbf{G}}} non abbia neanche un elemento data la mancanza di generazioni & \hyperref[sec:uc-1b-1]{UC-1B.1} & Obbligatorio \\
    \hline
    RF-046 & Un utente deve avere la possibilità di visualizzare un elemento dalla lista mostrata nello storico & \hyperref[sec:uc-1b-2]{UC-1B.2} & Obbligatorio \\
    \hline
    RF-047 & Un utente deve avere la possibilità di visualizzare lo stile di una generazione & \hyperref[sec:uc-1b-3]{UC-1B.3} & Obbligatorio \\
    \hline
    RF-048 & Un utente deve avere la possibilità di visualizzare il risultato della generazione & \hyperref[sec:uc-1b-4]{UC-1B.4} & Obbligatorio \\
    \hline
    RF-049 & Un utente deve avere la possibilità di visualizzare il timestamp di una generazione & \hyperref[sec:uc-1b-5]{UC-1B.5} & Obbligatorio \\
    \hline
    RF-050 & Un utente deve avere la possibilità di visualizzare la valutazione di una generazione & \hyperref[sec:uc-1b-6]{UC-1B.6} & Obbligatorio \\
    \hline
    RF-051 & Un utente deve avere la possibilità di visualizzare il prompt\textsubscript{\scalebox{0.6}{\textbf{G}}} id una generazione & \hyperref[sec:uc-1b-7]{UC-1B.7} & Obbligatorio \\
    \hline
    RF-052 & Un utente deve avere la possibilità di visualizzare il tono di una generazione & \hyperref[sec:uc-1b-8]{UC-1B.8} & Obbligatorio \\
    \hline

    RF-053 & Un utente deve avere la possibilità di visualizzare un contenuto prima di pubblicarlo & \hyperref[sec:uc-1c]{UC-1C} & Obbligatorio \\
    \hline

    RF-054 & Un utente deve avere la possibilità di effettuare modifiche al contenuto generato & \hyperref[sec:uc-1d]{UC-1D} & Obbligatorio \\
    \hline
    RF-055 & Un utente deve avere la possibilità di modificare l'immagine di un contenuto generato & \hyperref[sec:uc-1d-1]{UC-1D.1} & Obbligatorio \\
    \hline
    RF-056 & Un utente deve avere la possibilità di modificare il titolo di un contenuto generato & \hyperref[sec:uc-1d-2]{UC-1D.2} & Obbligatorio \\
    \hline
    RF-057 & Un utente deve avere la possibilità di modificare il testo di un contenuto generato & \hyperref[sec:uc-1d-3]{UC-1D.3} & Obbligatorio \\
    \hline
    RF-058 & Un utente deve avere la possibilità di salvare le modifiche effettuate a un contenuto generato & \hyperref[sec:uc-1d-4]{UC-1D.4} & Obbligatorio \\
    \hline
    RF-059 & Un utente deve avere la possibilità di annullare le modifiche effettuate a un contenuto generato & \hyperref[sec:uc-1d-5]{UC-1D.5} & Obbligatorio \\
    \hline
    RF-060 & Deve esserci un controllo per "File immagine non valido" & \hyperref[sec:uc-1d-6]{UC-1D.6} & Obbligatorio \\
    \hline

    RF-061 & Un utente deve avere la possibilità di riutilizzare una generazione & \hyperref[sec:uc-1e]{UC-1E} & Obbligatorio \\
    \hline

    RF-062 & Un utente deve avere la possibilità di duplicare una generazione & \hyperref[sec:uc-1f]{UC-1F} & Obbligatorio \\
    \hline

    RF-063 & Un utente deve avere la possibilità applicare un filtro alla lista dello storico & \hyperref[sec:uc-1g]{UC-1G} & Obbligatorio \\
    \hline
    RF-064 & Un utente deve avere la possibilità di visualizzare la lista dopo aver applicato il filtro & \hyperref[sec:uc-1g-1]{UC-1G.1} & Obbligatorio \\
    \hline


    RF-065 & Un utente deve avere la possibilità di rigenerare un contenuto tramite AI & \hyperref[sec:uc-1h]{UC-1H} & Obbligatorio \\
    \hline

    RF-066 & Deve avvenire una valutazione di ogni contenuto generato & \hyperref[sec:uc-1i]{UC-1i} & Obbligatorio \\
    \hline

    RF-067 & Un utente deve avere la possibilità di scartare un contenuto generato & \hyperref[sec:uc-1j]{UC-1J} & Obbligatorio \\
    \hline

    RF-068 & Un utente deve avere la possibilità di salvare il contenuto generato e eventualmente modificato & \hyperref[sec:uc-1k]{UC-1K} & Obbligatorio \\
    \hline


    RF-069 & Un utente deve avere la possibilità di far analizzare un documento al sistema AI & \hyperref[sec:uc-2a]{UC-2A} & Obbligatorio \\
    \hline
    RF-070 & Un utente deve avere la possibilità di caricare un file all'interno del Modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} di upload e gestione documentale & \hyperref[sec:uc-2a-1]{UC-2A.1} & Obbligatorio \\
    \hline
    RF-071 & Un utente deve avere la possibilità di inserire la categoria del documento all'interno del Modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} di upload e gestione documentale & \hyperref[sec:uc-2a-2]{UC-2A.2} & Obbligatorio \\
    \hline
    RF-072 & Un utente deve avere la possibilità di inserire il mese/anno di competenza di un documento all'interno del Modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} di upload e gestione documentale & \hyperref[sec:uc-2a-3]{UC-2A.3} & Obbligatorio \\
    \hline
    RF-073 & Un utente deve avere la possibilità di inserire l'azienda di appartenenza del documento all'interno del Modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} di upload e gestione documentale & \hyperref[sec:uc-2a-4]{UC-2A.4} & Obbligatorio \\
    \hline
    RF-074 & Un utente deve avere la possibilità di inserire il reparto di appartenenza del documento all'interno del Modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} di upload e gestione documentale & \hyperref[sec:uc-2a-5]{UC-2A.5} & Obbligatorio \\
    \hline


    RF-075 & Un utente deve avere la possibilità di visualizzare la lista delle informazioni dei documenti partizionati dall'AI in seguito all'upload & \hyperref[sec:uc-2b]{UC-2B} & Obbligatorio \\
    \hline
    RF-076 & Deve esserci un controllo per "Nessun documento riconosciuto" & \hyperref[sec:uc-2b-1]{UC-2B.1} & Obbligatorio \\
    \hline
    RF-077 & Un utente deve avere la possibilità di visualizzare un elemento dalla lista delle informazioni dei documenti partizionati dall'AI in seguito all'upload & \hyperref[sec:uc-2b-2]{UC-2B.2} & Obbligatorio \\
    \hline
    RF-078 & Un utente deve avere la possibilità di visualizzare il campo di competenza di un documento & \hyperref[sec:uc-2b-3]{UC-2B.3} & Obbligatorio \\
    \hline
    RF-079 & Un utente deve avere la possibilità di visualizzare l'azienda di appartenenza di un documento & \hyperref[sec:uc-2b-4]{UC-2B.4} & Obbligatorio \\
    \hline
    RF-080 & Un utente deve avere la possibilità di visualizzare la causale di un documento & \hyperref[sec:uc-2b-5]{UC-2B.5} & Obbligatorio \\
    \hline
    RF-081 & Un utente deve avere la possibilità di visualizzare la lingua di un documento & \hyperref[sec:uc-2b-6]{UC-2B.6} & Obbligatorio \\
    \hline
    RF-082 & Un utente deve avere la possibilità di visualizzare il numero di pagine documento & \hyperref[sec:uc-2b-7]{UC-2B.7} & Obbligatorio \\
    \hline
    RF-083 & Un utente deve avere la possibilità di visualizzare il nome del documento originale & \hyperref[sec:uc-2b-8]{UC-2B.8} & Obbligatorio \\
    \hline
    RF-084 & Un utente deve avere la possibilità di visualizzare la data i redazione documento & \hyperref[sec:uc-2b-9]{UC-2B.9} & Obbligatorio \\
    \hline
    RF-085 & Un utente deve avere la possibilità di visualizzare il codice di un documento & \hyperref[sec:uc-2b-10]{UC-2B.10} & Obbligatorio \\
    \hline
    RF-086 & Un utente deve avere la possibilità di visualizzare la tipologia di un documento & \hyperref[sec:uc-2b-11]{UC-2B.11} & Obbligatorio \\
    \hline



    RF-087 & Un utente deve avere la possibilità di aprire il Modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} di gestione del documento & \hyperref[sec:uc-2c]{UC-2C} & Obbligatorio \\
    \hline
    RF-088 & Un utente deve avere la possibilità di visualizzare l'anteprima di un documento prima di inviarlo & \hyperref[sec:uc-2c-1]{UC-2C.1} & Obbligatorio \\
    \hline
    RF-089 & Un utente deve avere la possibilità di modificare il destinatario a un documento & \hyperref[sec:uc-2c-2]{UC-2C.2} & Obbligatorio \\
    \hline
    RF-090 & Un utente deve avere la possibilità di modificare la tipologia a un documento & \hyperref[sec:uc-2c-3]{UC-2C.3} & Obbligatorio \\
    \hline
    RF-091 & Un utente deve avere la possibilità di rivalutare la percentuale di confidenza di un documento& \hyperref[sec:uc-2c-4]{UC-2C.4} & Obbligatorio \\
    \hline
    RF-092 & Un utente deve avere la possibilità di salvare le modifiche apportate a un documento & \hyperref[sec:uc-2c-5]{UC-2C.5} & Obbligatorio \\
    \hline
    RF-093 & Un utente deve avere la possibilità di aprire il Modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} riguardante le informazioni dei destinatari & \hyperref[sec:uc-2d]{UC-2D} & Obbligatorio \\
    \hline
    RF-094 & Un utente deve avere la possibilità di visualizzare la lista informazioni destinatari & \hyperref[sec:uc-2d]{UC-2D} & Obbligatorio \\
    \hline
    RF-095 & Un utente deve avere la possibilità di visualizzare un elemento dalla lista informazioni destinatari & \hyperref[sec:uc-2d-1]{UC-2D.1} & Obbligatorio \\
    \hline
    RF-096 & Un utente deve avere la possibilità di visualizzare la matricola di un destinatario & \hyperref[sec:uc-2d-3]{UC-2D.3} & Obbligatorio \\
    \hline
    RF-097 & Un utente deve avere la possibilità di visualizzare il reparto di un destinatario & \hyperref[sec:uc-2d-4]{UC-2D.4} & Obbligatorio \\
    \hline
    RF-098 & Un utente deve avere la possibilità di visualizzare il nome di un destinatario & \hyperref[sec:uc-2d-5]{UC-2D.5} & Obbligatorio \\
    \hline
    RF-099 & Deve esserci un controllo per "Nessun destinatario riconosciuto" & \hyperref[sec:uc-2b-6]{UC-2B.6} & Obbligatorio \\
    \hline
    RF-100 & Un utente deve avere la possibilità di visualizzare il codice fiscale di un destinatario & \hyperref[sec:uc-2d-2]{UC-2D.2} & Obbligatorio \\
    \hline


    RF-101 & Un utente deve avere la possibilità di visualizzare la lista storico documenti & \hyperref[sec:uc-2e]{UC-2E} & Obbligatorio \\
    \hline
    RF-102 & C'è la possibilitá che non siano mai stati registrati documenti e che quindi l'applicativo agisca di conseguenza & \hyperref[sec:uc-2e-1]{UC-2E.1} & Obbligatorio \\
    \hline
    RF-103 & Un utente deve avere la possibilità di visualizzare un elemento dalla lista storico documenti & \hyperref[sec:uc-2e-2]{UC-2E.2} & Obbligatorio \\
    \hline
    RF-104 & Un utente deve avere la possibilità di visualizzare la percentuale di confidenza di un elemento & \hyperref[sec:uc-2e-3]{UC-2E.3} & Obbligatorio \\
    \hline
    RF-105 & Un utente deve avere la possibilità di visualizzare la lista di appartenenza di un elemento & \hyperref[sec:uc-2e-4]{UC-2E.4} & Obbligatorio \\
    \hline
    RF-106 & Un utente deve avere la possibilità di visualizzare lo stato da un elemento& \hyperref[sec:uc-2e-5]{UC-2E.5} & Obbligatorio \\
    \hline

    RF-107 & Un utente deve avere la possibilità di creare un messaggio da inviare con i documenti & \hyperref[sec:uc-2f]{UC-2F} & Obbligatorio \\
    \hline
    RF-108 & Un utente deve avere la possibilità di salvare il template di un messaaggio in uno storico per poterlo riutilizzare in futuro & \hyperref[sec:uc-2f-1]{UC-2F.1} & Obbligatorio \\
    \hline
    RF-109 & Un utente deve avere la possibilità di modificare l'oggetto di un messaggio & \hyperref[sec:uc-2f-2]{UC-2F.2} & Obbligatorio \\
    \hline
    RF-110 & Un utente deve avere la possibilità di modificare il testo di messaggio & \hyperref[sec:uc-2f-3]{UC-2F.3} & Obbligatorio \\
    \hline
    RF-111 & Un utente deve avere la possibilità di confermare le modifiche apportate ad un messaggio & \hyperref[sec:uc-2f-4]{UC-2F.4} & Obbligatorio \\
    \hline
    RF-112 & Un utente deve avere la possibilità di annullare le modifiche apportate ad un messaggio & \hyperref[sec:uc-2f-5]{UC-2F.5} & Obbligatorio \\
    \hline
    RF-113 & Un utente deve avere la possibilità di visualizzare l'oggetto di un messaggio & \hyperref[sec:uc-2f-6]{UC-2F.6} & Obbligatorio \\
    \hline
    RF-114 & Un utente deve avere la possibilità di visualizzare il testo di messaggio & \hyperref[sec:uc-2f-7]{UC-2F.7} & Obbligatorio \\
    \hline

    RF-115 & Un utente deve avere la possibilità di accedere alla pagina dei template salvati & \hyperref[sec:uc-2g]{UC-2G} & Obbligatorio \\
    \hline
    RF-116 & Un utente deve avere la possibilità di eliminare template dalla tabella dei template salvati& \hyperref[sec:uc-2g-1]{UC-2G.1} & Obbligatorio \\
    \hline
    RF-117 & Il sistema non deve mostrare niente se nessun template è stato salvato all'interno dello storico & \hyperref[sec:uc-2g-2]{UC-2G.2} & Obbligatorio \\
    \hline
    RF-118 & Un utente deve avere la possibilità di caricare un template per riutilizzarlo & \hyperref[sec:uc-2g-3]{UC-2G.3} & Obbligatorio \\
    \hline
    RF-119 & Un utente deve avere la possibilità di visualizzare la lista dei template salvati & \hyperref[sec:uc-2g-4]{UC-2G.4} & Obbligatorio \\
    \hline
    RF-120 & Un utente deve avere la possibilità di visualizzare un elemento dall lista template salvati & \hyperref[sec:uc-2g-5]{UC-2G.5} & Obbligatorio \\
    \hline

    RF-121 & Un utente deve avere la possibilità di inviare un documento con il relativo messaggio & \hyperref[sec:uc-2h]{UC-2H} & Obbligatorio \\
    \hline
    RF-122 & Un utente deve avere la possibilità di visualizzare allegare un file con il documento che sta inviando & \hyperref[sec:uc-2h-1]{UC-2H.1} & Obbligatorio \\
    \hline
    RF-123 & Un utente deve avere la possibilità di pianificare l'invio di un documento & \hyperref[sec:uc-2h-2]{UC-2H.2} & Obbligatorio \\
    \hline

    RF-124 & Un utente deve avere la possibilità di filtrare la lista dei documenti & \hyperref[sec:uc-2i]{UC-2I} & Obbligatorio \\
    \hline
    RF-125 & Un utente deve avere la possibilità di visualizzare la lista filtrata delle informazioni dei documenti partizionati dall'AI in seguito all'upload & \hyperref[sec:uc-2i-1]{UC-2I.1} & Obbligatorio \\
    \hline

    RF-126 & Un utente deve avere la possibilità di filtrare la lista dei destinatari & \hyperref[sec:uc-2j]{UC-2J} & Obbligatorio \\
    \hline
    RF-127 & Un utente deve avere la possibilità di visualizzare la lista filtrata dei destinatari & \hyperref[sec:uc-2j-1]{UC-2J.1} & Obbligatorio \\
    \hline

    RF-128 & Un utente deve avere la possibilitá di filtrare i documenti nello storico per favorire la ricerca & \hyperref[sec:uc-2k]{UC-2K} & Obbligatorio \\
    \hline
    RF-129 & Un utente deve avere la possibilità di visualizzare la lista filtrata storico documenti & \hyperref[sec:uc-2k-1]{UC-2K.1} & Obbligatorio \\
    \hline



    RF-130 & Un utente deve avere la possibilità di accedere alla Dashboard\textsubscript{\scalebox{0.6}{\textbf{G}}} di analisi e Monitoraggio AI & \hyperref[sec:uc-3a]{UC-3A} & Obbligatorio \\
    \hline
    RF-131 & Un utente deve avere la possibilità di visualizzare l'elenco dati AI Assistant\textsubscript{\scalebox{0.6}{\textbf{G}}} & \hyperref[sec:uc-3a-1]{UC-3A.1} & Obbligatorio \\
    \hline
    RF-132 & Un utente deve avere la possibilità di visualizzare il numero di prompt\textsubscript{\scalebox{0.6}{\textbf{G}}} generati & \hyperref[sec:uc-3a-2]{UC-3A.2} & Obbligatorio \\
    \hline
    RF-133 & Un utente deve avere la possibilità di visualizzare il rating medio prompt\textsubscript{\scalebox{0.6}{\textbf{G}}} generati & \hyperref[sec:uc-3a-3]{UC-3A.3} & Obbligatorio \\
    \hline
    RF-134 & Un utente deve avere la possibilità di visualizzare il numero rigenerazioni prompt\textsubscript{\scalebox{0.6}{\textbf{G}}} & \hyperref[sec:uc-3a-4]{UC-3A.4} & Obbligatorio \\
    \hline
    RF-135 & Un utente deve avere la possibilità di visualizzare i toni più usati & \hyperref[sec:uc-3a-5]{UC-3A.5} & Obbligatorio \\
    \hline
    RF-136 & Un utente deve avere la possibilità di visualizzare gli stili più usati & \hyperref[sec:uc-3a-6]{UC-3A.6} & Obbligatorio \\
    \hline
    RF-137 & Un utente deve avere la possibilità di visualizzare l'elenco dati AI Co-Pilot\textsubscript{\scalebox{0.6}{\textbf{G}}} & \hyperref[sec:uc-3a-7]{UC-3A.7} & Obbligatorio \\
    \hline
    RF-138 & Un utente deve avere la possibilità di visualizzare la confidenza media & \hyperref[sec:uc-3a-8]{UC-3A.8} & Obbligatorio \\
    \hline
    RF-139 & Un utente deve avere la possibilità di visualizzare la percentuale interventi manuali & \hyperref[sec:uc-3a-9]{UC-3A.9} & Obbligatorio \\
    \hline
    RF-140 & Un utente deve avere la possibilità di visualizzare l'accuratezza mapping & \hyperref[sec:uc-3a-10]{UC-3A.10} & Obbligatorio \\
    \hline
    RF-141 & Un utente deve avere la possibilità di visualizzare i tempi medi analisi & \hyperref[sec:uc-3a-11]{UC-3A.11} & Obbligatorio \\
    \hline
    RF-142 & Un utente deve avere la possibilità di visualizzare inserire la data d'inizio delle statistiche & \hyperref[sec:uc-3a-12]{UC-3A.12} & Obbligatorio \\
    \hline
    RF-143 & Un utente deve avere la possibilità di visualizzare inserire la data di fine delle statistiche & \hyperref[sec:uc-3a-13]{UC-3A.13} & Obbligatorio \\
    \hline
