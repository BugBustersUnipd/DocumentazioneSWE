...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item L'Amministratore\textsubscript{\scalebox{0.6}{\textbf{G}}} vede gli utenti registrati con i rispettivi ruoli e ha la possibilitá di modificarli
\end{itemize}
...
\begin{enumerate}
    ...
    \item L'Amministratore\textsubscript{\scalebox{0.6}{\textbf{G}}} é soddisfatto della situazione attuale e non apporta modifiche.
\end{enumerate}

\textbf{Scenario secondario\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item Un utente non autorizzato tenta di accedere al Modulo\textsubscript{\scalebox{0.6}{\textbf{G}}} di gestione ruoli.
    \item Un utente Amministratore\textsubscript{\scalebox{0.6}{\textbf{G}}} non é soddisfatto dei ruoli attuali e decide di modificarli.
\end{enumerate}
...
\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'Amministratore\textsubscript{\scalebox{0.6}{\textbf{G}}} interagisce con il campo relativo al ruolo (es. tramite menu a tendina) e seleziona una nuova tipologia di permessi
\end{enumerate}
...
\textbf{Pre-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item L'Amministratore\textsubscript{\scalebox{0.6}{\textbf{G}}} ha modificato il ruolo di un utente ma non ha ancora confermato
\end{itemize}
...
\textbf{Scenario principale\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'Amministratore\textsubscript{\scalebox{0.6}{\textbf{G}}} conferma l'operazione di cambio ruolo
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item L'utente ha revisionato il risultato ed é soddisfatto del contenuto finale.
\end{itemize}
...
\begin{enumerate}
    ...
    \item L'utente é soddisfatto del contenuto generato e decide di lasciarlo così com'è.
\end{enumerate}

\textbf{Scenario secondario\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{enumerate}
    \item L'utente non é soddisfatto del contenuto generato e decide di modificarlo.
\end{enumerate}
...
\textbf{Pre-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Ci si trova in una delle pagine precedenti 
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item L'utente è soddisfatto delle informazioni del documento e può tornare alla pagina precedente.
\end{itemize}
...
\begin{enumerate}
    ...
    \item L'utente é soddisfatto con il messaggio generato da inviare assieme ai documenti.
\end{enumerate}
...
\endlastfoot
    ...
    \hline
    RF-037 & Un utente con titolo di admin deve poter salvare le modifiche al ruolo di un utente registrato & \hyperref[sec:uc-0e-9]{UC-0E.9} & Opzionale \\
    \hline
