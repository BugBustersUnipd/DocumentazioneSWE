...
\hline
\autoRF & Il sistema deve permettere all'Amministratore di modificare il ruolo di un utente registrato. & \hyperref[UC-0F]{UC-0F}, \hyperref[UC-0F.1]{UC-0F.1} , \href{\urlcap}{Progetto C5} & Opzionale \\
\hline
...
\hline
\autoRF & Il sistema deve generare contenuti testuali tramite AI Assistant in base a prompt e parametri. & \hyperref[UC-1A]{UC-1A} , \href{\urlcap}{Progetto C5} & Obbligatorio \\
\hline
...
\hline
\autoRF & Il sistema deve permettere la visualizzazione dello storico delle generazioni AI. & \hyperref[UC-1B]{UC-1B} , \href{\urlcap}{Progetto C5} & Obbligatorio \\
\hline
...
\hline
\autoRF & Il sistema deve permettere di modificare l'immagine associata al contenuto generato. & \hyperref[UC-1D]{UC-1D} , \href{\urlcap}{Progetto C5} & Obbligatorio \\
\hline
...
\hline
\autoRF & Il sistema deve permettere di modificare il titolo del contenuto generato. & \hyperref[UC-1E]{UC-1E} , \href{\urlcap}{Progetto C5} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere di modificare il testo del corpo del contenuto generato. & \hyperref[UC-1F]{UC-1F} , \href{\urlcap}{Progetto C5} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere di annullare le modifiche apportate al contenuto generato. & \hyperref[UC-1G]{UC-1G} , \href{\urlcap}{Progetto C5} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere di riutilizzare i parametri di un contenuto dello storico per una nuova generazione. & \hyperref[UC-1H]{UC-1H} , \href{\urlcap}{Progetto C5} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere di duplicare un contenuto dallo storico per modificarne i parametri. & \hyperref[UC-1I]{UC-1I} , \href{\urlcap}{Progetto C5} & Obbligatorio \\
\hline
...
\hline
\autoRF & Il sistema deve permettere all'utente di valutare (rating) il contenuto generato. & \hyperref[UC-1M]{UC-1M} , \href{\urlcap}{Progetto C5} & Obbligatorio \\
\hline
...
\hline
\autoRF & Il sistema deve permettere di salvare il contenuto generato nel database. & \hyperref[UC-1O]{UC-1O} , \href{\urlcap}{Progetto C5} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere all'utente l'inserimento di un nuovo tono per la generazione di contenuti & \hyperref[UC-1P]{UC-1P} , \href{\urlcap}{Progetto C5} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere all'utente l'eliminazione di un tono per la generazione di contenuti & \hyperref[UC-1Q]{UC-1Q} , \href{\urlcap}{Progetto C5} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere all'utente l'inserimento di un nuovo stile per la generazione di contenuti & \hyperref[UC-1R]{UC-1R} , \href{\urlcap}{Progetto C5} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere all'utente l'eliminazione di uno stile per la generazione di contenuti & \hyperref[UC-1S]{UC-1S} , \href{\urlcap}{Progetto C5} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere l'analisi di documenti tramite il modulo AI Co-Pilot. & \hyperref[UC-2A]{UC-2A} , \href{\urlcap}{Progetto C5} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere l'inserimento/selezione della categoria del documento. & \hyperref[UC-2A.1]{UC-2A.1} , \href{\urlcap}{Progetto C5} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere l'inserimento del mese/anno di competenza del documento. & \hyperref[UC-2A.2]{UC-2A.2} , \href{\urlcap}{Progetto C5} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere l'inserimento dell'azienda associata al documento. & \hyperref[UC-2A.3]{UC-2A.3} , \href{\urlcap}{Progetto C5} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere l'inserimento del reparto associato al documento. & \hyperref[UC-2A.4]{UC-2A.4} , \href{\urlcap}{Progetto C5} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere controllare la correttezza del formato del file inserito. & \href{\urlcap}{Progetto C5} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere controllare che lo stesso file non sia già stato analizzato. & \href{\urlcap}{Progetto C5} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere lo split di documenti diversi all'interno dello stesso file. & \href{\urlcap}{Progetto C5} & Obbligatorio \\
\hline
\autoRF & Il sistema deve visualizzare la lista dei documenti analizzati. & \hyperref[UC-2B]{UC-2B}, \href{\urlcap}{Progetto C5} & Obbligatorio \\
\hline
...
\hline
\autoRF & Il sistema deve mostrare l'anteprima visiva del documento analizzato. & \hyperref[UC-2C]{UC-2C} , \href{\urlcap}{Progetto C5} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere di modificare il destinatario associato al documento. & \hyperref[UC-2D]{UC-2D}, \href{\urlcap}{Progetto C5}  & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere di modificare la tipologia del documento. & \hyperref[UC-2E]{UC-2E} , \href{\urlcap}{Progetto C5} & Obbligatorio \\
\hline
\autoRF & Il sistema deve ricalcolare la percentuale di confidenza dopo modifiche manuali. & \hyperref[UC-2F]{UC-2F} , \href{\urlcap}{Progetto C5} & Obbligatorio \\
\hline
\autoRF & Il sistema deve visualizzare la lista delle informazioni sui destinatari estratti. & \hyperref[UC-2G]{UC-2G} , \href{\urlcap}{Progetto C5} & Obbligatorio \\
\hline
...
\hline
\autoRF & Il sistema deve visualizzare lo storico completo dei documenti processati. & \hyperref[UC-2H]{UC-2H} , \href{\urlcap}{Progetto C5} & Obbligatorio \\
\hline
...
\hline
\autoRF & Il sistema deve permettere di caricare un template di messaggio esistente. & \hyperref[UC-2I]{UC-2I} , \href{\urlcap}{Progetto C5} & Obbligatorio \\
\hline
...
\hline
\autoRF & Il sistema deve permettere l'invio del documento e del messaggio associato. & \hyperref[UC-2O]{UC-2O} , \href{\urlcap}{Progetto C5} & Facoltativo \\
\hline
\autoRF &  Il sistema deve permettere di allegare ulteriore contenuto al messaggio. & \hyperref[UC-2O.1]{UC-2O.1} , \href{\urlcap}{Progetto C5} & Facoltativo \\
\hline
\autoRF & Il sistema deve permettere di pianificare l'invio del documento e del messaggio associato. & \hyperref[UC-2O.2]{UC-2O.2} , \href{\urlcap}{Progetto C5} & Facoltativo \\
\hline
...
\hline
\autoRF & Il sistema deve permettere di mostrare l'audit di un documento nello storico. & \hyperref[UC-2V]{UC-2V} , \href{\urlcap}{Progetto C5}  & Obbligatorio \\
\hline
\autoRF & Il sistema deve visualizzare la dashboard con i dati di analytics per l'AI Assistant. & \hyperref[UC-3A]{UC-3A} , \href{\urlcap}{Progetto C5} & Obbligatorio \\
\hline
...
\hline
\autoRF & Il sistema deve visualizzare la dashboard con i dati di analytics per l'AI Co-Pilot. & \hyperref[UC-3B]{UC-3B} , \href{\urlcap}{Progetto C5} & Obbligatorio \\
\hline
