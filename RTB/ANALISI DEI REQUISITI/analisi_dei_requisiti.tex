...
\hline
\endhead
\rowcolor{secondaryblue!10} 0.2.5 & 20/01/2026 & Correzione errori & Alberto Pignat &  & - \\
\hline
...
\begin{itemize}
    ...
    Dashboard\textsubscript{\scalebox{0.6}{\textbf{G}}} di monitoraggio delle performance dei moduli AI per consentire valutazioni semplici su efficacia\textsubscript{\scalebox{0.6}{\textbf{G}}} ed efficienza\textsubscript{\scalebox{0.6}{\textbf{G}}} dei moduli. L'applicazione consentirà inoltre
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Le modifiche precedenti vengono annullate e il contenuto torna alla versione originale generata dall'AI
\end{itemize}
...
\hline
\autoRF & Il sistema deve permettere all'Amministratore di modificare il ruolo di un utente registrato. & \hyperref[UC-0F]{UC-0F}, \hyperref[UC-0F.1]{UC-0F.1} , \href{\urlcap}{capitolato} & Opzionale \\
\hline
...
\hline
\autoRF & Il sistema deve generare contenuti testuali tramite AI Assistant in base a prompt e parametri. & \hyperref[UC-1A]{UC-1A} , \href{\urlcap}{capitolato} & Obbligatorio \\
\hline
...
\hline
\autoRF & Il sistema deve permettere la visualizzazione dello storico delle generazioni AI. & \hyperref[UC-1B]{UC-1B} , \href{\urlcap}{capitolato} & Obbligatorio \\
\hline
...
\hline
\autoRF & Il sistema deve mostrare un'anteprima del contenuto generato dall'AI. & \hyperref[UC-1C]{UC-1C}, \hyperref[UC-1C.1]{UC-1C.1}, \hyperref[UC-1C.2]{UC-1C.2}, \hyperref[UC-1C.3]{UC-1C.3} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere di modificare l'immagine associata al contenuto generato. & \hyperref[UC-1D]{UC-1D} , \href{\urlcap}{capitolato} & Obbligatorio \\
\hline
...
\hline
\autoRF & Il sistema deve permettere di modificare il titolo del contenuto generato. & \hyperref[UC-1E]{UC-1E} , \href{\urlcap}{capitolato} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere di modificare il testo del corpo del contenuto generato. & \hyperref[UC-1F]{UC-1F} , \href{\urlcap}{capitolato} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere di annullare le modifiche apportate al contenuto generato. & \hyperref[UC-1G]{UC-1G} , \href{\urlcap}{capitolato} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere di riutilizzare i parametri di un contenuto dello storico per una nuova generazione. & \hyperref[UC-1H]{UC-1H} , \href{\urlcap}{capitolato} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere di duplicare un contenuto dallo storico per modificarne i parametri. & \hyperref[UC-1I]{UC-1I} , \href{\urlcap}{capitolato} & Obbligatorio \\
\hline
...
\hline
\autoRF & Il sistema deve permettere all'utente di valutare (rating) il contenuto generato. & \hyperref[UC-1M]{UC-1M} , \href{\urlcap}{capitolato} & Obbligatorio \\
\hline
...
\hline
\autoRF & Il sistema deve permettere di salvare il contenuto generato nel database. & \hyperref[UC-1O]{UC-1O} , \href{\urlcap}{capitolato} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere all'utente l'inserimento di un nuovo tono per la generazione di contenuti & \hyperref[UC-1P]{UC-1P} , \href{\urlcap}{capitolato} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere all'utente l'eliminazione di un tono per la generazione di contenuti & \hyperref[UC-1Q]{UC-1Q} , \href{\urlcap}{capitolato} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere all'utente l'inserimento di un nuovo stile per la generazione di contenuti & \hyperref[UC-1R]{UC-1R} , \href{\urlcap}{capitolato} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere all'utente l'eliminazione di uno stile per la generazione di contenuti & \hyperref[UC-1S]{UC-1S} , \href{\urlcap}{capitolato} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere l'analisi di documenti tramite il modulo AI Co-Pilot. & \hyperref[UC-2A]{UC-2A} , \href{\urlcap}{capitolato} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere l'inserimento/selezione della categoria del documento. & \hyperref[UC-2A.1]{UC-2A.1} , \href{\urlcap}{capitolato} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere l'inserimento del mese/anno di competenza del documento. & \hyperref[UC-2A.2]{UC-2A.2} , \href{\urlcap}{capitolato} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere l'inserimento dell'azienda associata al documento. & \hyperref[UC-2A.3]{UC-2A.3} , \href{\urlcap}{capitolato} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere l'inserimento del reparto associato al documento. & \hyperref[UC-2A.4]{UC-2A.4} , \href{\urlcap}{capitolato} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere controllare la correttezza del formato del file inserito. & \href{\urlcap}{capitolato} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere controllare che lo stesso file non sia già stato analizzato. & \href{\urlcap}{capitolato} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere lo split di documenti diversi all'interno dello stesso file. & \href{\urlcap}{capitolato} & Obbligatorio \\
\hline
\autoRF & Il sistema deve visualizzare la lista dei documenti analizzati. & \hyperref[UC-2B]{UC-2B}, \href{\urlcap}{capitolato} & Obbligatorio \\
\hline
...
\hline
\autoRF & Il sistema deve mostrare l'anteprima visiva del documento analizzato. & \hyperref[UC-2C]{UC-2C} , \href{\urlcap}{capitolato} & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere di modificare il destinatario associato al documento. & \hyperref[UC-2D]{UC-2D}, \href{\urlcap}{capitolato}  & Obbligatorio \\
\hline
\autoRF & Il sistema deve permettere di modificare la tipologia del documento. & \hyperref[UC-2E]{UC-2E} , \href{\urlcap}{capitolato} & Obbligatorio \\
\hline
\autoRF & Il sistema deve ricalcolare la percentuale di confidenza dopo modifiche manuali. & \hyperref[UC-2F]{UC-2F} , \href{\urlcap}{capitolato} & Obbligatorio \\
\hline
\autoRF & Il sistema deve visualizzare la lista delle informazioni sui destinatari estratti. & \hyperref[UC-2G]{UC-2G} , \href{\urlcap}{capitolato} & Obbligatorio \\
\hline
...
\hline
\autoRF & Il sistema deve visualizzare lo storico completo dei documenti processati. & \hyperref[UC-2H]{UC-2H} , \href{\urlcap}{capitolato} & Obbligatorio \\
\hline
...
\hline
\autoRF & Il sistema deve permettere di caricare un template di messaggio esistente. & \hyperref[UC-2I]{UC-2I} , \href{\urlcap}{capitolato} & Obbligatorio \\
\hline
...
\hline
\autoRF & Il sistema deve permettere l'invio del documento e del messaggio associato. & \hyperref[UC-2O]{UC-2O} , \href{\urlcap}{capitolato} & Facoltativo \\
\hline
\autoRF &  Il sistema deve permettere di allegare ulteriore contenuto al messaggio. & \hyperref[UC-2O.1]{UC-2O.1} , \href{\urlcap}{capitolato} & Facoltativo \\
\hline
\autoRF & Il sistema deve permettere di pianificare l'invio del documento e del messaggio associato. & \hyperref[UC-2O.2]{UC-2O.2} , \href{\urlcap}{capitolato} & Facoltativo \\
\hline
...
\hline
\autoRF & Il sistema deve permettere di mostrare l'audit di un documento nello storico. & \hyperref[UC-2V]{UC-2V} , \href{\urlcap}{capitolato}  & Obbligatorio \\
\hline
\autoRF & Il sistema deve visualizzare la dashboard con i dati di analytics per l'AI Assistant. & \hyperref[UC-3A]{UC-3A} , \href{\urlcap}{capitolato} & Obbligatorio \\
\hline
...
\hline
\autoRF & Il sistema deve visualizzare la dashboard con i dati di analytics per l'AI Co-Pilot. & \hyperref[UC-3B]{UC-3B} , \href{\urlcap}{capitolato} & Obbligatorio \\
\hline
...
\endlastfoot
    ...
    RQ-01 & Presentare documento analisi dei Requisiti\textsubscript{\scalebox{0.6}{\textbf{G}}} contenente diagrammi e descrizioni Use Case & \href{\urlcap}{capitolato} & Obbligatorio \\
    \hline
    ...
    \hline
    RQ-03 & Il Prodotto deve passare tutti i test\textsubscript{\scalebox{0.6}{\textbf{G}}} con la copertura concordata con la proponente\textsubscript{\scalebox{0.6}{\textbf{G}}} & \href{\urlcap}{capitolato}, Piano di Qualifica\textsubscript{\scalebox{0.6}{\textbf{G}}} & Obbligatorio \\
    \hline
    RQ-04 & Il codice deve essere documentato secondo le linee guida descritte in Norme di Progetto\textsubscript{\scalebox{0.6}{\textbf{G}}} & \href{\urlcap}{capitolato}, Interna & Obbligatorio \\
    \hline
    RQ-05 & È necessario versionare il codice con appositi strumenti di controllo versione, compreso di istruzioni di setup & \href{\urlcap}{capitolato} & Obbligatorio \\
    \hline
    RQ-06 & Report finale di integrazione e suggerimenti di evoluzione & \href{\urlcap}{capitolato} & Obbligatorio \\
    \hline
...
\endlastfoot
    ...
    RV-01 & Git come sistema di controllo versione & \href{\urlcap}{capitolato} & Obbligatorio \\
    \hline
    RV-02 & API \& Backend devono essere sviluppati in Ruby on Rails\textsubscript{\scalebox{0.6}{\textbf{G}}} & \href{\urlcap}{capitolato} & Obbligatorio \\
    \hline
    RV-03 & Il database deve essere PostgreSQL\textsubscript{\scalebox{0.6}{\textbf{G}}} & \href{\urlcap}{capitolato} & Obbligatorio \\
    \hline
    RV-04 & Il frontend deve essere sviluppato in Angular\textsubscript{\scalebox{0.6}{\textbf{G}}} & \href{\urlcap}{capitolato} & Obbligatorio \\
    \hline
    RV-05 & La gestione dei modelli AI deve essere implementata utilizzando AWS Bedrock\textsubscript{\scalebox{0.6}{\textbf{G}}} & \href{\urlcap}{capitolato} & Obbligatorio \\
    \hline
    RV-06 & Eventuali background jobs gestiti con Sidekiq e PWA con Next.js & \href{\urlcap}{capitolato}, trattativa con la proponente\textsubscript{\scalebox{0.6}{\textbf{G}}} & Opzionale \\
    \hline
