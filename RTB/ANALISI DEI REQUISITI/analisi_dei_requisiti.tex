...
\begin{itemize}
    \item \textit{include}: 
    \begin{itemize}
        \item UC-0E.8 - Visualizzazione lista utenti registrati.
...
\subsubsection{UC-0E.1 – Visualizzazione nome utente registrato}
...
\subsubsection{UC-0E.2 – Visualizzazione cognome utente registrato}
...
\subsubsection{UC-0E.8 – Visualizzazione lista utenti registrati}
...
\begin{itemize}
    \item \textit{include}: 
    \begin{itemize}
        \item UC-0E.9 - Visualizzazione elemento lista utenti registrati.
    \end{itemize}
    \item \textit{extend}: 
    \begin{itemize}
        \item nessuna
...
\subsubsection{UC-0E.9 – Visualizzazione elemento lista utenti registrati}
...
\begin{itemize}
    \item \textit{include}: 
    \begin{itemize}
        \item UC-0E.1 - Visualizzazione nome utente registrato.
        \item UC-0E.2 - Visualizzazione cognome utente registrato.
...
\begin{itemize}
    \item \textit{include}: 
    \begin{itemize}
        \item UC-1B.12 – Visualizzazione lista elementi storico
    \end{itemize}
    \item \textit{extend}: 
    \begin{itemize}
...
\subsubsection{UC-1B.12 – Visualizzazione lista elementi storico}
...
\begin{itemize}
    \item \textit{include}: 
    \begin{itemize}
        \item UC-2B.12 – Visualizzazione lista documenti
    \end{itemize}
    \item \textit{extend}: 
    \begin{itemize}
...
\subsubsection{UC-2B.12 – Visualizzazione lista documenti}
...
\begin{itemize}
    \item \textit{include}: 
    \begin{itemize}
        \item UC-2B.13 – Visualizzazione elemento da lista documenti
    \end{itemize}
\end{itemize}

\vspace{0.5cm}

\subsubsection{UC-2B.13 – Visualizzazione elemento da lista documenti.}
...
\begin{itemize}
    \item \textit{include}: 
    \begin{itemize}
        \item UC-2D.5 – Visualizzazione lista informazioni destinatari
    \end{itemize}
    \item \textit{extend}: 
    \begin{itemize}
        \item UC-2B – Apertura modulo informazioni documenti 
...
\subsubsection{UC-2D.5 – Visualizzazione lista informazioni destinatari}
...
\begin{itemize}
    \item \textit{include}: 
    \begin{itemize}
        \item UC-2D.6 – Visualizzazione elemento da lista informazioni destinatari
    \end{itemize}
\end{itemize}

\vspace{0.5cm}

\subsubsection{UC-2D.6 – Visualizzazione elemento da lista informazioni destinatari}
...
\subsubsection{UC-2E.4 – Visualizzazione elemento da lista storico documenti}
...
\subsubsection{UC-2E.8 – Visualizzazione lista storico documenti}
