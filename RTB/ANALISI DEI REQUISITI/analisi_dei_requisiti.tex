...
\subsubsection{UC-0E – Logout / Gestione della sessione}
...
\subsubsection{UC-1C – Salvataggio, pubblicazione o scarto del contenuto}
...
\begin{enumerate}
    ...
    \item Se l’utente sceglie “Salva”, il Sistema memorizza localmente il contenuto.
...
\textbf{Post-condizioni}
\begin{itemize}
    \item Il contenuto risulta salvato, pubblicato o eliminato, a seconda dell’azione scelta dall’utente.
\end{itemize}
...
\subsubsection{UC-1F – Personalizzazione del tono e dello stile}

\textbf{Attori}
\begin{itemize}
    \item Utente autenticato.
    \item Sistema di preferenze utente.
\end{itemize}
...
\textbf{Scenario principale}
\begin{enumerate}
    \item L’utente accede alla sezione “Preferenze AI”.
    \item Il Sistema mostra l’elenco dei toni e degli stili disponibili.
    \item L’utente seleziona un tono/stile predefinito.
    \item Il Sistema salva le preferenze aggiornate.
\end{enumerate}
