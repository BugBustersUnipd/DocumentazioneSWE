...
\newcommand{\CurrentVersion}{0.0.13} % ultima versione, da cambiare ad ogni push significativo
...
\hline
\rowcolor{secondaryblue!10} 0.0.12 & 12/12/2025 & Aggiunta sotto-casi d'uso alla sezione 2 & Leonardo Salviato & - & - \\
\hline
\rowcolor{secondaryblue!10} 0.0.11 & 11/12/2025 & Aggiunto modulo 3 & Marco Piro & - & - \\
\hline
\rowcolor{secondaryblue!10} 0.0.10 & 10/12/2025 & Rinominazione casi d'uso, aggiunta sotto-casi d'uso alle sezioni 0 e 1. & Leonardo Salviato & - & - \\
\hline
...
I moduli saranno quindi concepiti in modo modulare per permettere all'eventuale integrazione futura con NEXUM di inserirsi nell'architettura esistente come componente riutilizzabile e scalabile. L'integrazione includerà l'adattamento delle API, l'allineamento della gestione utenti e la centralizzazione dei dati all'interno dell'infrastruttura NEXUM.

\subsection{Funzioni del prodotto}

Qui di seguito le funzionalità del prodotto, divise per i due moduli principali:
...
l'obiettivo del progetto è quello di progettare moduli intelligenti e interoperabili per essere in un futuro integrati nella piattaforma NEXUM. Tale ecosistema è concepito per rispondere alle esigenze di un ampio spettro di organizzazioni e professionisti nel settore delle risorse umane e della consulenza del lavoro.
