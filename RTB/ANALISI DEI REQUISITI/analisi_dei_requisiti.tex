...
\textbf{\color{white} Versione} & \textbf{\color{white} Data} & \textbf{\color{white} Descrizione} & \textbf{\color{white} Redatto} & \textbf{\color{white} verifica\textsubscript{\scalebox{0.6}{\textbf{G}}}to} & \textbf{\color{white} Approvato} \\
\hline
\endfirsthead

\hline
\rowcolor{primaryblue!40}
\textbf{\color{white} Versione} & \textbf{\color{white} Data} & \textbf{\color{white} Descrizione} & \textbf{\color{white} Redatto} & \textbf{\color{white} Verificato\textsubscript{\scalebox{0.6}{\textbf{G}}}to} & \textbf{\color{white} Approvato} \\
\hline
\endhead
...
\hline
\rowcolor{secondaryblue!10} 0.1.10 & 02/01/2026 & Inserimento diagrammi Casi d'uso\textsubscript{\scalebox{0.6}{\textbf{G}}} sezioni 0 e 1 & Leonardo Salviato & - & - \\
\hline
...
\hline
\rowcolor{secondaryblue!10} 0.1.3 & 13/12/2025 & Aggiunta sotto-Casi d'uso\textsubscript{\scalebox{0.6}{\textbf{G}}} sezione due, riscritta struttura Requisiti e relative tabelle & Leonardo Salviato & - & - \\
\hline
...
\hline
\rowcolor{secondaryblue!10} 0.0.9 & 06/12/2025 & Aggiunti a ogni sezione scenari secondari, relativi Casi d'uso\textsubscript{\scalebox{0.6}{\textbf{G}}} (eccezioni e varianti) e trigger. & Leonardo Salviato & - & - \\
\hline
...
\hline
\rowcolor{secondaryblue!10} 0.0.7 & 04/12/2025 & Riscrittura Casi d'uso\textsubscript{\scalebox{0.6}{\textbf{G}}} con aggiornato grado di precisione (sezioni 0 e 1). & Leonardo Salviato & - & - \\
\hline
...
\hline
\rowcolor{secondaryblue!10} 0.0.2 & 25/11/2025 & Riscrittura della prima stesura e modifica Casi d'uso\textsubscript{\scalebox{0.6}{\textbf{G}}}. & Leonardo Salviato & - & - \\
\hline
...
\subsubsection{UC-0C – Apertura Dashboard\textsubscript{\scalebox{0.6}{\textbf{G}}}}\label{sec:uc-0c}
...
\subsubsection{UC-0E – Revisione ruoli}\label{sec:uc-0e}
...
\subsubsection{UC-0E.9 – Errore modifica ruolo utente registrato}\label{sec:uc-0e-9}
...
\begin{itemize}
    \item L'Amministratore\textsubscript{\scalebox{0.6}{\textbf{G}}} sta modificando il ruolo di un utente
    \item L'Amministratore\textsubscript{\scalebox{0.6}{\textbf{G}}} ha effettuato un'operazione non valida
\end{itemize}
...
\subsubsection{UC-1A.1 – Inserimento prompt\textsubscript{\scalebox{0.6}{\textbf{G}}}}\label{sec:uc-1a-1}
...
\subsubsection{UC-1B.1– Nessun prompt\textsubscript{\scalebox{0.6}{\textbf{G}}} salvato}\label{sec:uc-1b-1}
...
\subsubsection{UC-1B.7 – Visualizzazione prompt\textsubscript{\scalebox{0.6}{\textbf{G}}}}\label{sec:uc-1b-7}
...
\subsubsection{UC-1D – Revisione contenuto generato}\label{sec:uc-1d}
...
\subsubsection{UC-1K – Salva contenuto generato}\label{sec:uc-1k}
...
\textbf{Attori\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Operatore CdL\textsubscript{\scalebox{0.6}{\textbf{G}}}\textsubscript{\scalebox{0.6}{\textbf{G}}}
\end{itemize}
...
\begin{itemize}
    ...
    \item L'utente visualizza l'interfaccia\textsubscript{\scalebox{0.6}{\textbf{G}}} di upload documenti, pronta per il caricamento e la gestione dei file.
\end{itemize}
...
\begin{enumerate}
    ...
    \item Il sistema verifica\textsubscript{\scalebox{0.6}{\textbf{G}}} che il file rispetti i Requisiti di formato (es. PDF, Excel) e dimensione massima
    \item Se la verifica\textsubscript{\scalebox{0.6}{\textbf{G}}} è positiva, il file viene mostrato in lista d'attesa
\end{enumerate}
...
\subsubsection{UC-2C – Revisione documento}\label{sec:uc-2c}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Diagrammi casi d'uso/UC2Ca.jpg}
    \caption{Diagramma del caso d'uso UC-2C – Revisione documento (include)}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Diagrammi casi d'uso/UC2Cb.jpg}
    \caption{Diagramma del caso d'uso UC-2C – Revisione documento (extend)}
\end{figure}
...
\subsubsection{UC-2E.2 – Visualizzazione elemento da lista storico documenti}\label{sec:uc-2e-4}
...
\subsubsection{UC-2E.4 – Visualizzazione appartenenza lista distribuzione}\label{sec:uc-2e-2}
...
\subsubsection{UC-2F – Creazione messaggio}\label{sec:uc-2f}
...
\subsubsection{UC-2F.5 – Uscita senza salvare modifica messaggio}\label{sec:uc-2f-5}
...
\textbf{Post-condizioni\textsubscript{\scalebox{0.6}{\textbf{G}}}}
\begin{itemize}
    \item Le modifiche nonvengono salvate in preparazione all'invio.
\end{itemize}
...
\subsubsection{UC-2I – Filtraggio documenti analisi}\label{sec:uc-2i}
...
\subsubsection{UC-2I.1 – Visualizzazione lista documenti filtrata}\label{sec:uc-2i-1}
...
\subsubsection{UC-2J – Filtraggio destinatari analisi}\label{sec:uc-2j}
...
\subsubsection{UC-3A.1 - Visualizzazione elenco dati AI Assistant\textsubscript{\scalebox{0.6}{\textbf{G}}}}\label{sec:uc-3a-1}
...
\subsubsection{UC-3A.2 – Visualizzazione numero prompt\textsubscript{\scalebox{0.6}{\textbf{G}}} generati}\label{sec:uc-3a-2}
...
\subsubsection{UC-3A.3 – Visualizzazione rating medio prompt\textsubscript{\scalebox{0.6}{\textbf{G}}} generati}\label{sec:uc-3a-3}
...
\subsubsection{UC-3A.4 – Visualizzazione numero rigenerazioni prompt\textsubscript{\scalebox{0.6}{\textbf{G}}}}\label{sec:uc-3a-4}
...
\subsubsection{UC-3A.7 - Visualizzazione elenco dati AI Co-Pilot\textsubscript{\scalebox{0.6}{\textbf{G}}}}\label{sec:uc-3a-7}
...
\vspace{0.5cm}
\begin{longtable}{|L{\wCod}|L{\wDesc}|L{\wFonti}|L{\wPrio}|}
\caption{Tabella dei equisiti di qualità}\label{tab:reqqualita}\\
\hline
\textbf{Codice} & \textbf{Descrizione} & \textbf{Fonti} & \textbf{Priorità} \\
\hline
\endfirsthead
