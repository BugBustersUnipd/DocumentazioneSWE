...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item UC-2E.5 - visualizzazione informazioni documento
        \item UC-2C – Apertura documento
        \item UC-2D - Apertura informazioni destinatari
...
\subsubsection{UC-2E.3 – Visualizzazione stato}\label{sec:uc-2e-3}
...
\textbf{Pre-condizioni}
\begin{itemize}
    \item L'utente sta visualizzando la lista o il dettaglio dei documenti (tramite UC-2E o UC-2E.5).
\end{itemize}
...
\subsubsection{UC-2E.4 – Visualizzazione lista storico documenti}\label{sec:uc-2e-4}
...
\begin{itemize}
    \item \textit{include}: 
    \begin{itemize}
        \item UC-2E.5 – Visualizzazione elemento da lista storico documenti
    \end{itemize}
\end{itemize}

\vspace{0.5cm}

\subsubsection{UC-2E.5 – Visualizzazione elemento da lista storico documenti}\label{sec:uc-2e-5}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item UC-2B.10 – Visualizzazione codice documento
        \item UC-2E.3 - Visualizzazione stato
...
\endlastfoot
    ...
    \hline
    RF-107 & Apertura storico documenti & \hyperref[sec:uc-2e]{UC-2E} & Obbligatorio \\
    \hline
    RF-108 & Selezione documento & \hyperref[sec:uc-2e-1]{UC-2E.1} & Obbligatorio \\
    \hline
    RF-109 & Documenti assenti & \hyperref[sec:uc-2e-2]{UC-2E.2} & Obbligatorio \\
    \hline
    RF-110 & Visualizzazione stato & \hyperref[sec:uc-2e-3]{UC-2E.3} & Obbligatorio \\
    \hline
    RF-111 & Visualizzazione lista storico documenti & \hyperref[sec:uc-2e-4]{UC-2E.4} & Obbligatorio \\
    \hline
    RF-112 & Visualizzazione elemento da lista storico documenti & \hyperref[sec:uc-2e-5]{UC-2E.5} & Obbligatorio \\
    \hline
    RF-113 & Visualizzazione percentuale confidenza & \hyperref[sec:uc-2e-6]{UC-2E.6} & Obbligatorio \\
    \hline
    RF-114 & Visualizzazione appartenenza lista distribuzione & \hyperref[sec:uc-2e-7]{UC-2E.7} & Obbligatorio \\
    \hline
    RF-115 & Filtraggio documenti & \hyperref[sec:uc-2e-8]{UC-2E.8} & Obbligatorio \\
    \hline
    RF-116 & Visualizzazione lista storico documenti filtrata & \hyperref[sec:uc-2e-9]{UC-2E.9} & Obbligatorio \\
    \hline
    RF-117 & Gestione messaggio & \hyperref[sec:uc-2f]{UC-2F} & Obbligatorio \\
    \hline
    RF-118 & Salva template messaggio & \hyperref[sec:uc-2f-1]{UC-2F.1} & Obbligatorio \\
    \hline
    RF-119 & Modifica oggetto messaggio & \hyperref[sec:uc-2f-2]{UC-2F.2} & Obbligatorio \\
    \hline
    RF-120 & Modifica testo messaggio & \hyperref[sec:uc-2f-3]{UC-2F.3} & Obbligatorio \\
    \hline
    RF-121 & Conferma modifica messaggio & \hyperref[sec:uc-2f-4]{UC-2F.4} & Obbligatorio \\
    \hline
    RF-122 & Genera messaggio & \hyperref[sec:uc-2f-5]{UC-2F.5} & Obbligatorio \\
    \hline
    RF-123 & Visualizzazione oggetto messaggio & \hyperref[sec:uc-2f-6]{UC-2F.6} & Obbligatorio \\
    \hline
    RF-124 & Visualizzazione testo messaggio & \hyperref[sec:uc-2f-7]{UC-2F.7} & Obbligatorio \\
    \hline
    RF-125 & Tabella template salvati & \hyperref[sec:uc-2g]{UC-2G} & Obbligatorio \\
    \hline
    RF-126 & Elimina template & \hyperref[sec:uc-2g-1]{UC-2G.1} & Obbligatorio \\
    \hline
    RF-127 & Nessun template salvato & \hyperref[sec:uc-2g-2]{UC-2G.2} & Obbligatorio \\
    \hline
    RF-128 & Carica template & \hyperref[sec:uc-2g-3]{UC-2G.3} & Obbligatorio \\
    \hline
    RF-129 & Visualizzazione lista template salvati & \hyperref[sec:uc-2g-4]{UC-2G.4} & Obbligatorio \\
    \hline
    RF-130 & Visualizzazione elemento da lista template salvati & \hyperref[sec:uc-2g-5]{UC-2G.5} & Obbligatorio \\
    \hline
    RF-131 & Invio documento e messaggio & \hyperref[sec:uc-2h]{UC-2H} & Obbligatorio \\
    \hline
    RF-132 & Allega file & \hyperref[sec:uc-2h-1]{UC-2H.1} & Obbligatorio \\
    \hline
    RF-133 & Pianifica invio & \hyperref[sec:uc-2h-2]{UC-2H.2} & Obbligatorio \\
    \hline
    RF-134 & Conferma invio & \hyperref[sec:uc-2h-3]{UC-2H.3} & Obbligatorio \\
    \hline
    RF-135 & Apertura dashboard di analisi e Monitoraggio AI & \hyperref[sec:uc-3a]{UC-3A} & Obbligatorio \\
    \hline
    RF-136 & Visualizzazione elenco dati AI assistant & \hyperref[sec:uc-3a-1]{UC-3A.1} & Obbligatorio \\
    \hline
    RF-137 & Visualizzazione numero prompt generati & \hyperref[sec:uc-3a-2]{UC-3A.2} & Obbligatorio \\
    \hline
    RF-138 & Visualizzazione rating medio prompt generati & \hyperref[sec:uc-3a-3]{UC-3A.3} & Obbligatorio \\
    \hline
    RF-139 & Visualizzazione numero rigenerazioni prompt & \hyperref[sec:uc-3a-4]{UC-3A.4} & Obbligatorio \\
    \hline
    RF-140 & Visualizzazione toni più usati & \hyperref[sec:uc-3a-5]{UC-3A.5} & Obbligatorio \\
    \hline
    RF-141 & Visualizzazione stili più usati & \hyperref[sec:uc-3a-6]{UC-3A.6} & Obbligatorio \\
    \hline
    RF-142 & Visualizzazione elenco dati AI Co-pilot & \hyperref[sec:uc-3a-7]{UC-3A.7} & Obbligatorio \\
    \hline
    RF-143 & Visualizzazione confidenza media & \hyperref[sec:uc-3a-8]{UC-3A.8} & Obbligatorio \\
    \hline
    RF-144 & Visualizzazione percentuale interventi manuali & \hyperref[sec:uc-3a-9]{UC-3A.9} & Obbligatorio \\
    \hline
    RF-145 & Visualizzazione accuratezza mapping & \hyperref[sec:uc-3a-10]{UC-3A.10} & Obbligatorio \\
    \hline
    RF-146 & Visualizzazione tempi medi analisi & \hyperref[sec:uc-3a-11]{UC-3A.11} & Obbligatorio \\
    \hline
    RF-147 & Inserimento data inizio & \hyperref[sec:uc-3a-12]{UC-3A.12} & Obbligatorio \\
    \hline
    RF-148 & Inserimento data fine & \hyperref[sec:uc-3a-13]{UC-3A.13} & Obbligatorio \\
    \hline
