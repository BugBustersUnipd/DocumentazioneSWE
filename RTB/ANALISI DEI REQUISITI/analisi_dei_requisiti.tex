...
\hline
\autoRF & Il sistema deve permettere all'Amministratore di modificare il ruolo di un utente registrato. & \hyperref[UC-0F]{UC-0F}, \hyperref[UC-0F.1]{UC-0F.1} & Opzionale \\
\hline
