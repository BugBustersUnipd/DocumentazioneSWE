...
\textbf{Scenario principale}
\begin{enumerate}
    \item Il file immagine caricato dall'utente non é valido
\end{enumerate}
...
\endlastfoot
    ...
    \hline
    RF- & L'utente deve poter inserire & \hyperref[sec:uc-0a-1]{UC-0A.1} & Opzionale \\
    \hline
    ...
    \hline
    RF- & L'utente deve avere la possibilità di salvare le modifiche al profilo utente & \hyperref[sec:uc-0d-7]{UC-0D.7} & Opzionale \\
    \hline
    ...
    \hline
    RF- & L'utente deve avere la possibilità di modificare le informazioni nel proprio profilo utente & \hyperref[sec:uc-0d-9]{UC-0D.9} & Opzionale \\
    \hline
    ...
    \hline
    RF- & Un utente con titolo di admin deve poter annullare la modifica al ruolo utente registrato & \hyperref[sec:uc-0e-6]{UC-0E.8} & Opzionale \\
    \hline
    ...
    \hline
    RF- & Un utente con titolo di admin deve poter modificare il ruolo di utente registrato & \hyperref[sec:uc-0e-8]{UC-0E.6} & Opzionale \\
    \hline
    ...
    \hline
    RF- & C'é la possibilità che il prompt non abbia neanche un elemento data la mancanza di generazioni & \hyperref[sec:uc-1b-1]{UC-1B.1} & Obbligatorio \\
    \hline
    ...
    \hline
    RF- & Un utente deve avere la possibilità di pubblicare un contenuto generato & \hyperref[sec:uc-1k]{UC-1K} & Obbligatorio \\
    \hline
    ...
    \hline
    RF- & Un utente deve avere la possibilità di avviare l'upload del file selezionato con i relativi metadati & \hyperref[sec:uc-2a-6]{UC-2A.6} & Obbligatorio \\
    \hline
    RF- & Un utente deve avere la possibilità di accedere al modulo contenente le informazioni relative ai documenti. & \hyperref[sec:uc-2b]{UC-2B} & Obbligatorio \\
    \hline
    ...
    \hline
    RF- & C'é la possibilitá che non siano mai stati registrati documenti e che quindi l'applicativo agisca di conseguenza & \hyperref[sec:uc-2e-2]{UC-2E.1} & Obbligatorio \\
    \hline
    ...
    \hline
    RF- & Il sistema non deve mostrare niente se nessun template é stato salvato all'interno dello storico & \hyperref[sec:uc-2g-2]{UC-2G.2} & Obbligatorio \\
    \hline
