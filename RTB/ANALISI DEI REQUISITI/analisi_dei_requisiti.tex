...
\endlastfoot
    ...
    \autoRF & Il sistema deve permettere all'utente non registrato di effettuare la registrazione di un nuovo account. & \hyperref[UC-0A]{UC-0A} & Opzionale \\
\hline
...
\hline
\autoRF & Il sistema deve permettere di modificare l'immagine associata al contenuto generato con un file non valido. & \hyperref[UC-1D.1]{UC-1D.1} & Obbligatorio \\
\hline
