...
\subsubsection{UC-0E – Gestione ruoli (Admin / Editor)}\label{sec:uc-0e}
...
\subsubsection{UC-1B – Visualizzazione lista elementi storico}\label{sec:uc-1b-1}
...
\subsubsection{UC-1B.1– Nessun prompt salvato}\label{sec:uc-1b-10}
...
\begin{itemize}
    ...
    \item \textit{extend}: 
    \begin{itemize}
        \item UC-1H – Rigenera contenuto tramite AI 
        \item UC-1I – Valuta contenuto generato
        \item UC-1J – Scarta contenuto generato
        \item UC-1K – Pubblica contenuto generato
        \item UC-1D – Modifica contenuto generato
    \end{itemize}
\end{itemize}
...
\subsubsection{UC-1G – Ricerca prompt}\label{sec:uc-1g}
...
\subsubsection{UC-1H – Rigenera contenuto tramite AI}\label{sec:uc-1c-2}
...
\subsubsection{UC-1I – Valuta contenuto generato}\label{sec:uc-1c-4}
...
\subsubsection{UC-1J – Scarta contenuto generato}\label{sec:uc-1c-5}
...
\subsubsection{UC-1K – Pubblica contenuto generato}\label{sec:uc-1c-6}
...
\subsubsection{UC-2B.1 – Nessun documento riconosciuto}\label{sec:uc-2b-13}
...
\subsubsection{UC-2D – Visualizzazione lista informazioni destinatari analisi}\label{sec:uc-2d-1}
...
\begin{itemize}
    \item \textit{include}: 
    \begin{itemize}
        \item UC-2D.0 – Visualizzazione elemento da lista informazioni destinatari
    \end{itemize}
\end{itemize}

\vspace{0.5cm}

\subsubsection{UC-2D.1 – Visualizzazione elemento da lista informazioni destinatari}\label{sec:uc-2d-2}
...
\subsubsection{UC-2D.2 – Visualizzazione codice fiscale}\label{sec:uc-2d-6}
...
\subsubsection{UC-2E – Visualizzazione lista storico documenti}\label{sec:uc-2e-4}
...
\subsubsection{UC-2E.1 – Documenti assenti}\label{sec:uc-2e-2}
...
\subsubsection{UC-2E.2 – Visualizzazione appartenenza lista distribuzione}\label{sec:uc-2e-7}
...
\subsubsection{UC-2E.3 – Visualizzazione percentuale confidenza}\label{sec:uc-2e-6}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item UC-2G - Gestione template salvati
        \item UC-1A.2 - Selezione tono
        \item UC-1A.3 - Selezione stile
...
\subsubsection{UC-2I – Filtraggio documenti analisi}\label{sec:uc-2b-12}
...
\subsubsection{UC-2I.1 – Visualizzazione lista documenti filtrata}\label{sec:uc-2b-14}
...
\subsubsection{UC-2J – Filtraggio destinatari analisi}\label{sec:uc-2d-7}
...
\subsubsection{UC-2J.1 – Visualizzazione lista destinatari filtrata}\label{sec:uc-2d-8}
...
\subsubsection{UC-2K – Filtraggio documenti storico}\label{sec:uc-2e-8}
...
\subsubsection{UC-2K.1 – Visualizzazione lista storico documenti filtrata}\label{sec:uc-2e-9}
...
\endlastfoot
    ...
    \hline
    RF-051 & Un utente deve avere la possibilità di duplicare una generazione & \hyperref[sec:uc-1f]{UC-1F} & Obbligatorio \\
    \hline
    ...
    \hline
    RF-053 & Un utente deve avere la possibilità di riutilizzare una generazione & \hyperref[sec:uc-1e]{UC-1E} & Obbligatorio \\
    \hline
    RF-054 & Un utente deve avere la possibilità applicare un filtro alla lista dello storico & \hyperref[sec:uc-1g]{UC-1G} & Obbligatorio \\
    \hline
    RF-055 & Un utente deve avere la possibilità di visualizzare la lista dopo aver applicato il filtro & \hyperref[sec:uc-1g-1]{UC-1G.1} & Obbligatorio \\
    \hline
    ...
    \hline
    RF-109 & C'é la possibilitá che non siano mai stati registrati documenti e che quindi l'applicativo agisca di conseguenza & \hyperref[sec:uc-2e-2]{UC-2E.1} & Obbligatorio \\
    \hline
    RF-110 & Un utente deve avere la possibilità di visualizzare la lista storico documenti & \hyperref[sec:uc-2e-4]{UC-2E} & Obbligatorio \\
    \hline
    ...
    \hline
    RF-113 & Un utente deve avere la possibilità di visualizzare la percentuale di confidenza di un elemento & \hyperref[sec:uc-2e-6]{UC-2E.3} & Obbligatorio \\
    \hline
    RF-114 & Un utente deve avere la possibilità di visualizzare la lista di appartenenza di un elemento & \hyperref[sec:uc-2e-7]{UC-2E.2} & Obbligatorio \\
    \hline
    ...
    \hline
    RF-116 & Un utente deve avere la possibilità di visualizzare la lista filtrata storico documenti & \hyperref[sec:uc-2e-9]{UC-2K.1} & Obbligatorio \\
    \hline
