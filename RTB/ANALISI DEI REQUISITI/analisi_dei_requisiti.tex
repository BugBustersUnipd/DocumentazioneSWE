...
\begin{itemize}
    \item \textit{include}: 
    \begin{itemize}
        \item UC-2B.1 – Visualizzazione numero documento
    ...
    \item \textit{extend}: 
    \begin{itemize}
        \item UC-2B.9 - Filtraggio documenti
...
\textbf{Pre-condizioni}
\begin{itemize}
    \item É stato caricato almeno un documento tramite UC-2A.
    \item L’utente é entrato nel modulo AI Co-Pilot per i CdL dalla dashboard principale.
...
\begin{figure}[H]
    \centering
    %\includegraphics[width=1\textwidth]{Diagrammi casi d'uso/UC1.jpg}
    \caption{Diagramma del caso d'uso UC-2B – }
\end{figure}
...
\begin{figure}[H]
    \centering
    %\includegraphics[width=1\textwidth]{Diagrammi casi d'uso/UC1.jpg}
    \caption{Diagramma del caso d'uso UC-2C – Visualizzazione pagina documento}
\end{figure}
...
\begin{figure}[H]
    \centering
    %\includegraphics[width=1\textwidth]{Diagrammi casi d'uso/UC1.jpg}
    \caption{Diagramma del caso d'uso UC-2D - Visualizzazione pagina destinatario }
\end{figure}
