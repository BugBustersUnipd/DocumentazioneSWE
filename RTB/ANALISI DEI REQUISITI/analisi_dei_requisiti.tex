...
\begin{itemize}
    \item \textit{include}: 
    \begin{itemize}
        \item UC-2N.5 – Visualizzazione elemento da lista template salvati
    \end{itemize}
\end{itemize}
...
\endlastfoot
    ...
    % Gruppo UC-0A
    \autoRF & & \hyperref[UC-0A]{UC-0A} & Opzionale \\
    \hline
    \autoRF & & \hyperref[UC-0A.1]{UC-0A.1} & Opzionale \\
    \hline
    \autoRF & & \hyperref[UC-0A.2]{UC-0A.2} & Opzionale \\
    \hline
    \autoRF & & \hyperref[UC-0A.3]{UC-0A.3} & Opzionale \\
    \hline
    \autoRF & & \hyperref[UC-0A.4]{UC-0A.4} & Opzionale \\
    \hline
    \autoRF & & \hyperref[UC-0A.5]{UC-0A.5} & Opzionale \\
    \hline
    \autoRF & & \hyperref[UC-0A.6]{UC-0A.6} & Opzionale \\
    \hline
    \autoRF & & \hyperref[UC-0A.7]{UC-0A.7} & Opzionale \\
    \hline
    \autoRF & & \hyperref[UC-0A.8]{UC-0A.8} & Opzionale \\
    \hline
    \autoRF & & \hyperref[UC-0A.9]{UC-0A.9} & Opzionale \\
    \hline
    \autoRF & & \hyperref[UC-0A.10]{UC-0A.10} & Opzionale \\
    \hline
    \autoRF & & \hyperref[UC-0A.11]{UC-0A.11} & Opzionale \\
    \hline
    \autoRF & & \hyperref[UC-0A.12]{UC-0A.12} & Opzionale \\
    \hline

    % Gruppo UC-0B
    \autoRF & & \hyperref[UC-0B]{UC-0B} & Opzionale \\
    \hline
    \autoRF & & \hyperref[UC-0B.1]{UC-0B.1} & Opzionale \\
    \hline
    \autoRF & & \hyperref[UC-0B.2]{UC-0B.2} & Opzionale \\
    \hline

    % Gruppo UC-0C
    \autoRF & & \hyperref[UC-0C]{UC-0C} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-0C.1]{UC-0C.1} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-0C.2]{UC-0C.2} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-0C.3]{UC-0C.3} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-0C.4]{UC-0C.4} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-0C.5]{UC-0C.5} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-0C.6]{UC-0C.6} & Obbligatorio \\
    \hline

    % Gruppo UC-0D
    \autoRF & & \hyperref[UC-0D]{UC-0D} & Opzionale \\
    \hline
    \autoRF & & \hyperref[UC-0D.1]{UC-0D.1} & Opzionale \\
    \hline

    % Gruppo UC-0E
    \autoRF & & \hyperref[UC-0E]{UC-0E} & Opzionale \\
    \hline
    \autoRF & & \hyperref[UC-0E.1]{UC-0E.1} & Opzionale \\
    \hline
    \autoRF & & \hyperref[UC-0E.2]{UC-0E.2} & Opzionale \\
    \hline
    \autoRF & & \hyperref[UC-0E.3]{UC-0E.3} & Opzionale \\
    \hline
    \autoRF & & \hyperref[UC-0E.4]{UC-0E.4} & Opzionale \\
    \hline

    % Gruppo UC-0F / 0G
    \autoRF & & \hyperref[UC-0F]{UC-0F} & Opzionale \\
    \hline
    \autoRF & & \hyperref[UC-0G]{UC-0G} & Opzionale \\
    \hline

    % Gruppo UC-1A
    \autoRF & & \hyperref[UC-1A]{UC-1A} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-1A.1]{UC-1A.1} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-1A.2]{UC-1A.2} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-1A.3]{UC-1A.3} & Obbligatorio \\
    \hline

    % Gruppo UC-1B
    \autoRF & & \hyperref[UC-1B]{UC-1B} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-1B.1]{UC-1B.1} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-1B.2]{UC-1B.2} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-1B.3]{UC-1B.3} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-1B.4]{UC-1B.4} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-1B.5]{UC-1B.5} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-1B.6]{UC-1B.6} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-1B.7]{UC-1B.7} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-1B.8]{UC-1B.8} & Obbligatorio \\
    \hline

    % Gruppo UC-1C -> 1J
    \autoRF & & \hyperref[UC-1C]{UC-1C} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-1D]{UC-1D} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-1E]{UC-1E} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-1F]{UC-1F} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-1G]{UC-1G} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-1G.1]{UC-1G.1} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-1H]{UC-1H} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-1I]{UC-1I} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-1J]{UC-1J} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-1O]{UC-1O} & Obbligatorio \\
    \hline

    % Gruppo UC-1K -> 1N
    \autoRF & & \hyperref[UC-1K]{UC-1K} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-1L]{UC-1L} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-1M]{UC-1M} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-1N]{UC-1N} & Obbligatorio \\
    \hline

    % Gruppo UC-2A
    \autoRF & & \hyperref[UC-2A]{UC-2A} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2A.1]{UC-2A.1} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2A.2]{UC-2A.2} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2A.3]{UC-2A.3} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2A.4]{UC-2A.4} & Obbligatorio \\
    \hline

    % Gruppo UC-2B
    \autoRF & & \hyperref[UC-2B]{UC-2B} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2B.1]{UC-2B.1} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2B.2]{UC-2B.2} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2B.3]{UC-2B.3} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2B.4]{UC-2B.4} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2B.5]{UC-2B.5} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2B.6]{UC-2B.6} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2B.7]{UC-2B.7} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2B.8]{UC-2B.8} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2B.9]{UC-2B.9} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2B.10]{UC-2B.10} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2B.11]{UC-2B.11} & Obbligatorio \\
    \hline

    % Gruppo UC-2C -> 2E
    \autoRF & & \hyperref[UC-2C]{UC-2C} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2D]{UC-2D} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2E]{UC-2E} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2F]{UC-2F} & Obbligatorio \\
    \hline

    % Gruppo UC-2G
    \autoRF & & \hyperref[UC-2G]{UC-2G} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2G.1]{UC-2G.1} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2G.2]{UC-2G.2} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2G.3]{UC-2G.3} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2G.4]{UC-2G.4} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2G.5]{UC-2G.5} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2G.6]{UC-2G.6} & Obbligatorio \\
    \hline

    % Gruppo UC-2H
    \autoRF & & \hyperref[UC-2H]{UC-2H} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2H.1]{UC-2H.1} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2H.2]{UC-2H.2} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2H.3]{UC-2H.3} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2H.4]{UC-2H.4} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2H.5]{UC-2H.5} & Obbligatorio \\
    \hline

    % Gruppo UC-2I -> 2R
    \autoRF & & \hyperref[UC-2I]{UC-2I} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2J]{UC-2J} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2K]{UC-2K} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2L]{UC-2L} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2M]{UC-2M} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2N]{UC-2N} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2O]{UC-2O} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2P]{UC-2P} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2Q]{UC-2Q} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2R]{UC-2R} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2S]{UC-2S} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2T]{UC-2T} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-2U]{UC-2U} & Obbligatorio \\
    \hline

    % Gruppo UC-3A
    \autoRF & & \hyperref[UC-3A]{UC-3A} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-3A.1]{UC-3A.1} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-3A.2]{UC-3A.2} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-3A.3]{UC-3A.3} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-3A.4]{UC-3A.4} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-3A.5]{UC-3A.5} & Obbligatorio \\
    \hline

    % Gruppo UC-3B
    \autoRF & & \hyperref[UC-3B]{UC-3B} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-3B.1]{UC-3B.1} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-3B.2]{UC-3B.2} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-3B.3]{UC-3B.3} & Obbligatorio \\
    \hline
    \autoRF & & \hyperref[UC-3B.4]{UC-3B.4} & Obbligatorio \\
    \hline

    % Gruppo UC-3C
    \autoRF & & \hyperref[UC-3C]{UC-3C} & Obbligatorio \\
    \hline
