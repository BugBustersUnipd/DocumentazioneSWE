...
\textbf{Trigger}
\begin{itemize}
    \item Click sul tasto per aprire lo storico prompt
\end{itemize}
...
\textbf{Trigger}
\begin{itemize}
    \item L'utente entra nella pagina storico prompt
\end{itemize}
...
\textbf{Trigger}
\begin{itemize}
    \item Apertura del dettaglio elemento (incluso in UC-1B.2)
\end{itemize}
...
\begin{enumerate}
    \item L'utente si trova nel modulo storico dell'AI Co-pilot
    \item L'utente vede l'elenco di tutti gli elementi relativi a tutte el analisi
\end{enumerate}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item UC-2B.10 – Visualizzazione codice documento
        \item UC-2E.8 - Visualizzazione stato
...
\subsubsection{UC-2E.8 – Visualizzazione stato}
...
\subsection{UC-3A - Apertura dashboard di analisi e Monitoraggio AI}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item UC-3A.2 - Visualizzazione statistiche toni utilizzati.
        \item UC-3A.3 - Visualizzazione statistiche stili utilizzati.
        \item UC-3A.4 - Visualizzazione rating medio e feedback.
        \item UC-3A.5 - Visualizzazione confidenza media riconoscimento.
        \item UC-3A.6 - Visualizzazione percentuale interventi manuali.
    \end{itemize}
    \item \textit{extend}: 
    \begin{itemize}
        \item UC-3A.7 - Filtraggio per periodo temporale (L'utente modifica le date).
        \item UC-3A.8 - Filtraggio per utente/operatore (L'utente seleziona uno specifico operatore).
        \item UC-3A.9 - Esportazione Report (PDF/CSV).
        \item UC-3A.10 - Assenza di dati storici.
    \end{itemize}
\end{itemize} 
