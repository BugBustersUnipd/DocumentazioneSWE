...
\hline
\rowcolor{secondaryblue!10} \CurrentVersion & 29/01/2026 & Aggiunti ai termini presenti nel Glossario\G la G & Alberto Autiero & - & - \\
\hline
\hline
...
adattandole alle esigenze specifiche del nostro team e del progetto\G Nexum. In particolare identifica tre tipologie di processi:
\begin{itemize}
...
Il nostro progetto\G mira alla creazione di un'applicazione stand-alone\G (rispetto l'applicazione Nexum già esistente) che implementa un modulo\G di AI\G assistant generativo per la scrittura di comunicazioni e l'AI Co-Pilot\G{} per
...
\begin{enumerate}[label=\textbf{MPD0\arabic*}, leftmargin=4.5em, resume=metriche_processo]
    ...
    \item \textbf{Code Response Time - Ai Co-Pilot\G immagini}.\\
