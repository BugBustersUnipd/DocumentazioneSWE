...
\begin{itemize}
    ...
    \item \textbf{Revisione e approvazione}: sottoporre tutta la documentazione prodotta alla revisione e approvazione della proponente, 
...
\begin{itemize}
    ...
    \item \href{http:\\localhost}{Norme di progetto}
...
L'obiettivo della verifica\G{} è poter rispondere alla domanda <<Did I build the system right?>> gli esiti di tale processo sono riportati nel (Inserire Parte Relativa Nel Piano Di Qualifica). %TODO
...
In ogni caso tutte le informazioni relative alla verifica, verranno riportate nel Piano di Qualifica (Inserire Link Futuro alla sezione del Piano relativa ai test). %TODO
