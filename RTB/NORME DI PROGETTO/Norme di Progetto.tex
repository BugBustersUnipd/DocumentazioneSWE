...
\newcommand{\CurrentVersion}{0.1.6} % ultima versione, da cambiare ad ogni push significativo
...
\hline
\rowcolor{secondaryblue!10} \CurrentVersion & 19/1/2026 & Terminate metriche finali & Linor Sadè & - & - \\
\hline
\rowcolor{secondaryblue!10} 0.1.5 & 18/1/2026 & Aggiornamento sezione qualità, aggiunti dettagli su metriche di processo & Linor Sadè & - & - \\
\hline
...
\begin{enumerate}[label=\textbf{MPD0\arabic*}, leftmargin=4.5em, resume=metriche_processo]
    ...
    \item \textbf{Code Response Time - Ai Co-Pilot immagini}.\\
    \textit{Valore di accettazione}: $\leq 10$ sec\\
    \textit{Valore ideale}: $\leq 5$ sec
    \item[\textbf{MPD10}] \textbf{Code Response Time - Ai Co-Pilot}.\\
    \textit{Valore di accettazione}: $\leq 10$ sec\\
    \textit{Valore ideale}: $\leq 5$ sec
\end{enumerate}
...
\begin{enumerate}[label=\textbf{MPD\arabic*}, leftmargin=4.5em]
    ...
    \item[\textbf{MPD12}] \textbf{User Error Rate (Errori di validazione)}.\\
...
\begin{enumerate}[label=\textbf{MPD\arabic*}, leftmargin=4.5em]
    ...
    \item[\textbf{MPD14}] \textbf{Cyclomatic Complexity (per metodo)}. Misura la complessità ciclomatica di un metodo, ovvero il numero di percorsi indipendenti nel codice.\\
...
\begin{enumerate}[label=\textbf{MPD\arabic*}, leftmargin=4.5em]
    \item[\textbf{MPD16}] \textbf{Supported Browsers (Test passati)}.\\
