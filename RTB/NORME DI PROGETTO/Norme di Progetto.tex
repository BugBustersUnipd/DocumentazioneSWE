...
L'obiettivo della verifica\G{} è poter rispondere alla domanda <<Did I build the system right?>> gli esiti di tale processo sono riportati nel (Inserire Parte Relativa Nel Piano Di Qualifica).
...
Ripetibili poiché se si presenta un failure nel codice, e vengono corretti i fault, posso eseguire lo stesso test\G{} nelle stesse condizioni per verificare l'effettiva correzione del failure.\\
