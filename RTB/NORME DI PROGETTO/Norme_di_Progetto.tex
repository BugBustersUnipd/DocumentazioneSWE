...
\paragraph*{Fornitura}{
    \begin{enumerate}[label=\textbf{MPC0\arabic*}, leftmargin=4.5em, series=metriche_processo] %nota: viene definita una serie per far sì che gli enumerate riprendano la numerazione da dove si era interrotta
        ...
        \[ CPI = \frac{EV}{AC} \]
        \textit{Interpretazione}: Se $CPI > 1$, il progetto è sotto budget (positivo).

        \item \textbf{Schedule Performance Index (SPI)}: indica l'efficienza del tempo del progetto.
        \[ SPI = \frac{EV}{PV} \]
        \textit{Interpretazione}: Se $SPI > 1$, il progetto è in anticipo rispetto alla pianificazione (positivo).
        ...
        \[ TEAC = \frac{\text{Tempo Pianificato}}{SPI} \]
...
\paragraph*{Sviluppo}{
    \begin{enumerate}[label=\textbf{MPC0\arabic*}, leftmargin=4.5em, resume=metriche_processo]
        ...
        \[ RSI = 1 - \frac{\text{Numero di requisiti modificati}}{\text{Numero totale di requisiti}} \]
...
\paragraph*{Gestione della qualità}{
    \begin{enumerate}[label=\textbf{MPC\arabic*}, leftmargin=4.5em, resume=metriche_processo]
        ...
        \[ \text{Quality metrics satisfied} = \frac{\text{Numero di metriche soddisfatte}}{\text{Numero totale di metriche definite}} \times 100\% \]
...
\paragraph*{Gestione dei processi}{
    \begin{enumerate}[label=\textbf{MPC\arabic*}, leftmargin=4.5em, resume=metriche_processo]
        ...
        \[ \text{Time efficiency} = \frac{\text{Tempo pianificato}}{\text{Tempo effettivamente impiegato}} \times 100\% \]
