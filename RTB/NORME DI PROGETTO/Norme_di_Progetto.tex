...
\begin{enumerate}
    ...
    \item \textbf{Verbali (interni/esterni)}: Registrazione degli incontri e delle decisioni, sia per le riunioni interne sia per i confronti con Sync Lab e la proponente.
\end{enumerate}
