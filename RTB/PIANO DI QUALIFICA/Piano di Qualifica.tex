...
Un indicatore della qualità di un prodotto è il metodo con cui è stato sviluppato. Se il processo di sviluppo segue delle linee guida ben definite, esso favorisce la buona riuscita del prodotto. Come stabilito nelle Norme di Progetto, nel nostro way of working\G abbiamo adottato lo Standard ISO/IEC 12207:1995 adattandolo alle nostre esigenze e a quelle del progetto. /////Oltre allo standard abbiamo deciso di effettuare delle revisioni periodiche per analizzare lo stato di avanzamento rispetto agli ovbiettivi stabilti./////LE FAREMO? INTANTO L'HO SCRITTO POI AL MASSIMO CANCELLIAMO

\subsubsection{Processi primari\G}
\subsubsubsection{Fornitura}
Tabella
\subsubsubsection{Sviluppo}
Tabella

\subsubsection{Processi di supporto\G}
...
\subsubsection{Processi organizzativi\G}
