...
\newcommand{\CurrentVersion}{0.0.3} % ultima versione, da cambiare ad ogni push significativo
...
\hline
\CurrentVersion & 04/01/2026 & Aggiunte sezioni 4 e 5 & Marco Piro & - & - \\
\hline
...
\hline
??????
MPC05 & Schedule variance (SV) & $\geq -5\%$ rispetto al (BAC) & $\geq 0\%$ \\
\hline
...
\hline
?????????
MPC0X & Cost variance (CV) & $\geq -5\%$ rispetto al (BAC) & $\geq 0\%$ \\
...
\subsection{MPC03 e MPC07 - Estimate to complete (ETC) e Actual cost (AC)}
Grafico
