...
\renewcommand{\G}{\textsuperscript{\scalebox{0.6}{\textbf{G}}}\xspace}
...
\hline
MPD09 & Core Response Time - AI\G Gnerativo immagini & $\leq 10$ sec & $\leq 5$ sec \\
\hline
MPD010 & Core Response Time - AI Co-Pilot\G & $\leq 10$ sec & $\leq 5$ sec \\
\hline}
...
\begin{longtable}{|p{2.2cm}|p{7cm}|p{3.5cm}|}
  ...
  \textbf{TI-001} & Verifica\G scambio dati e gestione errori tramite chiamate API\G REST (format JSON). & Frontend\G (Angular\G) $\leftrightarrow$ Backend\G (Ruby on Rails\G) \\
  \hline
...
TS-F-008 & Verifica\G che il sistema visualizzi un errore se l'email non è valida. & RF-8 & NI \\ \hline
TS-F-009 & Verifica\G che il sistema visualizzi un errore se la password non rispetta i criteri di sicurezza\G. & RF-9 & NI \\ \hline
...
TS-F-011 & Verifica\G che ll sistema impedisca la registrazione se
lo username inserito è già utilizzato. & RF-11 & NI \\ \hline
TS-F-012 & Verifica\G che ll sistema impedisca la registrazione
se la matricola inserita è già presente nel
sistema. & RF-12 & NI \\ \hline
TS-F-013 & Verifica\G che il sistema visualizzi un messaggio
...
TS-F-031 & Verifica\G che il sistema permetta all’Ammini-
...
TS-F-040 & Verifica\G che Il sistema visualizzi lo stile utilizzato
per un contenuto nello storico. & RF-40 & NI \\ \hline
TS-F-041 & Verifica\G che il sistema visualizzi il testo del
risultato generato nello storico. & RF-41 & NI \\ \hline
TS-F-042 & Verifica\G che il sistema visualizzi il timestamp
(data/ora) della generazione nello storico. & RF-42 & NI \\ \hline
TS-F-043 & Verifica\G che il sistema visualizzi la valutazio-
ne assegnata dall’utente al contenuto nello
storico. & RF-43 & NI \\ \hline
TS-F-044 & Verifica\G che il sistema visualizzi il prompt\G ori-
ginale utilizzato per un contenuto nello
storico. & RF-44 & NI \\ \hline
TS-F-045 & Verifica\G che il sistema visualizzi il tono utilizzato
...
% --- ANALYTICS (RF 55-61) ---
TS-F-055 & Verifica\G che il sistema visualizzi la lista dello
...
TS-F-065 & Verifica\G che il sistema permetta l’inseri-
...
TS-F-069 & Verifica\G che il sistema permetta controllare la
correttezza del formato del file inserito. & RF-69 & NI \\ \hline
TS-F-070 & Verifica\G che il sistema permetta controllare che lo
...
file. & RF-71 & NI \\ \hline
TS-F-072 & Verifica\G che il sistema visualizzi la lista dei
...
TS-F-075 & Verifica\G che il sistema visualizzare la competenza
(periodo) del documento analizzato. & RF-75 & NI \\ \hline
TS-F-076 & Verifica\G che il sistema visualizzi l’azienda
associata al documento analizzato. & RF-76 & NI \\ \hline
TS-F-077 & Verifica\G che il sistema visualizzi la causale del
documento analizzato. & RF-77 & NI \\ \hline
TS-F-078 & Verifica\G che il sistema visualizzi la lingua rilevata
nel documento. & RF-78 & NI \\ \hline
TS-F-079 & Verifica\G che il sistema visualizzi il numero di
pagine del documento. & RF-79 & NI \\ \hline
TS-F-080 & Verifica\G che il sistema visualizzi il nome originale
del file del documento. & RF-80 & NI \\ \hline
TS-F-081 & Verifica\G che il sistema visualizzi la data di
redazione/caricamento del documento. & RF-81 & NI \\ \hline
TS-F-082 & Verifica\G che il sistema visualizzi il codice
identificativo del documento. & RF-82 & NI \\ \hline
TS-F-083 & Verifica\G che il sistema visualizzi la tipologia del
...
TS-F-088 & Verifica\G che il sistema visualizzi la lista delle
informazioni sui destinatari estratti. & RF-88 & NI \\ \hline
TS-F-089 & Verifica\G che il sistema permetta di visualizzare i
dettagli di un singolo destinatario in lista. & RF-89 & NI \\ \hline
TS-F-090 & Verifica\G che il sistema visualizzi il codice fiscale
del destinatario. & RF-90 & NI \\ \hline
TS-F-091 & Verifica\G che il sistema visualizzi la matricola del
destinatario. & RF-91 & NI \\ \hline
TS-F-092 & Verifica\G che il sistema visualizzi il reparto del
destinatario. & RF-92 & NI \\ \hline
TS-F-093 & Verifica\G che il sistema visualizzi il
...
TS-F-095 & Verifica\G che il sistema visualizzi lo storico
...
TS-F-097 & Verifica\G che il sistema visualizzi i dettagli di un
elemento nello storico documenti. & RF-97 & NI \\ \hline
TS-F-098 & Verifica\G che il sistema visualizzi la percentuale di
confidenza dell’analisi nello storico. & RF-98 & NI \\ \hline
TS-F-099 & Verifica\G che il sistema visualizzi l’appartenenza
alle liste di distribuzione. & RF-99 & NI \\ \hline
TS-F-100 & Verifica\G che il sistema visualizzi lo stato di
...
TS-F-121 & Verifica\G che il sistema visualizzi la dashboard\G
con i dati di analytics per l’AI\G Assistant. & RF-121 & NI \\ \hline
TS-F-122 & Verifica\G che il sistema visualizzi il numero totale
di prompt\G generati. & RF-122 & NI \\ \hline
TS-F-123 & Verifica\G che il sistema visualizzi il rating medio
dei prompt\G generati. & RF-123 & NI \\ \hline
TS-F-124 & Verifica\G che il sistema visualizzi il numero di
rigenerazioni effettuate. & RF-124 & NI \\ \hline
TS-F-125 & Verifica\G che il sistema visualizzi le statistiche sui
toni più utilizzati. & RF-125 & NI \\ \hline
TS-F-126 & Verifica\G che il sistema visualizzi le statistiche
sugli stili più utilizzati. & RF-126 & NI \\ \hline
TS-F-127 & Verifica\G che il sistema visualizzi la dashboard\G
con i dati di analytics per l’AI Co-Pilot\G. & RF-127 & NI \\ \hline
TS-F-128 & Verifica\G che il sistema visualizzi la confidenza
media delle analisi documenti. & RF-128 & NI \\ \hline
TS-F-129 & Verifica\G che il sistema visualizzi la percentuale di
interventi manuali necessari. & RF-129 & NI \\ \hline
TS-F-130 & Verifica\G che il sistema visualizzi l’accuratezza del
mapping dei dati. & RF-130 & NI \\ \hline
TS-F-131 & Verifica\G che il sistema visualizzi i tempi medi di
