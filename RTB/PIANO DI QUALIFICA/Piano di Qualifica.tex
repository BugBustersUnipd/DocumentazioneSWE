...
\begin{tabularx}{\linewidth}{|>{\raggedright\arraybackslash}p{2cm}|>{\raggedright\arraybackslash}p{3cm}|>{\raggedright\arraybackslash}X|>{\raggedright\arraybackslash}p{2.5cm}|>{\raggedright\arraybackslash}p{2.5cm}|}
\hline
\rowcolor{primaryblue!40}
...
\hline
MPP01 & Estimated at completion (EAC) & $\pm 5\%$ rispetto al (BAC) & Budget at completion (BAC) \\
\hline
MPP02 & Estimate to complete (ETC) & $\geq 0$ & $\leq$ EAC \\
\hline
MPP03 & Actual cost (AC) & $\geq 0$ & $\leq$ EAC \\
\hline
MPP04 & Earned value (EV) & $\geq 0$ & $\leq$ EAC \\
\hline
MPP05 & Planned value (PV) & $\geq 0$ & $\leq$ Budget at completion (BAC) \\
\hline
MPP06 & Schedule variance (SV) & $\geq -5\%$ rispetto al (BAC) & $\geq 0\%$ \\
\hline
MPP07 & Cost variance (CV) & $\geq -5\%$ rispetto al (BAC) & $\geq 0\%$ \\
\hline
MPP08 & Cost Performance Index (CPI) & $\geq 0.9$ & $\geq 1.0$ \\
\hline
\end{tabularx}
...
\textbf{\color{white} Metrica} & \textbf{\color{white} Descrizione} & \textbf{\color{white} Valore accettazione} & \textbf{\color{white} Valore ideale} \\
\hline
MPP09 & Requirements Stability Index (EAC) & $\pm 70\%$ & 100\% \\
\hline
\end{tabularx}
