...
\hline
MPD11 & User Error Rate (Errori validazione\G) & $\leq 10\%$ & $\leq 5\%$ \\
\hline}
...
\hline
MPD13 & Cyclomatic complexity\G (per metodo) & $\leq 15$ & $\leq 10$ \\
\hline
...
\begin{longtable}{|p{2.2cm}|p{7cm}|p{3.5cm}|}
  ...
  \textbf{TI-001} & Verifica\G scambio dati JSON tra Frontend\G e Backend\G (API\G REST). & Front-End\G Angular\G $\leftrightarrow$ Back-End\G Ruby on Rails\G \\
  \hline
