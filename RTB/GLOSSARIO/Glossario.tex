...
\hline
0.0.2 & 17/11/2025 & Sono stati aggiunti i seguenti termini: Architettura a livelli, Architettura dei microservizi, Constructor Injection, Decomposizione funzionale, Dependency Injection, Diagramma dei componenti, Diagramma di deployment, Diagramma di sequenza, Diagramma degli stati, Load balancer, Livelli chiusi, Livelli aperti, Microservizio, Scalabilità, Transazioni distribuite, Accoppiamento (Coupling), Affidabilità (Reliability), Architettura multilivello, Architettura Pipe-and-Filter, Architettura Three-Tier, Availability (Disponibilità), Comprensibilità, Design pattern architetturali, Flessibilità, Modularità, Progettazione di dettaglio, Progettazione logica, Procedimento agile, Procedimento bottom-up, Procedimento top-down, Qualità architetturale, Riusabilità, Robustezza, Unità architetturali & Alberto Autiero & - & - \\
\hline
...
Pattern architetturale che organizza il sistema in livelli gerarchici, dove ogni livello fornisce servizi al livello superiore e utilizza servizi del livello inferiore.
...
Insieme di tecniche, metodi e procedures che sono state riconosciute come le più efficaci ed efficienti per raggiungere un obiettivo specifico in un determinato contesto.
