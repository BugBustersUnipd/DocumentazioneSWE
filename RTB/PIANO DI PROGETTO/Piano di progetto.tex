...
\CurrentVersion & 3/1/2026 & Verifica del documento & - & Luca Slongo & - \\
\hline
...
All'inizio di ogni sprint\pediceG vengono pianificate le attività per il ciclo che sta iniziando e avviene la rotazione dei ruoli all'interno del gruppo. Tale rotazione, sebbene programmata all'avvio di ogni iterazione, potrà essere modificata in corso d'opera per rispondere a specifiche esigenze organizzative. L'obiettivo è consentire a ciascun membro di sperimentare ogni ruolo.

Il gruppo si impegna a organizzare colloqui in via telematica o in presenza con il proponente\pediceG Eggon con una cadenza bisettimanale che può variare a seconda delle esigenze. Questo approccio garantisce un allineamento continuo con le aspettative del committente\pediceG e soprattutto permette di validare tempestivamente il lavoro svolto.
...
\noindent\textbf{Retrospettiva\pediceG}\\
Nel secondo sprint\pediceG abbiamo concentrato gli sforzi soprattutto sull'Analisi dei requisiti\pediceG individuata come priorità immediata e fondamentale per le succesive fasi di progetto e sviluppo. L'obiettivo raggiunto è stato quello di portarla ad uno stadio avanzato.
...
\noindent\textbf{Retrospettiva\pediceG}\\
Nel terzo sprint\pediceG abbiamo concentrato gli sforzi soprattutto sull'Analisi dei requisiti\pediceG che è ormai ad uno stato molto avanzato. Inoltre abbiamo dedicato del tempo allo sviluppo del Proof of concept (POC)
...
\noindent\textbf{Informazioni generali e attività da svolgere}\\
Questo quarto sprint\pediceG ha l'obiettivo principale di concludere la stesura delle Norme di progetto\pediceG e l'Analisi dei requisiti\pediceG.\\
...
\begin{itemize}
    ...
    \item Redazione del verbale interno\pediceG del 23/12/2025
\end{itemize}
