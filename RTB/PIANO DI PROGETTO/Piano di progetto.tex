...
\noindent\textbf{Retrospettiva\pediceG}\\
Nel corso del quinto sprint\pediceG, il gruppo ha concentrato gli sforzi sulla riorganizzazione dell'Analisi dei Requisiti\pediceG in seguito al colloquio con il Prof. Cardin. Tale necessità ha comportato la riassegnazione di un membro dal ruolo di Amministratore\pediceG a quello di Analista\pediceG; di conseguenza, altri componenti del gruppo hanno modificato i propri ruoli per garantire la copertura del ruolo rimasto vacante. Inoltre, è stato completato lo sviluppo del Proof of Concept (POC)\pediceG.
...
\centering
\begin{tikzpicture}[scale=1.3]
  % Responsabile: 10.3% = 8h su 78h totali -> 37.1°
  \draw[fill=blue!60, draw=black, line width=1.5pt] 
    (0,0) -- (2,0) arc (0:37.1:2) -- cycle;
  \node at (18.55:1.2) {\small\bfseries 10.3\%};
  
  % Amministratore: 5.1% = 4h -> 18.5° (cumulativo: 37.1° -> 55.6°)
  \draw[fill=red!60, draw=black, line width=1.5pt] 
    (0,0) -- (37.1:2) arc (37.1:55.6:2) -- cycle;
  \node[rotate=46.35] at (46.35:1.5) {\small\bfseries 5.1\%};
  
  % Analista: 71.8% = 56h -> 258.5° (cumulativo: 55.6° -> 314.1°)
  \draw[fill=orange!60, draw=black, line width=1.5pt] 
    (0,0) -- (55.6:2) arc (55.6:314.1:2) -- cycle;
  \node at (184.85:1.2) {\small\bfseries 71.8\%};
  
  % Progettista: 12.8% = 10h -> 46.1° (cumulativo: 314.1° -> 360°)
  \draw[fill=purple!60, draw=black, line width=1.5pt] 
    (0,0) -- (314.1:2) arc (314.1:360:2) -- cycle;
  \node at (337.05:1.2) {\small\bfseries 12.8\%};
