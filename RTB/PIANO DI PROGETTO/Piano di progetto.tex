...
0.1.5 & 12/01/2026 & Compilata l'attività "Redazione Norme di Progetto" nella sezione Attività previste per l'RTB\pediceG & Linor Sadè & - & - \\
\hline 
...
\hline
Realizzazione PoC\pediceG & \parbox[c]{3.5cm}{\centering\begin{itemize}[leftmargin=*,itemsep=3pt] \item XXX \item XXX \end{itemize}} & \parbox[c]{5cm}{\centering\begin{itemize}[leftmargin=*,itemsep=3pt] \item XXX \item XXX \end{itemize}} & IN REALIZZAZIONE \\
\hline
