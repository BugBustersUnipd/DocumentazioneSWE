...
\begin{longtblr}[
  ...
  % --- MODIFICA COLONNE QUI SOTTO ---
  % Ho ridotto la 1° colonna a 3.0cm (era 3.2)
  % Ho AUMENTATO la 2° colonna a 4.8cm (era 3.8) -> Ora il testo ci sta!
  % Ho ridotto la 3° colonna a 3.2cm (era 4.2) -> Basta per "Sprint X"
...
% Ora che la colonna è più larga, non serve l'invio manuale forzato
