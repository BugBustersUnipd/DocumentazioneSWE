...
\begin{longtable}{|>{\centering\arraybackslash}m{4cm}|>{\centering\arraybackslash}p{5cm}|>{\centering\arraybackslash}p{3.5cm}|>{\centering\arraybackslash}m{2cm}|}
\hline
...
\endfoot
\hline
Redazione Analisi dei Requisiti\pediceG & \parbox[c]{5cm}{\centering\begin{itemize}[leftmargin=*,itemsep=3pt] \item XXX \item XXX \end{itemize}} & \parbox[c]{3.5cm}{\centering\begin{itemize}[leftmargin=*,itemsep=3pt] \item XXX \item XXX \end{itemize}} & IN REDAZIONE \\
\hline
Redazione Piano di Progetto\pediceG & \parbox[c]{5cm}{\centering\begin{itemize}[leftmargin=*,itemsep=3pt] \item Introduzione del documento \item Analisi e gestione dei rischi \item Pianificazione nel lungo e breve periodo\end{itemize}} & \parbox[c]{3.5cm}{\centering\begin{itemize}[leftmargin=*,itemsep=3pt] \item Introduzione del documento: sprint 2 \item Analisi e gestione dei rischi: tutti gli sprint \item Pianificazione nel lungo e breve periodo: tutti gli sprint\end{itemize}} & IN REDAZIONE \\
\hline
Redazione Piano di Qualifica\pediceG & \parbox[c]{5cm}{\centering\begin{itemize}[leftmargin=*,itemsep=3pt] \item XXX \item XXX \end{itemize}} & \parbox[c]{3.5cm}{\centering\begin{itemize}[leftmargin=*,itemsep=3pt] \item XXX \item XXX \end{itemize}} & IN REDAZIONE \\
\hline
Redazione Norme di Progetto\pediceG & \parbox[c]{5cm}{\centering\begin{itemize}[leftmargin=*,itemsep=3pt] \item XXX \item XXX \end{itemize}} & \parbox[c]{3.5cm}{\centering\begin{itemize}[leftmargin=*,itemsep=3pt] \item XXX \item XXX \end{itemize}} & IN REDAZIONE \\
\hline
Redazione Glossario\pediceG & \parbox[c]{5cm}{\centering\begin{itemize}[leftmargin=*,itemsep=3pt] \item Redazione e aggiornamento dei termini\end{itemize}} & \parbox[c]{3.5cm}{\centering\begin{itemize}[leftmargin=*,itemsep=3pt] \item Tutti gli sprint \end{itemize}} & IN REDAZIONE \\
\hline
Realizzazione PoC\pediceG & \parbox[c]{5cm}{\centering\begin{itemize}[leftmargin=*,itemsep=3pt] \item XXX \item XXX \end{itemize}} & \parbox[c]{3.5cm}{\centering\begin{itemize}[leftmargin=*,itemsep=3pt] \item XXX \item XXX \end{itemize}} & DA FARE \\
\hline
