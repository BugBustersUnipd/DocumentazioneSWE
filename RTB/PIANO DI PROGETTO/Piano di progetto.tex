...
\begin{center}
  ...
  {\Large\color{secondaryblue} Versione 0.1.3}\\[0.8cm]
\end{center}
...
0.1.5 & 12/01/2026 & Compilate le attività "Redazione Norme di Progetto" e "Realizzazione PoC" nella sezione Attività previste per l'RTB\pediceG & Linor Sadè & - & - \\
\hline 
0.1.4 &  & Aggiunti ai termini presenti nel Glossario la G & Alberto Autiero & - & - \\
\hline
...
\begin{longtable}{|>{\centering\arraybackslash}m{4cm}|>{\centering\arraybackslash}p{3.5cm}|>{\centering\arraybackslash}p{5cm}|>{\centering\arraybackslash}m{2cm}|}
\hline
...
\endfoot
\hline
Redazione Analisi dei Requisiti\pediceG & \parbox[c]{3.5cm}{\centering\begin{itemize}[leftmargin=*,itemsep=3pt] \item XXX \item XXX \end{itemize}} & \parbox[c]{5cm}{\centering\begin{itemize}[leftmargin=*,itemsep=3pt] \item XXX \item XXX \end{itemize}} & IN REDAZIONE \\
\hline
Redazione Piano di Progetto\pediceG & \parbox[c]{3.5cm}{\centering\begin{itemize}[leftmargin=*,itemsep=3pt] \item Introduzione del documento \item Analisi e gestione dei rischi \item Pianificazione nel lungo e breve periodo\end{itemize}} & \parbox[c]{5cm}{\centering\begin{itemize}[leftmargin=*,itemsep=3pt] \item Introduzione del documento: sprint 2 \item Analisi e gestione dei rischi: tutti gli sprint \item Pianificazione nel lungo e breve periodo: tutti gli sprint\end{itemize}} & IN REDAZIONE \\
\hline
Redazione Piano di Qualifica\pediceG & \parbox[c]{3.5cm}{\centering\begin{itemize}[leftmargin=*,itemsep=3pt] \item XXX \item XXX \end{itemize}} & \parbox[c]{5cm}{\centering\begin{itemize}[leftmargin=*,itemsep=3pt] \item XXX \item XXX \end{itemize}} & IN REDAZIONE \\
\hline
Redazione Norme di Progetto\pediceG & \parbox[c]{3.5cm}{\centering\begin{itemize}[leftmargin=*,itemsep=3pt] \item Introduzione del documento \item Redazione dei processi primari \item Redazione dei processi di supporto \item Redazione dei processi organizzativi \item Redazione sezione Standard di progetto \item Redazione XXX\end{itemize}} & \parbox[c]{5cm}{\centering\begin{itemize}[leftmargin=*,itemsep=3pt] \item  Introduzione del documento: sprint 1 \item Redazione dei processi primari: sprint 1, 2 e modifiche minime o aggiunte negli altri sprint \item Redazione dei processi di supporto: sprint 2, modifiche o aggiunte negli altri sprint\item Redazione dei processi organizzativi: fine sprint 2, inizio 3 \item Redazione sezione Standard di progetto: sprint 3 \item Redazione XXX\end{itemize}} & IN REDAZIONE \\
\hline
Redazione Glossario\pediceG & \parbox[c]{3.5cm}{\centering\begin{itemize}[leftmargin=*,itemsep=3pt] \item Redazione e aggiornamento dei termini\end{itemize}} & \parbox[c]{5cm}{\centering\begin{itemize}[leftmargin=*,itemsep=3pt] \item Tutti gli sprint \end{itemize}} & IN REDAZIONE \\
\hline
Realizzazione PoC\pediceG & \parbox[c]{3.5cm}{\centering\begin{itemize}[leftmargin=*,itemsep=3pt] \item Prima implementazione solo con Rails (anche UI) \item Ridefinizione struttura backend-frontend aggiungendo Angular \item Implementazione e modifica di funzionalità backend con relativa implementazione in frontend \item Refactoring del codice \end{itemize}} & \parbox[c]{5cm}{\centering\begin{itemize}[leftmargin=*,itemsep=3pt] \item Prima implementazione: sprint 3 \item Ridefinizione struttura: sprint 3 \item Sprint 4 \end{itemize}} & IN REALIZZAZIONE \\
\hline
...
\centering
\begin{tikzpicture}[scale=1.3]
  % Responsabile\pediceG: 13.5% = 7h su 52h (7/52 = 0.135 -> 48.6°)
  \draw[fill=blue!60, draw=black, line width=1.5pt] 
    (0,0) -- (2,0) arc (0:48.6:2) -- cycle;
  \node at (24.3:1.2) {\small\bfseries 13.5\%};
  
  % Amministratore\pediceG: 13.5% = 7h (48.6° cumulative -> 97.2°)
  \draw[fill=red!60, draw=black, line width=1.5pt] 
    (0,0) -- (48.6:2) arc (48.6:97.2:2) -- cycle;
  \node[rotate=72.9] at (72.9:1.5) {\small\bfseries 13.5\%};
  
  % Analista\pediceG: 61.5% = 32h (221.4° cumulative -> 318.6°)
  \draw[fill=orange!60, draw=black, line width=1.5pt] 
    (0,0) -- (97.2:2) arc (97.2:318.6:2) -- cycle;
  \node at (207.9:1.2) {\small\bfseries 61.5\%};
  
  % Verificatore\pediceG: 11.5% = 6h (41.4° cumulative to 360°)
  \draw[fill=green!60, draw=black, line width=1.5pt] 
...
\hline
Amministratore\pediceG & 20€/h & 7 & 140€ & 45 & 900€ \\
\hline
Analista\pediceG & 25€/h & 32 & 800€ & 24 & 600€ \\
\hline
...
\hline
\textbf{Totale} & - & 52 & 1240€ & 592 & 11550€ \\
\hline
\end{tabular}
...
\centering
\begin{tikzpicture}[scale=1.3]
  % Responsabile\pediceG: 7.1% = 3h su 42h (3/42 = 0.071 -> 25.6°)
  \draw[fill=blue!60, draw=black, line width=1.5pt] 
    (0,0) -- (2,0) arc (0:25.6:2) -- cycle;
  \node at (12.8:1.2) {\small\bfseries 7.1\%};
  
  % Amministratore\pediceG: 14.3% = 6h (51.4° cumulative -> 77°)
  \draw[fill=red!60, draw=black, line width=1.5pt] 
    (0,0) -- (25.6:2) arc (25.6:77:2) -- cycle;
  \node[rotate=51.3] at (51.3:1.5) {\small\bfseries 14.3\%};
  
  % Analista\pediceG: 19% = 8h (68.4° cumulative -> 145.4°)
  \draw[fill=orange!60, draw=black, line width=1.5pt] 
    (0,0) -- (77:2) arc (77:145.4:2) -- cycle;
  \node[rotate=111.2] at (111.2:1.5) {\small\bfseries 19\%};
  
  % Progettista\pediceG: 38.1% = 16h (137.2° cumulative -> 282.6°)
  \draw[fill=purple!60, draw=black, line width=1.5pt] 
    (0,0) -- (145.4:2) arc (145.4:282.6:2) -- cycle;
  \node at (214:1.2) {\small\bfseries 38.1\%};
  
  % Verificatore\pediceG: 21.4% = 9h (77° cumulative to 360°)
  \draw[fill=green!60, draw=black, line width=1.5pt] 
    (0,0) -- (282.6:2) arc (282.6:360:2) -- cycle;
  \node at (321.3:1.2) {\small\bfseries 21.4\%};
...
\hline
Amministratore\pediceG & 20€/h & 6 & 120€ & 39 & 780€ \\
\hline
Analista\pediceG & 25€/h & 8 & 200€ & 16 & 400€ \\
\hline
Progettista\pediceG & 25€/h & 16 & 400€ & 131 & 3275€ \\
\hline
Programmatore\pediceG & 15€/h & - & - & 167 & 2505€ \\
\hline
Verificatore\pediceG & 15€/h & 9 & 135€ & 151 & 2265€ \\
\hline
\textbf{Totale} & - & 42 & 945€ & 550 & 10605€ \\
\hline
\end{tabular}
...
\centering
\begin{tikzpicture}[scale=1.3]
  % Responsabile\pediceG: 8.3% = 4h su 48h (4/48 = 0.083 -> 29.9°)
  \draw[fill=blue!60, draw=black, line width=1.5pt] 
    (0,0) -- (2,0) arc (0:29.9:2) -- cycle;
  \node at (15:1.2) {\small\bfseries 8.3\%};
  
  % Amministratore\pediceG: 8.3% = 4h (29.9° cumulative -> 59.8°)
  \draw[fill=red!60, draw=black, line width=1.5pt] 
    (0,0) -- (29.9:2) arc (29.9:59.8:2) -- cycle;
  \node[rotate=44.85] at (44.85:1.5) {\small\bfseries 8.3\%};
  
  % Progettista\pediceG: 54.2% = 26h (195.1° cumulative -> 254.9°)
  \draw[fill=purple!60, draw=black, line width=1.5pt] 
    (0,0) -- (59.8:2) arc (59.8:254.9:2) -- cycle;
  \node at (157.35:1.2) {\small\bfseries 54.2\%};
  
  % Verificatore\pediceG: 29.2% = 14h (105.1° cumulative to 360°)
  \draw[fill=green!60, draw=black, line width=1.5pt] 
    (0,0) -- (254.9:2) arc (254.9:360:2) -- cycle;
  \node at (307.45:1.2) {\small\bfseries 29.2\%};
...
Ruolo & Costo & Ore & Costo & Ore rimanenti & Budget rimanente \\
\hline
Responsabile\pediceG & 30€/h & 4 & 120€ & 42 & 1260€ \\
\hline
Amministratore\pediceG & 20€/h & 4 & 80€ & 35 & 700€ \\
\hline
Analista\pediceG & 25€/h & - & - & 16 & 400€ \\
\hline
Progettista\pediceG & 25€/h & 26 & 650€ & 105 & 2625€ \\
\hline
Programmatore\pediceG & 15€/h & - & - & 167 & 2505€ \\
\hline
Verificatore\pediceG & 15€/h & 14 & 210€ & 137 & 2055€ \\
\hline
\textbf{Totale} & - & 48 & 1060€ & 502 & 9545€ \\
\hline
\end{tabular}
...
\centering
\begin{tikzpicture}[scale=1.3]
  % Responsabile\pediceG: 14% = 6h su 43h (6/43 = 0.140 -> 50.2°)
  \draw[fill=blue!60, draw=black, line width=1.5pt] 
    (0,0) -- (2,0) arc (0:50.2:2) -- cycle;
  \node at (25.1:1.2) {\small\bfseries 14\%};
  
  % Amministratore\pediceG: 11.6% = 5h (41.8° cumulative -> 92°)
  \draw[fill=red!60, draw=black, line width=1.5pt] 
    (0,0) -- (50.2:2) arc (50.2:92:2) -- cycle;
  \node[rotate=71.1] at (71.1:1.5) {\small\bfseries 11.6\%};
  
  % Analista\pediceG: 16.3% = 7h (58.7° cumulative -> 150.7°)
  \draw[fill=orange!60, draw=black, line width=1.5pt] 
    (0,0) -- (92:2) arc (92:150.7:2) -- cycle;
  \node[rotate=121.35] at (121.35:1.5) {\small\bfseries 16.3\%};
  
  % Progettista\pediceG: 39.5% = 17h (142.2° cumulative -> 292.9°)
  \draw[fill=purple!60, draw=black, line width=1.5pt] 
    (0,0) -- (150.7:2) arc (150.7:292.9:2) -- cycle;
  \node at (221.8:1.2) {\small\bfseries 39.5\%};
  
  % Verificatore\pediceG: 18.6% = 8h (67.1° cumulative to 360°)
  \draw[fill=green!60, draw=black, line width=1.5pt] 
    (0,0) -- (292.9:2) arc (292.9:360:2) -- cycle;
  \node at (326.45:1.2) {\small\bfseries 18.6\%};
...
Ruolo & Costo & Ore & Costo & Ore rimanenti & Budget rimanente \\
\hline
Responsabile\pediceG & 30€/h & 6 & 180€ & 36 & 1080€ \\
\hline
Amministratore\pediceG & 20€/h & 5 & 100€ & 30 & 600€ \\
\hline
Analista\pediceG & 25€/h & 7 & 175€ & 9 & 225€ \\
\hline
Progettista\pediceG & 25€/h & 17 & 425€ & 88 & 2200€ \\
\hline
Programmatore\pediceG & 15€/h & - & - & 167 & 2505€ \\
\hline
Verificatore\pediceG & 15€/h & 8 & 120€ & 129 & 1935€ \\
\hline
\textbf{Totale} & - & 43 & 1000€ & 459 & 8545€ \\
\hline
\end{tabular}
