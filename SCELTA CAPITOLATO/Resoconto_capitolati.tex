...
\newcommand{\CurrentVersion}{0.6.0} % ultima versione, da cambiare ad ogni push significativo
...
\hline 
\CurrentVersion & 24/10/2025 & Stesura di C4 e altre piccole modifiche & Linor Sadè & - & - \\
\hline
0.5.0 & 23/10/2025 & Stesura di C6& Linor Sadè & - & - \\
\hline
0.4.1 & 22/10/2025 & Correzione indice& Linor Sadè & - & - \\
\hline
...
\paragraph{}
Le risposte dell'azienda non sono citazioni dirette, ma sono state riassunte e riformulate dal team
in modo da essere più concise e chiare.
{\footnotesize
...
\begin{itemize}
  ...
  \item Formazione iniziale sulla tematica della violenza di genere
...
\paragraph{}
Visto l'interesse del team, è stato organizzato anche un incontro di approfondimento con Eggon, durante il quale sono stati chiariti ulteriori dubbi e domande riguardo al progetto.
\subsubsection{Punti di forza e di debolezza}
{\footnotesize
\begin{tabularx}{\textwidth}{|X|X|}
\hline
