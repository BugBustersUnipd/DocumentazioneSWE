...
\newcommand{\CurrentVersion}{0.3.0} % ultima versione
...
\hline
\CurrentVersion & 21/10/2025 & Terminato C5, iniziato C8, C9 & Linor Sadè & - & - \\
\hline
...
\parbox[t]{\linewidth}{%
Qui di seguito sono riportate alcune delle domande poste ad Eggon con le relative risposte fornite dall'azienda. In particolare abbiamo posto domande che riguardavano il supporto di Eggon durante lo sviluppo del progetto, l'importanza della conoscenza pregressa delle tecnologie richieste e il coinvolgimento del team nel processo SCRUM dell'azienda perché sapevamo fosse il primo anno in cui Eggon partecipava a questo tipo di progetto.
}
